...
and|和, 与; 与
to|到, 向, 趋于;adv. 向前
have|有, 怀有, 拿, 进行;aux. 已经
it|它; 信息论, 输入终端, 智能终端, 内捕获
he|他;n. 男孩, 男人, 雄性动物
for|为, 因为, 至于;conj. 因为; DOS批处理命令:对一组参数重复执行指定的命令
not|不, 非, 未; 非
that|那, 那个;conj. 以致, 因为;pron. 那;adv. 那么, 那样
you|你, 你们
with|和...在一起, 以, 由于
on|在...之上;adv. ...上去;a. 正起作用的; 打开
they|他们, 它们
do|做, 进行, 完成
by|被, 经, 由, 在...之旁;adv. 经过, 在近处
she|她
at|在, 向, 对; 地址转换器, 异常传输, 自动订票
this|这, 本;a. 这, 本;adv. 这么
but|除了;conj. 但是;adv. 仅仅
his|他的; 组氨酸
we|我们
from|从, 来自, 根据
which|哪一个, 那一个
or|或, 或者; 或
say|说, 讲, 念, 说明, 指明;vi. 说, 讲;n. 意见, 发言权
as|同样地, 例如;prep. 做为, 当作;conj. 当...之时, 以...的方式, 像...一样, 因为; 高级系统, 先进系统, 辅助存储器, 自治系统
would|将, 愿意
their|他们的
there|在那里
what|什么;interj. 怎么, 多么;a. 什么的;adv. 到什么程度
all|所有的, 全部的, 一切的;adv. 全部, 全然;pron. 全部;n. 全部
if|如果, 是否, 无论何时, 假设, 即使;n. 条件; DOS批处理命令:根据所测试的条件决定是否执行另一条命令
get|得到, 获得, 变成, 使得, 收获, 接通, 抓住, 染上;vi. 到达, 成为, 变得;n. (网球等)救球, 生殖, 幼兽; 取得指令, 获取文件
her|她的, 她
go|去, 走, 达到, 运转, 查阅, 消失, 结束, 放弃, 花费, 流传, 趋于, 打算, 剩下;vt. 以...打赌, 对付, 忍受, 出产, 为被捕者出(保释金);n. 去, 尝试, 进行
who|谁
one|一(个);pron. 一, 任何人;num. 一, 一个;a. 一致的, 完整的
see|看见, 查看, 参观, 游览, 理解, 知道, 同意;vi. 看, 观看, 注意, 知道, 考虑;n. 主教的职位
time|时间, 时侯, 时机, 时期, 期限, 次数, 节拍, 暂停, 规定时间;vt. 测定...的时间, 记录...的时间, 计时, 定时;a. 时间的, 记时的, 定时的, 定期的, 分期的; DOS内部命令:用于显示或设…
some|一些, 一部分, 若干;adv. 大约;a. 一些的, 少许的, 某一的
when|当...的时候;adv. 何时, 什么时候;pron. 什么时侯;n. 时间
could|可以, 能
year|年, 年度, 年龄; 年度
into|进入...之内, 朝..., 深入...之中, 成为...状况
its|它的
then|然后, 当时;conj. 然后, 当时;n. 那时
my|我的; 迈尔(热容单位)
out|外面的, 熄灭的, 结束的;adv. 在外, 熄灭, 出现;prep. 出自, 离去, 向
about|在...周围, 大约, 有关, 关于;adv. 大约, 四处, 在附近, 周围
think|想, 考虑, 想起, 想像, 打算, 认为;vi. 思考, 料想;n. 想法;a. 思想的
come|过来, 来, 到达, 出现, 开始;interj. 喂
your|你的, 你们的
now|现在, 刚才, 目前;n. 现在;a. 现在的;conj. 由于
no|不, 拒绝, 否决票;a. 没有, 不是, 绝非;adv. 不
other|其他的, 另外的, 从前的;pron. 其他的, 他人, 另外一个
only|唯一的, 仅有的, 最佳的;adv. 只有, 仅仅, 只能;conj. 但是, 不过
give|弹性, 适应性;vt. 给, 授予, 供给, 产生, 发表, 付出, 献出, 让出;vi. 捐赠, 支持不住, 让步
good|善行, 好处, 利益;a. 好的, 优良的, 上等的, 愉快的, 有益的, 好心的, 慈善的, 虔诚的
more|更多;a. 多的, 程度较大的, 更大的;adv. 多, 更多, 进一步; DOS外部命令:显示满屏后自动暂停, 并显示:"--More--", 按任意键继续
people|人, 人民, 民族, 平民;vt. 使住满人, 居住于
also|也, 并且, 同样地
any|任何的;pron. 任何
first|首先, 第一, 优先;a. 第一的;num. 第一;n. 开始, 第一
very|真正的, 恰好的, 十足的, 特有的;adv. 非常, 完全
new|新的, 陌生的, 最近的, 不熟悉的; 新发现的, 新的, 重新开始的
look|一看, 神色, 样子, 面容;vi. 看, 注意, 朝着, 显得;vt. 打量, 看上去与...一样, 以眼色(或脸色)显示, 期待
should|应该, 将要
way|路, 路线, 路途, 方法, 道路, 情形, 规模, 习惯, 行业, 方面;adv. 远远地, 非常
like|相似的, 同样的;vt. 喜欢, 愿意, 想;vi. 喜欢, 希望;n. 爱好, 同样的人(或物);prep. 象, 如同;adv. 可能
than|比, 除...外;prep. 比
how|如何, 怎样, 多少, 多么;n. 方式
man|男人, 人类, 人;vt. 为...配备人手, 操纵, 使振奋; 城域网, 手册
find|发现, 感到, 找到, 认为, 得到;vi. 裁决;n. 发现; 查找; DOS外部命令:在指定的文件或从键盘输入的文本行中;寻找指定的字符串, 将符合条件的行或行数输出到标准输出设备上
our|我们的
want|需要的东西, 缺乏, 贫困, 需要;vt. 要, 希望, 应该, 缺少;vi. 生活困苦, 需要, 缺少
day|天, 日子, 白天, 工作日; 日(一昼夜), 昼, 白天
after|在...之后, 由于;conj. 在...之后;adv. 后来
between|在...之间
many|多数, 多数人;a. 许多的;pron. 许多
because|因为
back|后面的;vt. 使后退, 支持;vi. 倒退, 背靠;adv. 向后地;n. 背部, 后面
thing|事物, 东西, 物, 用品, 事, 事件, 情况, 行为, 特征
tell|告诉, 说, 吩咐, 断定, 知道;vi. 讲述, 泄密, 告发, 表明
such|如此的, 这样的
through|穿越, 从头至尾, 到底, 因为;prep. 经过, 穿过;a. 对穿的, 直达的, 完结的
over|结束, 越过, 从头到尾;prep. 在...之上, 遍于...之上, 越过;a. 上面的;vt. 越过
must|必须, 未发酵葡萄汁, 绝对必要的事物;aux. 必须
still|蒸馏室, 寂静, 剧照;v. 蒸馏, (使)平静, (使)静止;a. 静止的, 不动的, 静寂的, 不起泡的, 静物摄影的;adv. 仍然, 更, 静止地;conj. 然而, 但是
child|孩子, 产物, 追随者; 儿童
too|也, 非常, 太
put|放, 摆, 安置, 移动, 发射, 投掷, 写上, 表达, 使从事, 使受到, 驱使, 赋予;vi. 出发, 航行, 发芽;n. 掷, 股票出售权, 笨蛋;a. 固定不动的; 发送文件
here|在这里, 此时, 这里;n. 这里
own|自己的;a. 自己的, 嫡亲的, 同胞的;vt. 拥有, 支配, 自认, 承认, 顺从于;vi. 承认, 供认
oh|(表示惊讶、恐怖、赞叹)哦
become|变成, 变得;vt. 适合
Mr|先生; 存储器回收程序, 多重请求
government|政府, 内阁; 政府, 政治, 政体
work|工作, 劳动, 职业, 行为, 功, 作品, 成果, 产品, 工程;vi. 工作, 劳动, 做, 运转, 起作用, 被加工;vt. 使工作, 使转动, 开动, 使用, 经营, 使逐渐变得, 造成
old|以前, 往昔;a. 老的, 旧的, 古老的, 年长的, 老练的
leave|许可, 告别, 请假, 休假;vt. 离开, 剩下, 遗忘, 委托, 丢弃;vi. 出发, 离开, 生叶
life|生活, 生命, 人生, 世事, 生物, 寿命, 一生, 生命力, 灵魂, 无期徒刑; 生活, 生存, 生命, 寿命
great|大的, 非常的, 主要的, 重大的, 崇高的, 伟大的;adv. 顺利地, 得意地;n. 全部, 大人物, 大师
woman|女人, 妇女, 女仆;a. 女用的, 女性的, 妇女的;vt. 贬称...为女人, 使成女人腔
where|在哪里;pron. 哪里;n. 地点
need|需要, 必须, 缺乏;vt. 需要, 必需;vi. 贫困, 有必要;aux. 需要
seem|象是, 似乎
feel|感觉, 觉得, 触摸, 以为;vi. 有知觉, 摸索, 同情;n. 感觉, 觉得, 触摸
system|系统, 体系, 制度, 方式, 秩序, 分类原则; 系统; 体制; 体系
same|相同的, 同样的;pron. 相同的人(或事物);adv. 同样地
ask|问, 要求;vt. 问, 要求, 邀请, 需要
group|团体, 组, 团, 群;v. 聚合, 成群; 创建组; 组, 用户组
number|数, 数字, 数目, 号码;vt. 数, 计算, 共计;vi. 计算, 报数; 数字
yes|是;n. 是, 同意;v. 同意
however|然而, 无论如何, 究竟怎样;conj. 然而, 可是
world|世界, 地球, 宇宙, 万物, 世人, 人间, 领域, 世事, 世故, 社会生活, 大量; 世界, 地球, 世人
show|显示, 表现, 展览, 卖弄, 炫耀, 外观, 演出, 洋相;vt. 表示, 显示, 展现, 陈列, 演出, 表明, 指出, 带领;vi. 露面, 显现, 演出; 显示
house|房子, 住宅, 机构, 议院, 家族, 家庭;vt. 给...房子住, 收藏;vi. 住, 躲藏
area|区域, 面积, 范围, 空地; 区域
another|另外的, 再一的, 不同的;pron. 又一个, 另一个, 类似的另一个
company|公司, 友伴, 交往, 连队, 朋友, 一群;vt. 陪伴;vi. 交往
high|高度, 高处;a. 高的, 高级的, 主要的, 高尚的, 高原的, 高音的, 昂贵的, 傲慢的;adv. 高度地, 奢侈地
most|最多, 最大;a. 大多数的, 几乎全部的, 最多的;adv. 最, 最多, 极其
problem|问题, 难题;a. 成问题的, 难处理的
against|反对, 对着, 倚靠
again|再一次, 又, 到原处
never|从不, 决不, 不曾; 永不, 决不, 从来没有
under|在...之下, 低于;a. 下面的, 从属的;adv. 在下面
try|尝试, 试验, 审理, 审判;vt. 试, 尝试, 试验, 考验, 审问, 提炼;vi. 尝试, 试图
service|服务, 贡献, 雇佣, 公职, 服役, 功劳, 仪式, 送达, 行政部门;vt. 保养, 维修;a. 武装部队的, 服务性的, 仆人的, 耐用的; 服务, 业务
call|呼叫, 访问, 打电话, 号召, 召集, 要求;vt. 呼叫, 召集, 打电话;vi. 叫喊, 访问, 叫牌; 调用; 呼叫; DOS内部命令:在批处理文件中调用另一个批处理文件
much|大量, 许多, 重要的事;a. 很多的, 重要的;adv. 多, 甚, 几乎
school|学校, 鱼群, 门派, 学派;vt. 教育, 训练, 培养;vi. 成群地游
party|宴会, 党, 政党, 团体, 当事人, 聚会;v. 举办聚会
something|某事, 某物
small|小的, 少的, 小型的, 低微的, 小气的, 细微的;adv. 些微地;n. 狭小部分
why|为什么;n. 原因, 理由
each|每个, 每一;adv. 每个;pron. 每个, 个人, 各自
keep|生计, 维持, 保持;vt. 保持, 保存, 遵守, 看守, 整理, 维持, 履行, 经营, 拘留, 记帐;vi. 保持, 继续不断
provide|提供, 供应, 规定, 预备;vi. 作准备, 抚养, 规定
off|关着的, 不再生效的, 处于...境况的, 休假的, 空闲的;adv. 走开, ...掉, ...下, 休息, 出发, 隔断;prep. 离开, 脱落, 不在从事......, 在...之外;vi. 离开, 滚开;vt.…
country|国家, 乡村, 地区, 故乡;a. 乡下的, 农村的; DOS外部命令:用于设定国家代码, 包括日期时间及货币格式
point|点, 小数点, 标点, 地点, 要点, 特点, 尖端, 分数, 得分, 穴位;vt. 弄尖, 强调, 指出, 加标点于, 瞄准;vi. 指, 指向, 表明
different|不同的; 差动, 微分的, 差速器
really|实际上, 真实地, 实在
week|星期, 周
large|大的, 大量的, 宽大的, 广博的;adv. 大大地, 夸大地
member|成员, 会员; │肢, 肢体
turn|转弯, 转动, 旋转, 翻转, 一圈, 顺次, 改动, 变化, 性格, 特色, 形状, 转折;vt. 使旋转, 转弯, 转动, 使转向, 驱赶, 阻挡, 兑换, 改写, 使作对, 绕过, 使流通;vi. 转动, 转弯, …
always|总是, 始终
follow|跟随, 沿行, 遵循, 追求;vi. 跟随, 接着;n. 跟随, 追随
end|结束, 终点, 目标, 末端, 梢, 死亡, 残余;v. 结束, 终结, 终止; 端; 结束
without|没有, 不, 在...之外;adv. 在外面, 户外;n. 外面, 外部
few|很少的, 不多的, 少数的;n. 少数
within|内部, 里头;adv. 在内部, 在内心里;prep. 在...之内
local|地方性的, 当地的, 局部的, 乡土的, 本地的;n. 当地居民, 本地新闻, 局部; 本地的; 局部
during|在...的时候
begin|开始; 开始
state|州, 状态, 情形, 国家, 政府, 领土, 国务, 社会地位;a. 国家的, 正式的, 礼仪用的, 州的;vt. 说明, 陈述, 规定; 状态
bring|带来, 产生, 促使, 提出;vi. 生产
word|话, 消息, 词, 诺言, 命令;vt. 用言辞表达; 字
although|虽然, 尽管
before|在...之前;conj. 在...之前;adv. 在前
next|下一个;a. 下一个的, 其次的, 贴近的;adv. 然后, 下次, 次于; 近邻干扰
family|家庭, 家人, 族;a. 家庭的
fact|事实, 真实性, 真相, 细节, 论据
social|社会的, 群居的, 社交的;n. 联欢会
help|帮忙, 帮助者, 补救办法, 有益的东西;vt. 帮助, 帮忙, 接济, 治疗, 款待;vi. 有用, 救命, 招待; 帮助, 帮助程序; DOS外部命令: DOS命令的电子文件帮助程序
start|惊起, 出发, 开端, 起点, 吃惊, 有利条件;vi. 开始, 出发, 启动, 跳起, 吃惊, 出现, 松动, 脱落, 起价, 参赛;vt. 使惊起, 开动, 发动, 启动, 开始, 创办, 提议, 使松动, 使脱落,…
quite|相当, 完全, 十分
run|跑, 赛跑, 奔跑, 奔跑的路程, 趋向, 流出, 运转时间, 连续;vi. 跑, 奔跑, 跑步, 赛跑, 竞赛, 行驶, 运转, 进行, 蔓延;vt. 使跑, 参赛, 追究, 驾驶, 开动, 管理, 经营, 使流出, …
head|头, 头脑, 领袖, 脑袋, 最前的部分;vt. 为首, 朝向, 前进, 用头顶;vi. 朝特定方向行进, (作物)结穗;a. 头的, 在顶端的, 主要的; 磁头; 冲头
every|每一, 所有的
write|书写, 著述, 写, 写满, 写信给;vi. 写, 写字, 写信, 写作, 作曲; 书写器
side|旁边, 侧, 方面, 胁, 侧边, 血统;a. 旁的, 侧的, 次要的;vt. 同意, 支持;vi. 支持, 赞助
month|月; 月
business|生意, 事情, 业务, 商业, 商行, 职责; 企业, 商业, 营业
night|夜, 夜晚, 晚上, 黑暗, 夜晚的工作; 夜, 黑夜, 黑暗
important|重要的, 有地位的, 大量的, 显要的, 自负的; 要点
eye|眼睛, 视力, 看;vt. 看, 注视
move|移动, 迁居, 步骤;vt. 移动, 开动, 感动, 搬(家);vi. 移动, 离开, 运行, 迁移, 摇动, 搬家, 交往, 进展, 脱手; 移动; 传送; DOS外部命令:移动文件, 它可将文件移动到指定的地方
question|问题, 询问;v. 询问, 审问, 怀疑; 询问
information|消息, 知识, 通知, 情报, 信息, 问讯处, 起诉; 信息
play|游戏, 游玩, 玩笑, 运动, 比赛, 赌博, 跳动, 表演, 剧本;v. 玩, 游戏, 假装, 开玩笑, 比赛, 扮演, 演奏, 演戏, 传摇曳, (使)跳动; 播放
power|力, 体力, 力量, 势力, 动力, 权力, 强国, 乘方, 强度, 幂, 功率;vt. 使...有力量, 供以动力, 激励; 乘幂; DOS外部命令:能控制许多电池电源计算机上的电源管理特性
change|变化, 找回的零钱, 找头, 更换;vt. 改变, 更换, 兑换
pay|薪资, 付款, 补偿;vt. 支付, 付清, 补偿, 偿还, 对...有利, 为...涂防水物;vi. 付款, 付出代价, 偿还, 得到报应, 获得好处
young|年轻的, 无经验的, 朝气蓬勃的;n. 青年们, 幼小动物, 崽
both|两者的;adv. 两者都;pron. 两者
often|时常, 常常
interest|兴趣, 嗜好, 利息, 利益, 爱好, 趣味, 势力;vt. 使感兴趣, 与...有关系
national|国家的, 国立的, 全国性的, 民族的; 全国性的, 国家的, 国民的
money|金钱, 一笔款, 财富, 货币, 金额; 货币, 金钱, 财产
development|发展; 展开
book|书, 书籍, 帐簿, 名册, 工作簿;v. 登记, 预订; 工作簿
water|水, 雨水, 海水, 水位, 水面, 流水;vt. 给...浇水, 供以水, 注入水, 使湿;vi. 流泪, 流口水, 加水;a. 水的, 水上的, 水生的, 含水的
away|离去
hear|听到, 倾听, 听说, 审理;vi. 听见, 听
room|房间, 空位, 场所;vi. 住宿, 居住;vt. 留宿
level|水平, 水准, 平地;a. 同高的, 平坦的, 齐平的, 水平的;vt. 弄平, 夷平, 使同等, 瞄准, 对准;vi. 变平, 拉平; 级别
second|秒, 瞬间, 第二名, 支持者, 助手;a. 第二的, 其次的, 次要的, 附加的, 辅助的;num. 第二;vt. 当...助手, 支持
early|早的, 早熟的;adv. 很早, 初
include|包括, 把...算入, 包住; DOS内部命令:在CONFIG.SYS文件的一个配置块中包含另一配置块的内容
car|汽车, 客车; 车
perhaps|也许, 大概
policy|政策, 方针, 策略, 保险单; 凭单, 保险单
council|会议, 委员会; 委员会
believe|相信
market|市场, 交易, 集市, 推销地区, 行情, 市面, 销路;vt. 在市场上交易, 使上市, 销售;vi. 在市场上买卖
already|已经, 早已
possible|可能的, 潜在的, 合适的;n. 可能性, 可能的事物
allow|允许, 同意给予, 承认;vi. 容许, 猜想; 允许命令
nothing|无, 不关紧要之事, 零;adv. 毫不, 决不;interj. 什么也没有, 无
meet|会, 集会;a. 适宜的, 合适的;vt. 遇见, 引见, 认识, 满足, 对付;vi. 相遇, 接触
big|大的, 重要的;adv. 大量地
yet|还, 尚, 仍然, 已经, 然而;conj. 然而
effect|结果, 影响, 效果, 印象;vt. 实行, 引起, 完成; 效果
result|结果, 成绩, 答案;vi. 产生, 结果, 致使; 结果
whether|是否, 不论;pron. 两个中的哪一个
idea|主意, 办法, 理想, 思想, 概念, 意见; 观念, 思想
study|学习, 研究, 学科, 论文, 求学, 书房, 试作;vt. 学习, 读书, 研究, 考虑, 计划;vi. 学习, 思索
name|名字, 名称, 姓名, 名义, 名誉, 文件名;vt. 命名, 称呼, 任命, 提名, 列举;a. 姓名的, 据以取名的; 名称, 文件名, 姓名
job|工作, 零活, 职业, 事情;vi. 做零工, 打杂, 做股票经纪, 假公济私;vt. 代客买卖, 批发, 承包, 欺骗; 作业
stand|站立, 站住, 停顿, 讲台, 看台, 立场, 法院证人席;vi. 站, 立, 坐落, 停滞, 位于, 坚持, 维持原状;vt. 忍受, 使站立, 抵挡
body|身体, 人, 尸体, 主要部分, 团体;vt. 赋以形体; 体
happen|发生, 发生, 恰巧
report|报告, 报道, 传说, 案情报告, 爆炸声, 成绩单;vt. 报告, 汇报, 转述, 报道, 揭发, 使报到;vi. 报告, 写报道, 报到; 报告
line|列, 线, 绳, 电线, 线路, 路线, 航线, 作业线, 界线, 战线, 外形, 排, 家系;vt. 排成一行, 顺...排列, 划线于, 加衬里, 使有线条, 使起皱纹;vi. 排队; 线路
law|法律, 法则, 定律, 法律的制约, 法学, 司法界, 诉讼;v. 起诉
later|以后, 随后
almost|几乎, 差不多
friend|朋友, 支持者, 赞助者; 朋友, 友人, 赞助者
face|脸, 面容, 正面, 外观;vt. 面对, 朝, 正视, 面临;vi. 朝, 向; 现场可改变的控制元件
carry|进位, 射程, 运载;vt. 携带, 运送, 支持, 传送, 包含;vi. 被携带, 能达到; 进位; 进位数
road|路, 道路, 公路, 途径, 方法; 公路, 道路, 行车道
authority|权力, 当权者, 当局, 权威, 专家; 代理权, 授权, 权威
himself|他自己, 他亲自
far|远的, 久远的, 遥远的;adv. 甚远地, 很, 到很深的程度, 到很远的距离
together|一起, 共同, 彼此
talk|谈话, 交谈, 会谈, 讲话, 演讲, 空谈, 谣言, 方言, 语言;vi. 讲话, 演讲, 说话, 谈话, 交流, 闲聊, 说闲话;vt. 讲, 说, 讨论, 谈论; 对话类, 聊天
appear|出现, 显得, 来到; 出庭, 到案, 出现
little|一点点, 少许, 一会儿, 短时间;a. 小的, 很少的, 幼小的, 琐碎的, 短暂的, 矮小的;adv. 很少, 稍微, 完全不
political|政治的, 政治上的, 政党的, 从事政治的; 政治的, 政治上的, 党派政治的
minister|部长, 牧师, 公使;vi. 服侍, 救助, 主持宗教仪式
able|能干的, 能够的
produce|生产品, 物产, 后代;vt. 产生, 生产, 提出, 出示;vi. 生产, 制造
rate|比率, 率, 速度, 价格, 费用, 等级;vt. 估价, 认为, 鉴定等级, 责骂;vi. 被评价, 责骂
late|迟的, 晚的, 已故的;adv. 很晚, 很迟, 晚
hour|小时, 钟头, 时间, ...点钟, 课时
door|门
general|一般, 将军, 大体;a. 全面的, 大体的, 总的, 一般的, 普遍的;n. 常规; 常规
sit|坐, 就座, 坐落;vt. 使就座, 骑;n. 坐, 衣服合身
office|办公室, 部, 公职, 职责; 办公室
war|战争, 战争状态, 战术, 军事, 冲突, 斗争, 竞争;vi. 进行战争, 作战, 打仗, 战斗;a. 战争的, 战时用的
since|自...以后, 自...以来;adv. 自那时以后;conj. 既然, 自...以后, 自...以来
mother|母亲, 修女院长;vt. 产生, 照看, 收养
offer|给予(物), 出价, 提议, 意图, 报价;vt. 提供, 出价, 奉献, 试图, 使出现, 演出;vi. 出现, 献祭, 提议, 求婚
person|人, 人身, 人称; 人, 法人, 人身
full|全部, 完整;a. 充满的, 完全的, 丰富的, 完美的, 丰满的, 详尽的;adv. 完全地, 整整, 十分;vt. 把(衣服等)缝得宽松, 漂洗; 完整
reason|理由, 原因, 理智, 道理, 前提, 理性;vt. 说服, 推论, 辩论;vi. 推论, 劝说, 思考
view|视野, 风景, 见解, 视力, 观看, 视图, 指望, 意图, 印象;vt. 看, 考虑, 视察, 查看, 估量; 视图
consider|考虑, 思考, 认为
expect|预期, 盼望, 期待
suggest|提议, 建议, 促成, 暗示, 启发, 使人想起; 建议, 提出, 提议
anything|任何事
term|术语, 专有名词, 期限, 学期, 任期, 条件, 价钱, 关系, 地位, 项, 界石;vt. 称, 呼; 检索词; 项
towards|向, 对于, 为了
low|低点, 低价, 低, 牛叫声;a. 低的, 消沉的, 低等的, 浅的, 卑贱的;adv. 低下地, 谦卑地, 低;vi. 牛叫
public|公众, 民众;a. 公众的, 公共的, 公立的, 公用的
let|让, 假设, 出租, 排放, 妨碍;vi. 出租, 被承包;n. 出租屋, 障碍
read|读, 阅读, 理解;a. 有学问的;n. 读取, 阅读; 读取
continue|继续, 延续, 延长;vt. 使继续, 使延长
figure|数字, 价格, 图形, 形状;vt. 描绘, 表示, 演算, 认为;vi. 计算, 出现, 估计
society|社会;社交界;交往;社团
centre|中心, 中心点, 中锋;a. 中央的, 位在正中的;vt. 集中, 定中心;vi. 居中
police|警察, 警察当局, 治安;vt. 维持治安, 管辖
lose|遗失, 损失, 丢失, 使失去, 错过, 浪费, 迷失, 使迷路, 输去, 使沉溺于;vi. 受损失, 失败
add|增加, 添加, 附带说明, 计算...总和;vi. 做加法, 积累而成, 增添; 加法
fall|落下, 瀑布, 采伐量, 下降, 落差, 降低, 堕落, 秋天;vi. 倒下, 落下, 来临, 失守, 阵亡, 下跌, 减弱, 倾斜, 垮台, 轮到, 变成, 降低;a. 秋天的
probably|大概, 或许
available|可利用的, 可获得的, 有效的; 有效的, 可得的
community|社区, 公众, 共有, 共同体; 公众, 共有, 社会
price|价格, 代价, 价值;vt. 定...的价格
control|控制, 管理, 克制, 控制器, 操纵装置;vt. 控制, 操纵, 抑制; 控制; 控制器
action|行动, 活动, 动作, 作用, 战斗, 行为, 诉讼;vt. 对...起诉; 方式
issue|发行, 问题, 后果, 流出, 出口, 争端;vi. 发行, 流出, 造成...结果, 传下;vt. 使流出, 放出, 发行, 发布, 发给
cost|代价, 价值, 费用;vi. 花费;vt. 使失去, 值, 使花费
process|程序, 进行, 过程;vt. 加工, 使...接受处理, 对...处置, 对...起诉;a. 经加工的, 有特殊光效的; 进程
remain|保持, 逗留, 剩余; 停留, 居住, 继续
position|位置, 地位, 身分, 形势, 姿势, 立场, 职位, 状态, 阵地;vt. 安置, 决定...的位置; 位置
remember|记得, 回忆起, 记住, 铭记, 纪念;vi. 记得
course|课程, 路线, 过程, 一道菜, 道路;v. 追, (使)跑
bad|坏的;n. 坏;adv. 坏地
today|今天, 当今, 现在;adv. 今天, 当今
buy|买, 获得;vi. 买;n. 购买, 买得的东西
speak|说, 说话, 演说, 发言;vt. 说, 讲, 说出
education|教育, 训练, 教育学; 教育, 训练
actually|事实上, 竟然, 如今, 现在
ever|曾经, 究竟, 永远
research|研究, 调查, 考察;vi. 研究, 调查
stop|停止, 车站, 逗留, 填塞, 障碍, (风琴的)音栓;vi. 停止, 被塞住;vt. 塞住, 堵塞, 阻止, 击落, 停止, 终止, 断绝
programme|节目, 节目单, 程序, 纲要, 大纲, 计划;vt. 规划, 拟...计划;vi. 安排节目, 编程序
moment|片刻, 瞬间, 重要, 阶段, 力矩; 片刻, 瞬间, 时机, 因素, 矩
girl|女孩, 少女, 女佣
age|年龄, 老年, 成年, 寿命, 时代, 时期;v. 变老, 成熟
father|父亲, 祖先, 长辈, 神父, 创始者;vt. 当...的父亲, 保护, 创作, 发明, 培养
send|发送, 使进入, 寄, 派遣, 发射, 使陷于;vi. 寄信, 派人, 播送;n. (船的)上升运动; 发送
value|价值, 价格, 购买力, 评价, 估价, 计算结果;vt. 评价, 估价, 重视; 计算结果
force|力量, 武力, 势力, 影响力, 军队, 力, 效力;vt. 强迫, 强夺, 推动, 提高; 人工转移; 强制
matter|事件, 物质, 原因, 素材, 实体, 重要;vi. 有关系
act|行动, 行为, 幕, 法案;vi. 行动, 表演, 假装, 见效, 表现, 担当;vt. 扮演, 装作; 先进通信技术, 先进计算机工艺, 自动代码翻译技术
receive|收到, 接到, 得到, 接待, 迎接, 承受;vi. 收到, 会客; 接收
health|健康, 卫生, 蓬勃, 健康状态; 健康
decide|决定, 判决
main|主要部分, 干线, 体力, 力量, 主群组;a. 主要的, 重要的, 全力的; 主群组
though|然而, 可是;conj. 虽然, 纵然
enough|充足, 够, 很多;a. 充足的, 足够;adv. 足够;interj. 够了
less|较少, 较小;a. 少的, 小的;adv. 较少, 较小, 较差; 最低成本估算与调度法
street|街道, 马路, 街区;a. 街道的
decision|决定, 决心, 决断; 判定
until|直到, 在...以前;conj. 直到...时, 在...以前
industry|勤劳, 工业, 企业, 产业, 有组织的劳动; 工业, 实业
sure|确信, 必然的, 必定的;adv. 当然, 确实地, 无疑地
class|班级, 阶级, 种类, 课;vt. 分类; 类别; 类; 种类; 类程
win|赢得, 打胜, 成功;vi. 获胜, 达到, 影响;n. 胜利, 赢, 收益
several|几个的, 一些的, 各自的;pron. 几个
clear|清楚的, 明确的, 澄清的;adv. 清晰地;vt. 澄清, 清除障碍;vi. 放晴, 变清澈;n. 空隙; 清除
understand|理解, 了解, 领会, 听说, 懂;vi. 懂得, 认为
major|主修课, 成年人, 陆军少校;a. 主要的, 较多的, 大部分的, 成年的, 严重的;vi. 主修; 主要, 主要刻度
themselves|他们自己, 她们自己, 它们自己
paper|纸, 文件, 文章, 报纸, 证券, 证件;vt. 用纸糊, 贴壁纸于, 用纸包装;vi. 贴壁纸;a. 纸做的, 纸上的
itself|它本身, 它自己
around|包围, 在...周围, 四处;adv. 兜着圈子, 在附近, 到处
describe|描述, 描绘, 画
condition|情况, 条件;vt. 使健康, 以...为条件, 决定, 使适应; 条件
develop|发展, 使发达, 进步, 洗印, 显影;vi. 发展, 生长
agree|同意, 赞成, 应允, 适合;vt. 承认, 认定, 同意
economic|经济上的, 实用的, 节省的; 经济的
open|公开, 户外, 空旷;a. 开着的, 开放的, 开阔的, 营业着的, 公开的, 悬而未决的;vt. 打开, 公开, 开放;vi. 展开, 开始, 展现; 打开指令; 打开语句
reach|伸出, 延伸, 区域, 范围, 流域, 岬;vt. 到达, 达到, 伸出, 延伸, 影响;vi. 达到, 延伸, 伸出手, 传到
century|世纪, 百年
build|建立, 建筑;n. 构造, 体格
including|包含, 包括; 包括, 算入
sense|感应, 感觉, 感官, 意识, 观念, 情理, 知觉, 理智;vt. 感觉, 觉察, 检测; 阅读; 检测
among|在...之中
building|建筑物, 建筑; 营造, 建筑, 建筑物
sort|种类, 方式, 品质, 态度, 举止;vt. 分类, 排序, 挑选;vi. 交往, 协调; 排序; DOS外部命令:从标准输入设备接收数据, 整个数据输入完后;对它以行为单位进行排序, 然后在标准输出设备上输出
likely|有可能的, 合适的, 前途有望的;adv. 或许, 可能
staff|全体人员, 工作班子, 棍棒, 杆, 拐杖, 支柱, 权杖;a. 职员的, 雇员的, 参谋的;vt. 为...配备人员
spend|花费, 浪费, 度过, 消耗, 消磨;vi. 花费, 用尽
real|真的, 真实的, 实际的, 实在的, 不动(产)的, 实数的;n. 实数, 现实;adv. 真正地
black|黑色, 黑颜料;a. 黑色的
team|队, 组;vt. 把马(牛)套在同一辆车上, 把...编成一组;vi. 驾驶卡车, 协作
return|回来, 返回, 来回票, 归还, 报答, 利润率, 报告书;a. 返回的, 回程的, 报答的, 反向的, 重现的, 复原的;vi. 返回, 归还, 回来;vt. 归还, 还, 回报, 产生, 反射, 报告, 申报, 退回…
draw|拉, 拖, 拔剑;vt. 拖拉, 挨近, 领取, 打成平局, 引导, 抽签决定, 画, 描写, 制订, 草拟, 吸引;n. 拉, 拖, 拔出, 抽签, 平局; 翻牌, 绘图
experience|经历, 经验, 体验;vt. 经历, 经验, 体验
student|学生, 研究者, 学者
town|城镇, 市, 镇; 城镇, 城市, 闹市
Mrs|太太
international|国际的;n. 国别设定; 国别设定
either|(两者之中)任一的, (两者之中)各一的;pron. (两者之中)任一;conj. 或, 要么
special|专辑, 专车, 号外, 特别的东西, 负有特别任务的人员;a. 特别的, 专门的, 特殊的, 额外的, 附加的, 特别亲密的
difficult|困难的
plan|计划, 方案, 策略, 方法, 进度表, 程序表, 平面图, 设计图, 轮廓, 示意图;vt. 计划, 设计, 意欲;vi. 订计划
die|死亡, 消逝, 平息, 熄灭, 漠然, 渴望;vt. 死;n. 骰子, 冲模
hope|希望, 信心, 期待;v. 希望, 期望, 信赖
morning|早晨, 早上, 初期
department|部门, 系, 机关; 部, 科
across|越过, 穿过, 与...相交叉, 在...的对面;adv. 交叉, 到另一边, 在对面, 成十字
create|创造, 建造, 引起, 任命
committee|委员会; 委员会
product|产品, 结果, 乘积; 生产物
whole|全部, 全体, 整体, 完全之体系;a. 所有的, 完整的, 完全的, 纯粹的
letter|信, 字母, 证书, 字面意义, 铅字, 学问, 出租人;vt. 写字母于, 在...上刻字母, 用字母标明;vi. 写印刷体字; 字母
ground|土地, 战场, 场地, 地面, 范围;a. 土地的, 地面上的;vt. 放在地上, 使搁浅, 打基础, 给...以训练;vi. 搁浅, 落地, 根据, 基于;a. 磨过的;grind的过去式和过去分词
meeting|会议, 会面; 会议, 会谈, 集会
walk|走, 散步, 步行, 行走的路程, 竞走, 散步场所;vi. 走路, 步行, 处世;vt. 走过, 遛, 使走, 护送...走
foot|脚, 步调, 英尺, 底部, 末尾, 步兵;vt. 走在...上, 给...换底, 支付;vi. 跳舞, 步行, 总计
rather|宁可, 稍微, 相当
sell|卖, 背叛, 销售, 出卖;vi. 卖, 销售;n. 卖, 推销术, 失望
boy|男孩; 男孩, 少年, 儿子
wait|等待, 等候;vt. 等候, 期待, 延缓, 伺候, 推迟;vi. 等, 等候, 耽搁, 伺候用餐; 等待
game|比赛, 玩耍, 比分, 得胜, 比赛规则, 策略, 游戏, 野味;vi. 赌博;a. 勇敢的, 有胆量的, 关于野味的, 跛的; 博弈; 对策
food|食物, 养料; 食物, 食品
union|联盟, 联合, 结合, 工会; 联合; 联管节; 活接头
role|角色, 职责, 任务; 作用, 功用
half|一半, 半场, 不完全;a. 一半的, 不完全的, 部分的, 半场的;adv. 一半地, 部分地, 在某种程度上地, 几乎
else|别的, 其他的;adv. 另外, 否则, 不然
land|陆地, 地面, 地界, 地产, 国土, 土地;vi. 登陆, 登岸, 到达;vt. 使上岸, 使登陆, 使到达; 连接盘; 焊盘
event|事件, 结果, 事情的进程, 竞赛项目; 事件
white|白色, 洁白, 眼白, 白种人, 蛋白;a. 白色的, 纯洁的, 白种的, 苍白的, 空白的, 幸运的
cause|原因, 目标;vt. 引起, 使产生, 使遭受
art|艺术, 人文科学, 技术, 巧妙, 诡计, 美术; 实际保持时间, 特许权和资源表, 平均检索时间, 平均运行时间
pass|经过, 要隘, 途径, 通行, 护照, 及格;vt. 经过, 越过, 通过, 批准, 度过, 传递, 忽略;vi. 经过, 变化, 流通, 及格, 宣判, 终止, 消逝, 被忽略, 不叫牌, 传递; 遍
support|支持, 支撑, 援助, 供养, 支撑物;vt. 支援, 支撑, 帮助, 支持, 忍受, 供养, 证实; 后援; 支持
stage|阶段, 舞台, 场所, 戏剧, 站, 驿站, 级, 层, 脚手架;vt. 上演, 表演, 筹划;vi. 适于上演, 乘驿车旅行
trade|贸易, 商业, 交易, 生意, 职业, 顾客, 信风;vi. 进行交易, 做买卖, 经商, 对换, 购物;vt. 用...进行交换
accept|接受, 承认, 同意, 相信, 赞成, 承担, 承兑, 采纳, 接纳, 容忍;vi. 同意
behind|在后地;prep. 在...背后
arm|手臂, 袖子, 狭长港湾, 武器;vt. 武装, 装备;vi. 武装起来; 异步应答方式; 自动货品销路管理
club|俱乐部, 木棍, 球棒;vt. 用棍棒打, 缴纳;vi. 联合起来;a. 俱乐部的
parent|父母, 父母亲, 根源; 父亲, 母亲, 根源
history|历史, 过去, 经历, 发展过程, 历史学, 过去的事, 历史记录; 历史记录
free|自由的, 享受政治权力的, 允许的, 免费的, 丰富的;vt. 释放, 解放, 使自由;adv. 自由地, 免费
account|报告, 解释, 估价, 理由, 利润, 算账, 帐目;vi. 报帐, 解释, 导致, 报偿, 占, 杀死;vt. 认为; 帐户, 帐号
whose|谁的
easy|容易的, 缓缓的, 舒适的, 从容的, 宽容的, 流畅的, 随便的, 自在的, 疲软的;adv. 容易地, 慢慢地
situation|情形, 境遇, 位置; 情境, 处境
ago|以前
care|小心, 照料, 忧虑;vi. 关心, 介意;vt. 在意, 喜欢
strong|强壮的, 坚固的, 坚强的, 强烈的, 有力的, 优良的;adv. 强劲地, 有力地, 猛烈地
record|记录, 履历, 档案, 审判记录, 最高纪录, 唱片;vt. 记录, 记载, 标明, 将...录音;vi. 记录, 录音, 可被录音;a. 创纪录的; 录制, 记录
raise|上升, 高地, 增高;vt. 升起, 举起, 唤起, 提高, 使出现, 使复活, 提出, 筹集, 饲养
example|例子, 样本, 实例; 实例
yesterday|昨天;adv. 昨天
base|底部, 垒, 基础, 基地;vt. 以...作基础;a. 卑鄙的, 低劣的; 基准
break|休息, 中断, 破裂处, 绝交, 破晓, 突变;vt. 打破, 弄破, 弄坏, 破坏, 违反, 打断, 削弱, 放弃;vi. 破碎, 决裂, 破晓, 突变, 变弱, 暂停;n. 分隔符; 分隔符; 中断; DOS内部命令…
learn|学习;认识到;得知
central|中央的, 重要的; 中央的, 中心的, 中枢的
increase|增加, 增进, 利益;vt. 增加, 加大;vi. 增加, 繁殖
grow|种植, 使长满;vi. 生长, 变成, 发展
cover|盖子, 封面, 藉口;vt. 覆盖, 掩饰, 保护, 掩护, 包括;vi. 覆盖
air|空气, 旋律, 态度;vt. 晾, 使通风, 夸耀
university|大学
wife|妻子, 太太, 夫人; 妻子, 已婚妇女
claim|要求, 要求权, 断言, 权利;vt. 要求, 认领, 主张;vi. 提出要求, 主张, 断言
sir|先生, 阁下
everything|每件事物, 所有事物
rule|规则, 统治, 控制, 支配, 规律, 标准, 章程, 破折号, 铅线;vt. 规定, 统治, 管理, 控制, 支配, 裁决;vi. 统治, 管辖, 裁定; 规则, 水线
cut|切口, 割伤, 降低, 切, 割, 砍, 削, 伤口, 削减, 缩短, 删节, 通路;a. 经切割的, 缩减的;vt. 切, 割, 减少, 刺痛, 开辟, 雕刻, 删节, 缩短, 停止, 排斥, 切断, 关, 显出;vi…
story|故事, 小说, 传奇, 描述, 阅历, 经历, 层
worker|工人, 劳动者; 工人, 劳工, 劳动者
tax|税, 税款, 重负, 会费;vt. 课以税, 使负重荷, 斥责
pound|磅, 英镑, 重击, 鱼塘, 拘留所, 兽栏;vt. 强烈打击, 捣烂, 监禁, 关入栏内;vi. 连续重击, 苦干
once|一次, 曾经, 一旦;conj. 一旦, 一经;n. 一次;a. 从前的
stay|停留, 逗留, 制止, 延缓, 停止, 支柱, 支撑物, 支索;vt. 制止, 延缓, 坚持, 支持, 支撑, 用支索固定;vi. 停留, 逗留, 暂停, 坚持, 中止
human|人, 人类;a. 人类的, 似人类的, 人性的, 有同情心的
officer|军官, 主管, 官员, 公务员;vt. 指挥
hospital|医院; 医院
single|单身的, 单程的, 单一的, 个别的, 孤独的, 专一的;n. 一个, 单打, 单程票;vt. 选出;vi. 击出一垒打; 单精度型
hard|坚硬的, 硬的, 难的, 艰苦的, 困难的, 坚固的, 猛烈的, 艰难的, 结实的, 确实的;adv. 坚硬地, 努力地, 辛苦地, 接近地, 猛烈地, 牢固地
wall|墙, 墙壁, 垣, 内壁, 分界物, 屏障;a. 墙的;vt. 给...建墙, 禁闭, 用墙围住; 背景墙
join|参加, 结合, 加入;vt. 连接, 结合, 参加, 加入;n. 连接, 结合, 接合点; 连接; 汇合指令
herself|她自己, 她亲自
bit|少量, 马嚼子, 辅币;vt. 给马上嚼子, 控制;bite的过去式和过去分词; 比特, 二进制数位, 机内测试
former|从前的, 前者的;n. 起形成作用的人(或物), 模型, 样板
president|总统, 总裁, 董事长, (学院)院长, (大学)校长, 主管人, 主持人; 总经理, 董事长, 总裁
seek|寻求, 寻找, 探索, 追求, 搜索, 请求;vi. 寻找, 搜索; 查找
son|儿子, 女婿, 子孙; 儿子, 女婿, 养子
wide|宽的, 广阔的, 普遍的, 宽阔的, 广泛的, 一般的;adv. 广阔地, 遍及各处地, 广泛地;n. 大千世界
financial|财政的, 金融的; 财政的, 金融的, 财务的
director|主管, 导演, 董事; 寻向偶极子; 指挥仪
leader|领导者, 社论, 指挥, 领袖, 领唱者, 前导字符; 前导字符
firm|公司, 商号;a. 坚定的, 坚强的, 牢固的, 结实的, 坚硬的, 坚挺的, 严格的, 确定的;vt. 使牢固, 使坚定;vi. 变稳固, 变坚实;adv. 稳固地
us|我们; 美国
soon|不久, 早, 快, 宁可
fail|失败, 缺乏, 中断, 衰退, 失灵;vt. 忘记, 使...失望, 缺乏, 不及格;n. 不及格
chance|机会, 意外, 可能性;vi. 偶然发生;vt. 冒险
operation|操作, 动作, 手术, 运算, 作用, 业务; 运算
share|部分, 参与, 一份, 参股, 份额;vt. 均分, 分担, 分享, 分配, 共有;vi. 分享; 共享; DOS外部命令:在网络或多工系统中提供文件共享;文件锁定及检测磁盘更动和对超过32MB硬盘分区的支持
test|测试, 试验, 化验, 检验, 考验, 甲壳;vt. 测试, 试验, 化验;vi. 接受测验, 进行测试
recent|最近的, 近代的, 最新的; 最近的, 新进的
security|安全, 安全性, 防护物, 保安, 可靠性, 担保人, 抵押品, 保证金; 安全性, 保密性, 安全检查程序
kill|杀, 杀戮, 小河;vt. 杀, 破坏, 消灭, 使终止, 抵消, 否决;vi. 杀死; 删除
election|选举, 当选, 选择权; 选举, 当选
future|未来, 将来;a. 将来的, 未来的
drive|驾车, 快车道, 推进力, 驱动, 动力, 击球, 驱动器;vt. 开车, 驱使, 推动, 驾驶;vi. 开车, 猛击, 飞跑; 驱动器
colour|颜色, 面色, 颜料, 外貌;vt. 把...涂上颜色, 粉饰, 使脸红, 歪曲;vi. 变色
rise|上升, 增加, 上涨, 高地, 升高, 出现;vi. 升起, 起身, 起立, 上升, 上涨, 增长, 高耸, 起义, 浮现;vt. 使飞起
page|页, 记录, 事件, 专栏, 男侍;vt. 标明...的页数, 翻...的书页, 分页排版, 呼叫, 侍候;vi. 翻书页, 侍侯; 页; 页面
music|音乐, 乐曲
love|爱, 恋爱, 爱情, 爱好, 性爱;vt. 爱, 爱好, 爱慕;vi. 爱
charge|指控, 费用, 冲锋, 电荷, 炸药, 主管, 被托管人, 命令;vt. 控诉, 加罪于, 使充满, 使充电, 使承担;vi. 冲锋, 要价, 收费
design|设计, 图样, 方案, 企图;v. 设计, 计划
pressure|压, 榨, 按, 强制, 压力, 压迫, 压强;vt. 迫使, 使增压, 密封
plant|植物, 作物, 工厂, 树枝, 生长, 设施, 成套设备;vt. 种植, 栽培, 播种, 培养, 安置, 殖民于, 使位于;vi. 种植
news|新闻, 消息, 报导; 新闻, 消息, 新闻报导
further|更远的, 此外的, 更多的;vt. 促进, 增进, 助长;adv. 更进一步地, 更远地, 此外
better|较好的;adv. 比较好
thought|想法, 思想, 思维, 关心, 挂念;think的过去式和过去分词
list|目录, 名单, 明细表, 布条, 条纹, 列表, 序列, 数据清单;vt. 列出, 列于表上, 记入名单内, 装布条;vi. 列于表上; 列表, 序列, 数据清单
step|步骤, 步, 步幅, 脚步声, 踏级, 步伐, 短距离, 步态, 手段, 等级;vt. 踏, 以步测量, 跨步, 使成阶梯状;vi. 跨步, 轻快地走, 跳舞, 踩, 踏上, 行走; 步骤
demand|要求, 需求, 需要;v. 要求, 查询
labour|劳动, 努力, 工作, 劳工, 分娩;vi. 劳动, 努力, 苦干;vt. 详细分析, 使厌烦
near|近的, 近亲的, 近似的;adv. 接近, 亲近;prep. 靠近, 近似于;v. 接近, 走近
capital|首都, 大写字母, 资本;a. 首都的, 重要的
player|竞赛者, 上场队员, 游戏者, 演员; 交易者
film|软片, 薄膜, 胶卷, 电影;vt. 覆以薄膜, 拍摄;vi. 生薄膜, 拍电影
attempt|尝试, 企图;vt. 尝试, 企图
effort|努力, 成就
cup|杯子, 茶杯, 优胜杯;vt. 使成杯状, 为...拔火罐
current|涌流, 趋势, 流;a. 流通的, 现在的, 当前的, 流行的; 当前的
thank|谢意, 感谢;vt. 谢谢, 感谢
top|顶部, 顶端, 极点, 上面, 上部, 顶篷, 最高地位, 首位, 陀螺;a. 最高的, 顶上的, 头等的;vt. 盖, 加以顶, 高达, 超越;vi. 结束, 达到顶点, 高出; TOP协议
final|期末考试, 结局, 决赛;a. 最后的, 终极的, 决定性的
east|东方, 东;a. 东方的, 向东的;adv. 向东方, 朝东方
west|西方, 西部;a. 西方的, 向西的;adv. 向西, 自西方, 在西方
announce|宣布, 声称, 显示, 预告;vi. 当报幕员, 宣布参加竞选
red|红的, 红色的, 红肿的, 流血的;n. 红色, 红颜料, 赤字; 简化, 减少
serious|严肃的, 认真的, 重要的, 严重的; 严重的
answer|答案, 回答, 回报, 答辩;vt. 回答, 反驳, 适应, 响应, 符合;vi. 回答, 答应, 负责, 符合, 成功; 用户问题及答案新闻组
economy|经济, 理财, 节约; 经济, 整体
army|军队, 陆军
along|平行地, 向前;prep. 沿着
brother|兄弟
total|全体的, 总的, 全然的;vt. 计算...的总和, 共计为;vi. 合计;n. 总数, 全体, 合计;adv. 统统
season|季节, 时节, 当令期, 时期;vt. 给...调味, 使成熟, 使老练, 缓和;vi. 变干燥
concern|关心, 忧虑;vt. 与...有关, 使担心, 使挂念
save|救球;vt. 解救, 挽救, 储蓄, 保存, 节省, 保留;vi. 挽救, 节省, 救球;prep. 除...之外; 保存
fund|基金, 资金, 存款, 财源, 贮藏;vt. 提供资金, 积累
outside|外面, 外表, 外界;a. 外面的, 外表的, 外界的;adv. 外面, 外表, 外界
visit|拜访, 访问, 游览, 视察;vt. 拜访, 访问, 参观, 视察, 降临;vi. 访问, 参观, 闲谈
daughter|女儿;a. 女儿的
conference|会议; 会议, 讨论会, 协商会
oil|油, 石油, 油画颜料;vt. 涂油于, 使融化成油状, 加油于;vi. 加燃油, 融化
attack|攻击, 抨击;vt. 攻击, 抨击, 动手干;vi. 攻击
fight|打架, 争吵, 斗志;v. 对抗, 打架
military|军队;a. 军事的, 军人的, 适于战争的
hit|打击, 打, 冲撞, 讽刺;vt. 打, 打击, 碰撞, 打中, 袭击, 偶然碰上;vi. 打, 打中, 打击, 碰撞, 偶然碰上; 击中; 找到; 瞬时打扰
sign|符号, 招牌, 征兆, 正负号, 手势;vt. 签名, 打手势表达;vi. 签名; 正负号; 符号; 符号字符
campaign|战役, 运动, 竞选运动;vi. 参加运动, 作战
direct|直接的, 坦白的;vt. 指示, 指挥, 命令, 导演;vi. 指导, 指挥;adv. 直接地
press|压, 揿, 按, 人群, 印刷机, 压力, 出版社, 记者, 报刊, 新闻舆论, 紧迫;vt. 压, 压榨, 紧抱, 逼迫, 推进, 强迫征募, 催逼;vi. 压, 重压, 催促, 拥挤, 奋力前进, 受压
drug|药, 麻药, 麻醉药;vi. 吸毒;vt. 使服麻醉药, 使麻木
operate|操作, 运转, 动手术, 活动
green|绿色, 绿色颜料;a. 绿色的, 未成熟的, 新鲜的, 青春的, 无经验的, 脸色发青的
complete|完全的, 十足的, 完成的;vt. 完成, 完工, 使圆满
star|星, 恒星, 星形物, 运气, 明星;vt. 以星状物装饰, 用星号标, 使成为明星;vi. 变成明星
independent|独立自主者, 无党派者;a. 独立的, 有主见的, 不须依赖的, 不受约束的
laugh|笑, 笑声;vi. 笑, 大笑;vt. 以笑表示
sister|姐妹, 姐, 妹, 护士, 修女;vt. 姐妹般对待
fear|恐怖, 害怕, 担心;v. 害怕, 恐惧, 为...担心, 敬畏
stock|树干, 祖先, 血统, 原料, 备料, 库存, 牲畜, 股票, 股份, 保留剧目;a. 存货的, 常备的, 平凡的, 普通的, 股票的, 保留剧目的, 繁殖用的;vt. 装把手于, 进货, 备有, 放牧;vi. 出新芽,…
blue|蓝色;a. 蓝色的, 下流的, 忧郁的;vt. 染成蓝色;vi. 变蓝
radio|无线电, 收音机, 无线电报, 无线电广播, 无线电台;v. 用无线电发送
aid|帮助, 外援, 助手;vt. 援助, 帮助, 有助于;vi. 帮助; 自动内部诊断
match|比赛, 火柴, 对手;vt. 使相配, 使比赛, 与...竞争;vi. 结婚, 相配; 比较
fly|苍蝇, 两翼昆虫, 飞行;vi. 飞, 飞翔, 飘扬, 逃走;vt. 飞, 飞越, 使飘扬, 逃出;a. 敏捷的
race|种族, 人种, 赛跑, 比赛, 急流, 人类, 同道, 姜根;vi. 赛跑, 竞赛, 疾走;vt. 与...赛跑, 使疾走, 使猛转; 竞争; 追赶; 欧州高级通信研究开发计划
past|过去, 昔时, 往事, 早年经历, 过去时;a. 过去的, 结束的, 卸任的, 过去时的;prep. 越过, 晚于, 超越, 超出...的可能性(能力、范围等);pass的过去分词
peace|和平, 和约, 治安, 和睦, 安宁, 静寂;vi. 安静下来, 不作声
sale|出售, 卖, 拍卖, 销售额, 廉价出售; 卖, 出售; 销售(货)
nation|国家, 民族; 民族, 国家
front|前面, 开头, 前线, 阵线, 态度;vt. 面对, 朝向, 对抗;vi. 朝向
official|官员, 公务员, 职员;a. 公务的, 官方的, 正式的
beat|心跳(声), 打, 敲打声, 拍子;v. 打, 拍打, 打败;a. 疲乏的, 颓废的;beat的过去式; 拍; 节拍
vote|投票, 选举, 选票, 表决, 选举权, 得票数;vi. 投票, 选举;vt. 投票选举, 投票决定, 公认, 使投票
release|释放, 发泄, 豁免, 发行, 释放证书;vt. 释放, 解除, 放松, 豁免, 免除, 发布, 放弃, 让与;n. 发布; 版本, 发布
chief|领袖, 酋长, 长官, 主要部分;a. 主要的, 首位的
middle|中央, 中间, 腰部;a. 中央的, 中庸的, 中间的
quick|快的, 迅速的, 敏捷的, 灵敏的, 急速的;adv. 快;n. 新长出的肉, 要害, 核心, 感觉敏锐部位
twice|两次, 两倍
working|工作, 运转, 劳动;a. 工作的, 劳动的, 经营的, 抽搐的, 运转的
surprise|惊奇, 奇袭, 诧异;vt. 使惊奇, 撞见, 奇袭
grey|灰色;a. 灰色的, 阴沉的;v. (使)成灰色
least|最少, 最小, 最小限度;a. 最少的, 最小的;adv. 最小, 最少
brown|褐色;a. 褐色的;v. (使)变褐色
dollar|美元, 元(加、澳等国货币单位); 纯经济的, 美元, 元
host|主人, 旅馆老板, 节目主持人;vt. 当主人招待, 作...节目主持人; 主机, 宿主机
bite|咬, 一口;v. 咬, 刺痛, 穿透
...
of course|当然
will|意志, 决心, 意愿, 意向, 干劲, 遗嘱;vt. 用意志的力量驱使, 决意, 愿意, 立遗嘱;vi. 下决心, 愿意;aux. 将, 愿意, 必须
may|五月;aux. 愿能, 可以, 愿意
use|使用, 习惯, 使用价值, 用法, 使用权;vt. 使用, 利用, 运用, 耗费;vi. 惯常
hand|手, 爪, 指针, 掌握, 协助, 人手, 手艺, 手迹, 支配, 插手;vt. 交给, 支持, 搀扶
while|一会儿, (一段)时间;conj. 当...的时候, 虽然;vt. 消磨
hold|把握, 把持力, 柄, 控制, 掌握, 监禁;vt. 保存, 握住, 拿住, 占据, 持有, 拥有;vi. 支持, 持续, 有效;n. 保留; 保留
require|需要, 命令, 要求; 需要, 要求, 命令
period|时期, 节段, 节, 句点, 学时, 周期;a. 当时特有的, 过去某段时期的;interj. 就是这话, 就是这么回事
city|城市, 市; 都市, 城市, 市
type|类型, 样式, 典型, 榜样, 标志, 符号, 型, 式;vi. 打字;vt. 作为代表, 测定类型, 用打字机打; 类型; 键入; DOS内部命令:在屏幕上显示指定文件的内容
subject|科目, 主题, 臣民, 主语, 题目, (事物的)经受者, 学科, 受治疗者, 原因, 理由;a. 服从的, 易患...的, 隶属的, 受支配的;adv. 在...条件下;vt. 使隶属, 使受到; 主题, 主体
order|次序, 规则, 命令;vi. 命令, 定货;vt. 整理, 命令, 定购;n. 顺序, 阶数; 顺序, 阶数
patient|病人, 承受者;a. 忍耐的, 容忍的, 有耐性的, 坚忍的
church|教堂, 礼拜, 教会;vt. 使人接受宗教仪式;a. 教堂的
upon|在...之上, 迫近, 紧接着
therefore|因此, 所以
section|区段, 部分, 区域, 节, 截面, 处, 科, 区, 扇区;vt. 把...分段, 把...切片;vi. 被切成片; 扇区
table|桌子, 餐桌, 工作台, 铭文, 表格, 表, 高原, 平地层;vt. 搁置, 嵌合, 制表, 把...列入议事日程; 表格, 模拟运算表
activity|活动, 行动, 活跃, 活力; 活动
death|死亡; 死亡
involve|包括, 使陷于, 潜心于, 包围; 累及, 牵涉, 包含
particular|一项(或条、点), 个别项目, 详细说明;a. 特别的, 独有的, 挑剔的, 详尽的
language|语言, 文字, 措辞; 语言
particularly|特别, 格外, 尤其, 详细地, 细致地
management|经营, 支配, 管理; 管理处
practice|实践, 练习, 实行, 惯例, 习惯, 开业;v. 实践, 实行, 练习, 实习, 业务
evidence|根据, 证据, 迹象; 证据, 凭证
shall|将
sometimes|有时, 时常, 往往
thus|如此, 因此, 到如此程度; 乳香
range|排, 行, 山脉, 范围, 行列, 射程;vt. 排列, 归类于, 使并列, 放牧;vi. 平行, 延伸, 漫游; 量程; 范围; 域; 距离
voice|声音, 嗓音, 嗓子, 愿望, 发言权, 表达, 喉舌, 语态;vt. 表达, 吐露, 调音
God|上帝, 神像, 偶像;vt. 使神化
field|领域, 田地, 场地, 战场, 场, 域;vt. 使...晒在场上, 使上场;a. 田间的, 野生的, 野外的, 田赛的; 域, 字段
material|材料, 物资, 素材, 布料, 资料;a. 物质的, 肉体的, 重要的
manager|经理, 管理员, 管理器; 管理器
project|计划, 设计, 事业;vt. 计划, 设计, 投掷, 发射, 使凸出, 放映;vi. 凸出
window|窗户, 窗子, 窗口;vt. 给...开窗; 窗口
explain|解释, 说明
apply|涂, 应用;vi. 申请, 适用
usually|通常, 大抵
difference|不同, 差异; 差分
relationship|关系, 关联; 关系
indeed|的确, 实在, 真正地, 甚至
quality|品质, 特性, 才能, 质量;a. 优质的; 品质
certainly|确定地
similar|相似的, 类似的;n. 相似的东西
true|真实的, 正确的, 忠诚的, 可靠的, 纯粹的, 正式的;n. 真实, 准确;adv. 真实地, 准确地
model|模型, 模范, 模特儿;a. 模范的, 作模型用的;vi. 做模型, 做模特儿;vt. 使模仿, 塑造; 模型
data|资料, 数据; 数据; DOS内部命令:用于显示或设定系统的日期
nature|自然, 大自然, 本性, 性格, 性质; 自然, 大自然; 本性, 性能
necessary|必要的;必然的;必需的
structure|结构, 构造, 建筑物;vt. 构成, 组织
contain|包含, 容纳, 控制;vi. 自制
unit|单位, 分队, 部队, 单元, 部件, 装置;a. 单位的, 单元的; 单元常数; 部件
method|方法, 办法, 条理, 秩序;;法
bed|床, 睡眠处, 河床, 底座, 路基, 一层;vt. 提供宿处, 栽种, 安装;vi. 睡, 形成坚实的一层
movement|运动, 动作, 运转, 移动, 倾向, 变化, 活动, 乐章; 运动
detail|细节, 详情;vt. 详述, 选派;vi. 画详图; 详细数据
reduce|减少, 分解, 降低, 使衰退, 把...分解, 把...归纳;vi. 减少, 减肥, 缩小; 缩小
simply|简单地, 只是, 简直, 简朴地, 坦白地
especially|尤其, 特别, 格外
date|日期, 约会, 枣椰树;vt. 约会, 定日期;vi. 注明日期, 过时
personal|私人的, 涉及隐私的, 有人性的, 人称的, 亲自的, 身体的; 人的; 个人的, 自身的
establish|建立, 确立, 制定;vi. 移植生长
computer|电脑, 电子计算机; 计算机
private|私人的, 秘密的, 私立的, 隐蔽的;n. 士兵, 隐士, 阴部; 私人的
approach|接近, 入门;vt. 接近, 近似, 找...商量;vi. 靠近
amount|总数, 总额;vi. 总计, 等同
wish|希望, 愿望, 祝愿, 命令, 请求;vt. 愿, 想要, 希望, 祝愿;vi. 希望
scheme|方案, 计划, 组合, 系统, 图解, 诡计, 阴谋;v. 计划, 设计, 图谋, 策划
award|奖品, 裁定, 判决;vt. 授予, 给予
achieve|完成, 达到;vi. 如愿以偿
chapter|章, 篇, 重要章节; 章; 段
choose|选择, 宁愿, 欲;vi. 作出选择, 愿意; 选取
theory|理论, 学说, 原理, 意见, 推测; 理论
property|财产, 所有权, 性质, 属性; 属性
poor|贫穷的, 贫乏的, 不幸的, 可怜的, 拙劣的, 卑鄙的; 低劣的, 不良的
south|南方, 南;a. 南的, 向南的;adv. 在南方;vi. 转向南方
production|制造, 生产, 产物; 产生, 生成
board|木板, 甲板, 膳食, 会议桌;vt. 乘船, 供膳食, 用板覆盖;vi. 搭伙; 板
king|国王, 君主;vt. 使...成为君主;vi. 君临, 统治
opportunity|机会, 时机
lord|统治者, 阁下, 上帝;vi. 称王, 作威作福;vt. 使成贵族
agreement|同意, 合约, 协议; 契约, 协议, 协定
simple|简单的, 普通的, 朴素的, 单纯的, 绝对的, 初级的, 原始的, 迟钝的;n. 出身低微者, 傻子
serve|可作...用, 服务, 经历, 招待, 供应, 送交, 对待;vi. 服务, 服役, 侍应, 适合, 有用, 开球;n. 发球, 轮到发球
picture|图画, 照片, 景色, 美丽如画的人(或物), 化身, 生动的描述, 想像, 形象思维;vt. 画, 拍摄, 用图说明, 描写, 想像; 图象; 形象; 字形
contract|合约, 婚约, 契约;vt. 使皱缩, 使缩短, 感染, 订约, 缔结;vi. 皱缩, 订约, 收缩
source|来源, 水源, 根源, 原始资料, 源; 来源, 源程序
occur|发生, 被想到, 存在
various|不同的, 各种的, 多方面的, 许多的, 个别的, 杂色的; 不同的, 种种的, 各式各样的
represent|表现, 表示, 描绘, 讲述, 代表, 象征, 回忆, 再赠送, 再上演;vi. 提出异议
site|位置, 场所, 地点;vt. 给...择址
shop|商店, 工厂, 车间;vi. 购物, 到处寻找;vt. 选购
loss|损失, 遗失, 失败, 输, 错过, 伤亡; 损失; 损耗
evening|傍晚, 晚间, 末期
animal|动物; 动物
standard|标准, 规格, 旗, 军旗, 本位;a. 标准的, 合规格的; 标准
heart|心, 心脏, 中心, 内心, 感情, 精神, 心情, 宝贝儿;vt. 鼓励
purpose|目的, 意向, 决心, 用途, 效果, 论题;vt. 意欲, 企图, 计划
benefit|利益;vt. 有益于;vi. 受益
discuss|讨论, 论述; 讨论, 辩论
anyone|任何人
doctor|医生, 博士;vt. 授以博士学位, 诊断, 修改;vi. 行医
factor|因素, 因数, 系数, 基因, 代理人; 因式
hair|头发, 毛发, 些微; 毛, 发
prove|证明, 查验, 检验, 勘探, 显示;vi. 证明是
wrong|错误的, 不正当的, 失常的;adv. 错误地
wear|穿着, 戴, 使用, 耗损, 服装, 耐久性;vt. 穿着, 戴, 留(须、发等), 呈现, 磨损, 磨成, 耗损, 使疲乏, 消磨;vi. 磨损, 变旧, 耐久, 渐变, 渐渐消失
argue|提出理由, 争论, 辩论;vt. 主张, 辩论, 证明, 说服
pattern|模范, 典型, 式样, 样品, 图案, 格调, 模式;vt. 模仿, 仿造, 以图案装饰;vi. 形成图案; 模式, 图案
piece|块, 片, 篇, 碎片, 部分, 部件, 标准量;vt. 修补, 修理, 拼合, 接线头;vi. 吃零食
tree|树, 木料, 树状物;vt. 把...赶上树; 树; DOS外部命令:显示指定磁盘驱动器的目录结构
catch|捕捉, 陷阱, 捕捉之物, 抓, 拉手;vt. 捕捉, 赶上, 感染, 听清楚;vi. 抓住, 燃着
royal|王室, 皇族;a. 王室的, 皇家的, 盛大的, 庄严的
population|人口, 人口数; 群体; 总体
April|四月
enjoy|享受, 喜欢, 欣赏; 享受, 享有, 获得某种利益
despite|轻视, 憎恨;prep. 虽然, 尽管
performance|施行, 工作情况, 成绩, 行为, 表现, 演出; 绩效, 性能
knowledge|知识, 学问, 认识, 知道
June|六月
basis|基础, 主要成分; 基底
size|大小, 尺寸, 规模, 尺码, 能力, 浆料;vt. 上浆, 依大小排列;vi. 可比拟;a. 一定大小的, 一定尺寸的
introduce|介绍, 引入, 采用, 输入; 引进, 输入, 介绍
series|串联, 序列, 连续, 系列, 丛书, 套, 级数, 组; 系列
garden|花园, 果园, 菜园;vi. 栽培花木;vt. 造园;a. 花园的, 普通的
eat|吃, 腐蚀
environment|环境, 外界, 围绕; 环境
rest|休息, 睡眠, 安息, 稍息, 静止, 支架, 休息处, 其余者, 剩余部分;vi. 休息, 睡, 长眠, 安心, 静止, 停止, 安置, 依赖;vt. 使休息, 使支撑, 把...寄托于
success|成功, 成就, 胜利
enter|进入, 参加, 开始, 输入, 回车;vi. 进去, 参加; 输入, 回车
arrive|到达, 抵达
natural|白痴;a. 自然的, 自然界的, 本能的, 天然的, 物质的, 正常的, 原始的, 自然数的
ensure|确定, 保证, 担保, 保护; 确保, 确定
region|区域, 地带, 地区, 领域, 范围, 区; 区, 区域
attention|注意, 注意力; 引起注意信号
space|位置, 空间, 距离, 太空, 空白, 间隔, (期刊等的)篇幅;vt. 隔开, 分隔;vi. 留间隔; 空白, 空格校验
statement|陈述, 指令, 声明; 程序语句; 语句
pull|拉, 拖, 拔, 牵, 撕开, 吸引;vi. 拉, 拖, 拔, 有吸引力;n. 拉, 拖, 拔, 拉力, 牵引力, 划船, 吸引
relation|关系, 联系, 叙述, 故事, 家属, 亲戚; 关系
sea|海, 海洋, 海浪, 大量; 海, 海洋
principle|原则, 原理, 主义; 原理
choice|选择, 精选品, 选择权;a. 精选的, 挑三拣四的, 上等的; DOS内部命令:在批处理文件中;该命令用于提示用户作出选择, 决定批处理文件的流程
couple|对, 夫妇, 数个;vt. 使成双, 连接, 使成婚, 把...联系起来;vi. 结合, 成婚
hotel|旅馆, 客栈
above|在上方, 超出;adv. 在上面;a. 上述的, 上面的
forward|向前的, 早的, 迅速的, 在前的, 进步的;vt. 促进...的生长, 转寄, 运送;adv. 向前地; 前推, 转信
village|村庄;a. 乡村的, 村庄的
station|车站, 站, 局, 驻地, 位置, 身分, 地位;vt. 安置, 配置, 驻扎; 站
individual|人, 个人, 个体;a. 个别的, 个人的, 独特的
feature|面孔的一部分(如眼、口等), 特征, 容貌, 特色, 特写;vt. 是...的特色, 特写, 放映;vi. 起重要作用; 特性
association|协会; 关联
income|收入, 收益, 流入; 收益
following|下列各项, 部下, 追随者;a. 下列的, 其次的
nice|美好的, 和蔼的, 正派的, 做得好的, 精密的, 细微的, 挑剔的, 谨慎的
manage|处理;vt. 管理, 控制, 维持, 达成, 经营, 运用
everyone|每个人, 人人; 系统中的一个组名
affect|影响, 感动, 假装, 模仿, 爱好, 倾向于;n. 自觉感情
technology|技术, 工业技术, 术语; 技术学, 工艺学
identify|识别, 认为...等同于, 确定, 使参与;vi. 一致, 认同
please|请;vt. 使高兴, 合...的心意, 取悦;vi. 使人满意, 讨好, 愿意, 敬请
whatever|无论什么
difficulty|困难, 难点
machine|机器, 机械装置, 机构, 自动售货机, 机械般工作的人;vt. 以机器制造
modern|现代人, 有思想的人;a. 现代的, 时髦的
degree|程度, 度数, 学位, 度; 度, 程度
legal|法律的, 法定的, 合法的; 法定权利; 法律(上)的, 合法的
energy|精力, 精神, 活力, 能量; 能; 能量
treatment|治疗, 待遇, 处理; 疗法, 治疗; 处理
cell|单元, 细胞, 电池; 单元
growth|生长, 栽培, 增长; 等比级数
finally|最后, 终于
mile|英里, 很大距离; 英里, 哩
lady|淑女, 夫人, 女士, 贵妇
whom|谁
happy|快乐的, 幸福的, 愉快的, 恰当的
task|工作, 任务, 作业, 困难的工作;vt. 派给...工作, 使辛劳; 任务
risk|冒险, 危险, 保险额;vt. 冒...的危险, 冒险干
function|官能, 职务, 功能, 函数;vi. 活动, 运行, 行使职责; 功能, 函数
county|县, 郡
resource|资源, 财力, 办法, 策略, 急智, 消遣; 资源
behaviour|行为, 举止; 特性, 性能, 特点, 行为, 动作, 状态
defence|防卫, 防卫设备; (诉讼程序中的)辩护
style|风格, 时尚, 文体, 风度, 字体, 类型;vt. 称呼, (根据新款式)设计, 使合潮流;n. 风格, 样式; 风格, 样式
floor|地板, 楼层, 底部, 底价;vt. 铺地板, 打倒;n. 地面, 地板, 基底; 基底
science|科学, 学科, 学问, 自然科学; 科学
feeling|摸, 触觉, 知觉, 感觉, 情绪, 同情;a. 有同情心的, 有感觉的, 仁慈的, 动人的
response|反应, 回答, 响应; 应答
note|笔记, 记录, 注解, 票据, 符号, 显要, 注重, 便笺, 照会;vt. 记录, 注解, 注意
skill|技术, 技巧, 技能, 熟练, 熟练工人; 技能
college|学院, 大学, 学会
horse|马, 骑兵, 脚架;vi. 骑马, 取笑;vt. 使骑马, 系马于
myself|我自己, 我亲自, 我独自
character|个性, 字符, 人物, 性质, 品格, 资格; 字符
nor|也不, 也没有; 或非
normal|常态, 标准, 正常, 普通;a. 正常的, 正规的, 标准的, 师范的, 正态的; 标准, 普通
indicate|显示, 象征, 指示, 指出; 指示
forget|忘记, 忽略, 忘;vi. 忘记
wonder|奇迹, 惊奇, 惊愕;vt. 惊奇, 想知道;vi. 惊讶, 怀疑
investment|投资; 包埋料, 围模料, 包埋法, 围模法
dog|狗, 坏蛋;vt. 跟踪, 尾随
suffer|遭受, 经历, 忍受;vi. 受痛苦, 受损害
recently|最近
previous|早先的, 前面的, 过急的; 以前的, 生前的, 前述的
maintain|维持, 维修, 保持, 坚持, 供养, 主张; 维修
husband|丈夫, 管理人, 节俭的人;vt. 节俭, 使成丈夫, 持有
publish|出版, 发行, 公开, 发表, 宣传, 公布;vi. 出版, 发行
responsibility|责任, 职责, 负担, 可靠性; 职责
argument|争论, 论证, 论据, 自变量; 参数
anyway|无论如何, 至少
avoid|避免, 防止, 撤消; 避免, 回避, 躲开
bill|帐单, 清单, 钞票, 鸟嘴, 广告, 法案, 票据;vt. 开帐单, (用招贴)宣布
express|快车, 快递, 专使;a. 明确的, 丝毫不差的, 专门的, 快的;vt. 表达, 表示, 表露
suppose|推想, 假设, 以为, 想像, 假定;vi. 料想
significant|重要的, 有效的, 有含义的, 暗示的, 值得注意的
finish|完成, 结束, 末道漆, 磨光, 完美;vt. 完成, 结束, 用完, 毁掉;vi. 结束; 完成
element|元件, 元素, 要素; 部分; 成分; 单元; 码元; 元件; 元素; 单元
glass|玻璃, 玻璃杯, 透镜;vt. 装玻璃于, 反射, 反映;vi. 成玻璃状
determine|决定, 决心
duty|责任, 关税, 职务, 尊敬; 职责
July|七月
tend|走向, 有某种的倾向, 易于, 照顾, 注意;vt. 照料, 护理
listen|听, 倾听, 听从;n. 听, 倾听
leg|腿, 假腿, 路程;vi. 走, 跑
park|公园, 停车处;vt. 停车, 置于;vi. 停车
suddenly|突然, 意外, 忽然, 迅速, 即席作成, 即刻, 急速
title|头衔, 名称, 标题, 书名, 扉页, 权利, 资格, 冠军, 字幕;vt. 授予头衔, 加标题于; 标题
treat|宴请, 款待;vt. 视为, 对待, 论述, 治疗, 款待;vi. 讨论, 谈判, 作东
summer|夏季, 全盛时期;vi. 避暑, 过夏天; 加法器
throughout|到处, 贯穿全部地, 自始至终;prep. 遍及, 在各处; 吞吐量
discussion|讨论
generally|通常, 逐渐地, 普遍地
aspect|外观, 方面, 面貌, 方向; 方面, 局面; 外观
industrial|工业的, 供工业用的, 工业高度发展的, 产业的;n. 工业工人, 工业股票
chairman|主席, 会长; 主席
nearly|几乎, 密切地
remove|移动, 调动, 除去, 迁移, 开除, 移交;vi. 迁移, 移动, 搬家;n. 班级, 升级, 移动, 搬家, 间距; 删除
throw|投, 掷, 抛, 发射, 摔下, 匆匆穿上(或脱下), 抛弃, 摆脱;vi. 丢, 掷, 抛;n. 投掷, 掷骰子, 冒险
baby|婴孩; 婴儿
sorry|难过的, 悲哀的, 遗憾的
box|盒子, 箱, 方框, 一巴掌;vt. 装...入盒中, 装箱, 打耳光;vi. 拳击; 方框
exist|存在, 生存, 发生
river|河, 江; 河流, 江河, 内河
dead|死的, 不活泼的, 麻木的, 熄灭的;n. 死者;adv. 完全地, 直接地
customer|消费者; 顾客
institution|机构, 惯例, 制度; 机关, 机构, 设施
encourage|鼓励, 支持, 激励; 怂恿, 煽动, 助长
specific|特效药, 特性;a. 特殊的, 明确的, 具有特效的, 特定地, 具体地
profit|利润, 赢利, 利益;vi. 有益, 获利, 赚钱;vt. 有益于
reflect|反射, 反映, 招致, 深思;vi. 被反射, 映出, 深思, 考虑, 指责
assume|假定, 承担, 呈现;vi. 装腔作势, 僭越
admit|承认, 接受, 允许进入, 容许;vi. 开向, 容许, 承认
stone|石头, 宝石, 果核, 纪念碑, 结石;vt. 投扔石子, 铺石头;a. 石的, 石制的, 完全的
measure|尺寸, 量度器, 量度标准, 测量, 量具, 程度, 范围, 限度, 分寸, 措施, 方法;vt. 测量, 测度, 估量, 权衡, 调节, 拿(自己或自己的力量等)作较量;vi. 度量
division|分, 分开, 除法, 部门(如部、处、系等), 师; 部分
smile|微笑, 喜色, 笑容;vi. 微笑, 觉得好笑;vt. 微笑着表示
prepare|准备, 筹备, 使在思想上有准备, 制造, 调制;vi. 预备
replace|代替, 替换, 放回, 归还; 替换; DOS外部命令:取代或更新文件
commission|委任状, 任官令, 所委职责, 佣金, 犯, 委托, 所托之事;vt. 委任, 委托制作, 使服役
proposal|提议, 计划, 求婚; 提案, 申请, 投标
fill|装满, 填充, 弥漫, 供给, 满足, 供应;vi. 充满, 变得沉重;n. 满足, 装满, 充分, 填方;vt. 填充;vi. 填充; 填充
unless|除非;prep. 除...之外
mention|提到, 言及, 陈述;vt. 提到, 提及
improve|改良, 提高...的价值, 改善, 利用;vi. 变得更好, 增加
image|影像, 肖像, 想象, 图像, 形象, 翻版;vt. 作...的像, 反映, 想象, 象征;n. 图像; 图象
obviously|显而易见地, 明显地
sector|扇形, 部门, 部分, 函数尺, 象限仪, 段, 区段;vt. 把...分成扇形; 扇面; 扇区; 段; 区段
direction|方向, 指导, 趋势; 方向; 流向
basic|基本原理, 要素, 基本规律;a. 基本的, 碱性的;(计算机)BASIC语言
seat|座, 座位, 位子, 席位, 所在地;vt. 使坐下, 使就座, 为...设座于, 使就职;vi. 安装在底座上
successful|成功的, 一帆风顺的, 顺利的; 成功的
intend|计划, 打算, 意思是; 想要, 打算, 意旨
original|最初的, 原始的, 有创意的;n. 原物, 原作
miss|失误, 避免, 失败, 小姐;vt. 未得到, 未达到, 未听到, 未觉察, 逃脱, 遗漏, 错过, 思念;vi. 失败, 击不中
attitude|态度, 看法, 姿势; 体态, 姿势, 态度
aware|知道的, 有觉悟的
discover|发现, 找到, 暴露;vi. 发现
drop|滴, 微量, 落下, 空投;vi. 放下, 掉下, 下降;vt. 使滴下, 放下, 丢失, 遗漏; 投入, 投入点, 接入点, 分接点
push|推, 推动, 奋斗, 攻击, 进取心;vt. 推, 推动, 使伸出, 推行, 逼迫, 增加;vi. 推, 推进, 增加, 努力争取
goal|目标, 终点, 得分, 球门, 守门员;vi. 攻门, 射门得分
disease|疾病, 弊病;;病
yourself|你自己
refuse|拒绝, 谢绝;vi. 拒绝;n. 废物;a. 扔掉的, 无用的
prevent|预防, 防止, 阻止, 妨碍
popular|通俗的, 流行的, 受欢迎的, 大众的, 人民的, 普及的; 大众的, 通俗的, 普及的
October|十月
affair|事件, 事务, 恋爱事件
appeal|恳求, 诉请, 上诉, 吸引力;vi. 呼吁, 诉请, 要求, 上诉, 有吸引力;vt. 将...上诉
heavy|重的, 巨大的, 沉重的, 笨重的, 过度的;adv. 沉重地;n. 重物, 严肃角色
beyond|超过, 在那一边, 迟于;adv. 在远处;n. 更远处
regard|关心, 注意, 尊敬, 关系, 问候;vt. 视为, 注意, 考虑, 和...有关, 看待;vi. 注视, 注意
ability|能力, 才干; 能力, 才能
professional|专业人才;a. 专业的, 职业的
holiday|假日, 假期, 节日;vi. 度假
technique|技巧, 技术, 方法; 工艺方法; 技巧
item|项目, 条款, 一则, 项; 项
version|一种描述, 版本, 译文; 版本
fish|鱼, 鱼肉, 鱼类, 接合板;vt. 钓, 钓鱼, 查出, 用接合板连接;vi. 捕鱼, 钓鱼, 用钩捞取, 摸索寻找
maybe|也许, 大概;n. 可能性
lay|放置, 产, 铺设, 布置, 提出, 平息;vi. 下蛋, 打赌;n. 位置, 层, 隐藏处;a. 世俗的, 外行的;lie的过去式
teach|教, 讲授, 教导, 教育;vi. 教书, 教学, 可以教
advice|忠告, 劝告, 意见, 报道, 通知; 通知书, 通知, 建议
September|九月
dark|黑暗, 夜, 黄昏, 模糊;a. 黑暗的, 暗的, 深色的, 隐密的, 模糊的, 无知的
reveal|露出, 显示, 透露, 揭露, 泄露, (神)启示;n. 窗侧, 门侧
advantage|优点, 便利, 好处, 优势;vt. 有助于
surface|面, 表面, 水面, 外表, 平面;a. 表面的, 外观的, 肤浅的, 水面上的;vt. 使成平面, 使浮出水面;vi. 浮出水面, 呈现, 在地面上工作
cold|感冒, 寒冷;a. 寒冷的, 冷淡的, 冷静的;adv. 完全地
immediately|直接地, 立刻, 立即
worth|价值, 财产;a. 值...的, 值得的
ready|预备好的状态, 现款;a. 准备好的, 备用的, 可以使用的;adv. 预先, 迅速;vt. 使准备好
variety|多样, 种类, 变种, 杂耍; 变种
television|电视; 电视
memory|记忆, 记忆力, 回忆, 纪念, 存储;n. 内存; 存储器, 内存, 查看内存实用程序
blood|血, 血统, 流血, 气质, 生命;vt. 使出血, 用血涂
island|岛, 岛屿, 孤立地区, 安全岛;vt. 使成岛状, 孤立
culture|文化, 修养, 耕种;vt. 耕种, 培养
January|一月
useful|有用的, 有益的; 有用的, 有效的
depend|靠, 视...而定, 信赖
Sunday|星期日;a. 星期日的, 业余的;vi. 度星期日
majority|多数, 大半; 多数逻辑
competition|竞争, 竞赛; 竞争, 竞销, 比赛
bar|条, 棒, 酒吧, 栅, 障碍物;vt. 禁止, 阻挡, 妨碍; 棒形图
parliament|国会, 议会; 会议, 国会, 议院
goods|货物; 货物, 商品, 动产
check|检查, 支票, 阻止物, 寄物牌, 象棋中将军;vt. 检查, 阻止, 核对, 寄存, 托运;vi. 逐项相符, 开支票; 复选
trouble|烦恼, 麻烦, 困难, 动乱, 故障;vt. 困扰, 麻烦, 使烦恼, 折磨;vi. 烦恼, 费心
traditional|传统的, 惯例的; 传统的, 惯例的
effective|有效的, 有力的, 实际的;n. 有生力量
payment|付款, 支付的款项(或实物), 偿还, 报应, 惩罚; 支付, 缴纳, 支付款额
mouth|嘴, 口, 口腔, 口状物;vi. 装腔作势说话, 做鬼脸;vt. 说出, 做作地说
facility|容易, 灵巧, 设备; 设施; 设备; 装备
survey|纵览, 视察, 测量, 俯瞰, 调查;vt. 审视, 视察, 俯瞰, 通盘考虑;vi. 测量土地
extend|扩充, 延伸, 伸展, 扩大; 扩展
deep|深的;adv. 深入地;n. 深渊, 深处
earth|地球, 泥土, 世界, 尘世;vt. 埋入土中, 赶入洞内;vi. 躲入洞内
article|文章, 冠词, 物品, 物件, 条款, 契约; 信件
object|物体, 目标, 目的, 对象, 宾语, 客体;vi. 反对, 抱反感;vt. 提出...来反对; 对象
chair|椅子, 显要的席位, 主席;vt. 使入座, 使就任要职
possibility|可能性, 可能的事; 可能性, 可能发生的事, 不确定权
means|方法, 手段, 工具, 财产, 收入; 方法, 手段, 工具; 意谓
notice|注意, 布告, 通知, 预告, 短评;vt. 注意, 通知, 评论, 提及, 关注;vi. 注意
card|卡片, 纸牌, 节目单, 明信片, 梳棉机;vt. 备置卡片, 记于卡片上, 梳理; 卡片, 卡
agency|代理机构, 经销商, 中介; 办事处
collection|收集, 采集, (一批)收藏品, 募捐; 收集; 收集品, 标本
considerable|相当的, 可观的, 重要的
physical|身体的, 物质的, 自然的, 物理学的, 好色的;n. 体格检查
supply|补给, 供给, 供应品;vt. 补给, 供给, 提供, 补充;vi. 替代
examine|检查, 调查, 考试
document|文件, 公文, 文档;vt. 证明, 为...引证; 文档
responsible|有责任的, 负责的, 责任重大的; 应负责任的, 有责任的, 能履行责任的
hot|热的, 热心的, 辣的, 热情的, 激动的, 猛烈的, 紧迫的;adv. 热, 紧迫地
weight|重, 重量, 体重, 砝码, 重大, 影响, 力量;vt. 加重量于, 压迫, 使加权, 称重量; 粗细
career|事业, 生涯, 成功; 职业, 专业, 履历
solution|解决, 解答, 溶液; 溶液
November|十一月
December|十二月
influence|影响力, 权力, 势力;vt. 影响, 改变
budget|预算;vi. 编预算;vt. 编入预算, 安排;a. 廉价的
opinion|意见, 评价, 主张; 意见
medical|医生, 体格检查;a. 医学的, 内科的, 药的
hang|悬挂, 诀窍, 意义;vt. 悬挂, 附着, 装饰, 垂下, 踌躇, 绞死, 使悬而未决;vi. 悬着, 垂下, 被绞死, 悬而不决
rock|岩石, 岩礁, 石头, 基石, 暗礁, 摇动, 摇滚乐;vt. 摇摆, 摇动, 使摇晃, 使动摇;vi. 摇, 摇动
district|区域, 地方; 地区, 地段
bird|鸟, 羽毛球;vi. 打鸟
damage|损害, 伤害;v. 损害
tomorrow|明天, 未来;adv. 明天, 未来地
shake|摇动, 震动;vt. 摇动, 动摇, 使震动, 挥舞;vi. 震动, 发抖, 动摇
organization|组织, 结构, 团体, 体制; 组织, 机构, 机化(血栓或坏死组织)
extra|额外的事物, 另外的收费;a. 额外的, 特别的;adv. 额外地, 特别地, 非常地
edge|边缘, 尖锐, 刀刃, 优势;vt. 使锐利, 挤进, 镶边;vi. 缓缓移动
exchange|交换, (电话)交换局, 交换机, 汇兑, 交易所;v. 交换, 交易, 兑换; 交换; 电话局
quarter|四分之一, 一刻钟, 季度, 地区;vt. 四等分, 肢解;vi. 驻扎, 住宿
option|选择权, 挑选, 选项; 选项
opposition|反对, 敌对, 相反, 在野党; 对生, 对向, 反抗, 反对症
eventually|最后, 终于
occasion|场合, 时机, 机会, 诱因, 理由;vt. 惹起, 引起
highly|非常, 非常赞许地; 大大地
executive|执行部门, 执行委员会, 执行者, 经理主管人员;a. 执行的, 善于执行的, 善于经营的; 执行程序
target|目标, 靶子, 指标;vt. 对准, 订指标
attend|参加, 照料, 伴随;vi. 专心于, 照顾, 服侍, 出席
network|网络, 广播网, 网状物; 网络
lack|缺乏, 无, 不足;vt. 缺乏, 短少, 不足, 需要;vi. 缺乏
corner|角落, 转角, 窘境;vt. 迫至一隅, 垄断, 使陷入绝境;vi. 相交成角, 垄断; 边角
sex|性别, 性欲;vt. 区别...的性别, 引起...的性欲
finger|手指, 指状物, (手套的)手指部分, 指针;v. 用手指拨弄, 伸出; 网络命令
slightly|些微地, 苗条地
scene|场, 情景, 镜头, 发生地点, 道具, 布景, 景色; 现场
gain|增益, 获得, 利润, 收获, 增加;vt. 得到, 增进, 赚到;vi. 获利, 增加; 增益
fully|十分地, 完全地, 充分地
scale|刻度, 衡量, 比例, 比例尺, 数值范围, 等级, 规模, 天平, 秤, 鳞, 积垢;vt. 依比例决定, 攀登, 测量, 绘制, 刮鳞, 使生垢, 过秤;vi. 剥落, 生水垢, 重量为, 攀登, 衡量; 刻度
equipment|装备, 设备, 才能; 设备; 装备; 装置
afternoon|午后, 下午
speech|演讲, 说话, 谈话, 言语, 引语, 民族语言; 言语, 语言
message|消息, 通讯, 讯息, 教训, 预言, 广告词;vt. 通知;vi. 通报, 报告, 报信; 报文; 消息; 信息
ball|球, 舞会, 球状物;v. 捏成球形
sport|运动, 游戏, 娱乐, 消遣, 玩笑;a. 运动的, 户外穿戴的;vi. 游戏, 参加体育运动, 戏弄, 产生变种;vt. 炫耀, 使产生变种
kitchen|厨房, 全套炊具; 厨房
crime|犯罪, 罪行, 罪恶; 犯罪, 罪, 罪恶
male|男人, 雄性动物;a. 男性的, 雄性的, 有力的
strategy|战略, 策略; 战略, 策略
review|检讨, 复习, 回顾, 检阅, 评论;vt. 温习, 检讨, 评论, 再检察, 复审;vi. 复习功课, 写评论
employee|职员, 员工, 受雇人员; 职工; 雇员
interested|感兴趣的; 有利害关系的, 有股份的, 偏私的
travel|旅行, 游历, 行进;vi. 旅行, 行进, 移动, 被传播;vt. 旅行, 通过, 使移动
otherwise|否则, 不同地, 别的方式
hardly|刚刚, 几乎不, 勉强是
below|在下面;adv. 在下面
status|状态, 情形, 地位, 要人身份; 状态
perform|进行, 履行, 完成, 执行, 表演;vi. 行动, 工作, 执行, 演出
tea|茶, 茶叶; 茶, 茶剂, 浸剂
partner|合伙人, 股东, 伙伴, 伴侣;vt. 与...合伙, 组成一对;vi. 做伙伴, 当助手
band|带子, 队, 乐队;v. 联合, 结合; 频带; 波段; 区
failure|失败, 失败者, 不足, 缺乏, 破产; 故障; 失效
reader|读者, 读物, 文选, 校对人, 讲师; 阅读程序; 阅读器
shoulder|肩, 肩膀, 衣肩;vt. 肩负, 负担, 担任;vi. 用肩推挤
fair|展览会, 市集, 美好的事物;a. 公平的, 按规则进行的, 不好不坏的, 晴朗的, 美丽的;adv. 公平地, 正面地, 有教养地, 清楚地;vi. 转晴
protect|防卫, 保护, 警戒; 庇护, 保护, 警戒
truth|事实, 实情; 真实, 真相, 事实
owner|拥有者, 物主, 所有人; 所有者, 物主, 业主
marriage|婚姻, 结婚, 婚礼, 合并; 婚姻, 结婚
essential|要素, 要点, 本质;a. 必要的, 重要的, 本质的; 本质冒险
confirm|证实, 确定, 批准, 使巩固; 确认
adopt|采用, 正式通过, 收养, 接受; 采取
civil|市民的, 公民的, 有礼貌的; 公民的, 国民的, 民用的
Saturday|星期六
trust|信任, 信赖, 相信, 受托, 职责, 信心, 托拉斯;a. 信托的, 托拉斯的;vt. 信赖, 信任, 相信, 盼望, 赊卖给;vi. 相信, 信赖, 依靠; 委托, 信任
beautiful|美丽的
newspaper|报纸
safety|安全, 保险, 平安, 保安设备;vt. 保护, 防护
trial|审判, 试验, 艰苦, 麻烦事, 考验;a. 审讯的, 试验性的
farm|农场, 农田;vt. 耕种;vi. 种田
sentence|句子, 命题, 宣判;vt. 宣判, 判决; 句子
file|档案, 公文箱, 文件夹, 文件, 卷宗, 锉刀;vi. 列队行进, 用锉刀做;vt. 归档, 申请, 锉, 琢磨; 文件
obvious|明显的, 明白的, 显然的, 平淡无奇的
length|长度, 长, 期间, 一段; 记录长度; 块长; 字长
copy|副本, 摹仿, 一册;v. 复印, 抄袭, 复制; 副本; 复制; DOS内部命令:复制文件;将几个文件合并成一个文件, 以及将文件传至外设或在设备之间传送
balance|平衡, 差额;vi. 平衡, 相等;vt. 称, 权衡, 比较, 使平衡, 结算, 抵消
wind|风, 气息, 气味, 呼吸, 风声, 趋势, 空谈, 卷绕, 弯曲;vt. 使通风, 嗅出, 使喘气, 吹号角, 上发条, 缠绕, 包, 绞起, 吊起, 使弯曲, 使迂回;vi. 嗅出猎物, 吹响号角, 卷曲, 蜿蜒, …
league|同盟, 联盟, 盟约;v. 组联盟, (使)加盟
none|一点也不, 毫不;pron. 没有人, 无一物, 并无一个;a. 没有的
doubt|怀疑, 疑惑;v. 怀疑, 不信
pain|痛苦, 疼痛, 辛苦;vt. 使痛苦, 痛苦;vi. 作痛, 疼
train|火车, 列车, 行列, 长队, 一连串的后果, 顺序;vt. 训练, 教育, 对准;vi. 受训练, 锻炼
February|二月
spirit|精神, 心灵, 灵魂, 态度, 志气, 人格, 情绪, 心情, 烈酒;vt. 诱拐, 鼓励, 鼓舞
studio|工作室, 画室, 演播室, 电影制片厂
environmental|周围的, 环境的; 环境的, 环保的
strength|力量, 实力, 强度, 浓度, 人数, 抵抗力; 强度
contact|联系, 交际, 熟人, 接触;vi. 接触, 联系;vt. 使接触
imagine|想像, 设想, 猜测;vi. 想像起来
positive|肯定的, 积极的, 有把握的; 正的, 阳性的
shape|形状, 形态, 外形, 形式, 身材;vt. 定形, 使成形, 塑造, 计划, 使符合;vi. 成形, 形成, 成长; 形状
transport|运输, 运输工具, 激动, 狂喜, 流放犯;vt. 传送, 运输, 流放; 传送
cash|现金;vt. 兑现
gas|气体, 汽油, 瓦斯; 气体; 煤气; 瓦斯; 毒气
museum|博物馆
debate|辩论, 讨论;v. 争论, 辩论
reform|改革, 改正, 改造;vt. 改革, 改过, 革新, 重整;vi. 革新, 改过
pair|一双, 一对, 一副;v. (使)成对
agent|代理商, 政府代表, 动原, 媒介; 代理程序
annual|年刊, 年报;a. 每年的, 一年一次的, 全年的, 一年生的
marry|与...结婚, 娶, 嫁;vi. 结婚
artist|艺术家, 画家
presence|出席, 面前, 存在, 仪态, 风度; 出现
protection|保护, 防卫, 贸易保护制度; 保护
nuclear|核子的, 原子能的, 核的, 中心的; 核的
collect|收集, 聚集, 集中, 搜集;a. 由收到者付款的;adv. 由收到者付款地
queen|王后, 女王;vt. 立为女王;vi. 做女王
master|主人, 硕士, 大师, 母机;a. 主人的, 主要的;vt. 征服, 控制, 精通
candidate|候选人, 投考者; 候选, 候补者
rich|富裕的, 富饶的, 浓厚的, 贵重的
huge|极大的, 巨大的, 无限的
exercise|行使, 执行, 运动, 练习, 作业;vt. 运用, 练习, 运动;vi. 练习, 锻炼
commercial|商业的, 商用的, 商品化的;n. 商业广告节目
adult|成人, 成虫;a. 成年的, 成熟的
august|八月;a. 威严的, 令人敬畏的
apparently|表面上, 清楚地, 显然地
safe|保险箱, 冷藏室;a. 安全的, 可靠的, 平安的, 稳健的, 有把握的
speed|速率, 速度, 迅速;vi. 加速, 超速, 快进;vt. 快速传送, 促进, 使加速; 中央处理机速度设置程序
route|路径, 途径, 路线;vt. 确定路线, 按规定路线发送; 传递, 路由设定程序
emerge|浮现, 形成, 出现, (事实)显露
regional|地方的, 地域性的; 区的, 部位的
mark|标志, 分数, 马克, 痕迹, 斑点, 靶子, 刻度, 记号, 符号, 戳记, 标准, 起跑线;vt. 做标记于, 留意, 打分数, 表明, 标志, 记录;vi. 作记号, 记得分; 标志; 标记; 传号
separate|独立件, 抽印本;a. 分开的, 各别的, 单独的, 分隔的;vi. 分开, 隔开, 分居;vt. 使分离, 使分开, 区分, 使分居
shoot|射击, 狩猎, 芽, 射伤, 发射, 发芽, 急流, 推力, 摄影, 急送, 滑运道, 浪费;vt. 射击, 射中, 损毁, 拍摄, 喷出, 投射, 挥出, 飞速行进, 挥霍, 给...注射;vi. 射出, 射击, 发出…
deny|否认, 拒绝
aim|目标, 瞄准, 击中目标的能力;vi. 对准目标, 致力, 打算;vt. 瞄准; 医学文摘索引, 存取隔离机构, 高级信息管理程序, 先进接口模块;应用接口模块, 医学人工智能, 相联索引法, 异步接口模块;自动化信息管…
credit|信用, 信任, 荣誉, 贷款, 学分;vt. 归功于, 赞颂, 信任, 相信; 信用量
impact|冲击, 冲突, 影响, 效果;vt. 挤入, 撞击, 压紧, 对...发生影响
danger|危险, 威胁; 危险, 危险物, 危机
progress|进步, 发展, 前进;vi. 进步, 进行
key|钥匙, 键, 解答, 关键, 要害, 基调, 线索, 答案, 暗礁;vt. 调音, 锁上, 提供线索;vi. 使用钥匙; 键, 密钥
track|轨迹, 足迹, 径迹, 小道, 轨道, 磁轨, 途径;vt. 循路而行, 追踪, 通过, 用纤拉;vi. 追踪, 留下足迹, 沿轨道运行; 跟踪
reaction|反应, 反作用, 反动; 反应
flower|花, 开花植物, 精华, 盛时;vi. 开花, 发育, 旺盛, 成熟;vt. 用花装饰, 使开花
video|影像, 电视;a. 图像的, 电视的
instead|作为替代, 反而
distance|距离, 远方, 遥远; 位距
regular|规则的, 常例的, 有秩序的, 整齐的, 等边的, 定期的, 经常的, 合格的, 常备军的;n. 正规军, 正式队员;adv. 经常地;n. 正常体; 正常体
link|环, 连结物, 链接, 火把;vt. 连结, 联合, 挽住;vi. 连接起来; 连接, 链路
gold|黄金, 钱财, 金块, 金色, 宝贵;a. 金的, 似金的, 金色的, 金制的
comment|注解, 批评, 评论, 备注;vi. 评论, 注解; 备注
due|应得的东西, 应付款;a. 到期的, 应得的, 应付的, 约定的
drink|饮料, 酒;v. 喝, 喝酒
politics|政治, 政治学, 政见, 政治活动; 政治, 政治学, 政纲
reply|答复, 回答, 答辩;vi. 答复, 回答, 回击, 反响, 答辩;vt. 回答; 答复
justice|正义, 公平, 公正, 正确, 司法, 审判
skin|皮肤, 皮;vt. 剥皮, 在...植皮;vi. 长皮, 愈合, 蜕皮
bag|袋子, 袋状物;vt. 使膨大, 装袋, 猎获
strike|罢工, 打击, 殴打;vt. 打, 撞击, 冲击, 侵袭, 取消, 结算, 打掉, 罢工, 刺透, 使生根, 遇见;vi. 打, 打击, 抓, 罢工, 搏动, 触礁, 敲, 响, 穿透, 打动
settle|有背长椅;vt. 决定, 整理, 安放, 使定居, 使平静, 支付, 安排, 解决, 结算;vi. 停留, 下陷, 沉淀, 澄清, 安下心来, 结清, 定居, 安家
ignore|不理睬, 忽视, 驳回, 忽略; 忽略
alone|孤独的, 单独的, 独自的;adv. 独自地
sight|景观, 视力, 眼界, 阅读, 见解, 意见;vt. 看见, 瞄准;vi. 瞄准, 观看;a. 即席的, 见票即付的
reality|实在, 事实, 实体, 逼真; 现实, 实在存在的事物, 实在性
inside|内部, 内脏, 内幕;a. 内部的, 秘密的, 户内的;adv. 在里面;prep. 在...之内
boat|船;vi. 乘船;vt. 以船运
wine|葡萄酒, 果酒, 暗红色;v. (请)喝酒
prison|监狱, 监禁, 拘留所;vt. 监禁
propose|计划, 打算, 建议, 提议, 求(婚);vi. 打算, 求婚
possibly|可能, 也许
respond|以...回答;vi. 回答, 响应, 回报, 有反应, 承担责任
clothes|衣服
active|活跃的, 起作用的, 积极的, 有效的, 主动的, 活性的, 现行的, 现役的;n. 主动语态, 积极分子
weekend|周末, 周末休假
vehicle|交通工具, 车辆, 传播媒介; 载体; 运载体; 漆料
debt|债务, 罪过; 借款, 欠款, 债务
somebody|了不起的人, 大人物;pron. 有人, 某人
largely|大量地, 很多地, 大半地
arrange|安排, 排列, 达成协议; 重排
survive|比...活得长, 生存, 生还, 幸免于;vi. 活下来, 幸存
powerful|有力的, 有权力的, 强大的; 强力的
telephone|电话, 电话机;v. 打电话
hole|孔, 洞, 穴, 漏洞;vt. 挖洞, 掘坑;vi. 进洞, 凿洞
battle|战役;v. 战斗
farmer|农夫, 农场主; 农民, 农场主, 承包者
injury|伤害, 侮辱; 伤, 损伤
expert|专家, 行家;a. 老练的, 内行的, 专门的; 高级
package|包裹, 套装软件, 包, 包装用物, 程序包;vt. 包装, 打包;a. 一揽子的; 包, 软件包, 包装
colleague|同事, 同僚
complex|综合体, 情结, 络合物;a. 复杂的, 组合的
impossible|不可能的, 难以置信的, 令人无法忍受的
confidence|信心; 可靠
mainly|主要地, 大抵
generation|一代, 一世, 产生; 生殖, 世代
lift|举起, 帮助, 昂扬, 电梯;vt. 升高, 提高, 鼓舞, 清偿, 空运, 举起, 剽窃;vi. 升起, 消散, 耸立
phone|电话, 受话器, 耳机;vt. 打电话给;vi. 打电话
insurance|保险, 保险业, 保险费; 保险
painting|画, 绘画, 油漆; 涂漆
warm|暖和的, 暖的, 温暖的, 热烈的, 兴奋的, 激烈的, 多情的, 色情的;vt. 使温暖, 弄热, 使兴奋, 使充满仇恨;vi. 变暖和, 变温暖, 取暖, 激动, 同情, 爱好;n. 暖, 保暖物
ship|船, 舰;vt. 以船运送, 装船, 运送;vi. 上船, 乘船
plus|加上, 加, 外加;a. 正的, 附加的;n. 正号, 加号, 附加额, 正数, 增益; 正差
volume|册, 卷, 体积, 容量, 大量, 许多, 份量, 音量;vi. 成团卷起;vt. 把...收集成卷;a. 大量的; 卷
judge|法官, 裁判员, 审判官, 鉴定人;vt. 审理, 鉴定, 判断, 判决, 裁定;vi. 下判断, 作评价
threat|恐吓, 恶兆, 威胁; 威胁
conflict|战斗, 冲突, 矛盾, 争执;vi. 争执, 战斗, 冲突, 抵触; 冲突
fresh|新鲜的, 新奇的, 另外的, 淡的, 精神饱满的, 冒失的;adv. 最新地, 刚刚;n. 开始, 泛滥
yard|码, 庭院, 工场; 堆置场
victim|受害人, 牺牲者, 牺牲品; 受害人, 被害人, 遭难者
touch|触觉, 碰, 触, 机灵, 轻触, 格调, 少许, 缺点, 弹力;vt. 接触, 触摸, 触及, 使接触, 达到, 涉及, 影响到, 使轻度受害, 感动;vi. 触摸, 接近, 涉及, 提到
entry|登录, 条目, 进入, 入口, 报关; 登录项, 输入项, 条目
engine|引擎, 发动机, 机车;vt. 安装发动机于
stuff|原料, 要素, 东西, 材料, 素质, 织品, 废物, 废话;vt. 装填;vi. 狼吞虎咽
cabinet|橱柜, 内阁;a. 内阁的, 细木工做的; 机柜
domestic|家庭的, 国内的, 驯养的; 家庭的, 家用的
author|作家, 作家的著作, 创始人; 作者, 著作人, 本人
sexual|性的, 性别的; 性的; 性欲的
tonight|今晚, 今夜;adv. 今晚, 今夜
prefer|宁可, 较喜欢, 提出; 给予优先权, 优先偿还, 提出
extremely|极端地, 非常地
cheap|便宜的, 不值钱的, 可鄙的;adv. 便宜地
threaten|恐吓, 威胁, 预示...的凶兆;vi. 威胁, 恫吓, 可能来临
relief|减轻, 解除, 救济, 安慰, 调剂, 浮雕, 换班, (地势的)起伏; 缓减, 减轻, 浮雕(绘画中)
commit|委托(托付), 犯罪, 指派...作战, 使承担义务; 犯, 做, 把...交托给
grant|授予, 授予物, 允许;vt. 允许, 承认, 授与; 授权命令
strange|奇怪的, 陌生的, 生疏的, 不熟悉的, 不可思议的, 外行的, 外地的, 异乡的
repeat|重复, 反复;vt. 重做, 重复, 复述, 使再现, 复制;vi. 重复; 重复
mountain|山, 山脉, 大堆
song|歌, 曲, 鸣声, 歌唱, 歌曲, 诗歌
sleep|睡眠, 静止, 昏迷, 麻木, 长眠, 冬眠;vi. 睡觉, 睡眠, 静止;vt. 睡
insist|坚持, 坚决主张, 强调
feed|饲料, 一餐, 饲养;vt. 喂, 饲养, 放牧, 靠...为生;vi. 吃东西, 用餐, 流入; 送纸
wood|木材, 木制品;vt. 植林于, 给...添加木柴;vi. 收集木材
excellent|优良的, 杰出的, 出色的
tour|旅游, 观光旅行, 任期;vi. 旅行, 周游, 巡回;vt. 周游, 观光, 游历, 使巡回演出
interview|面谈, 访问, 接见, 面试;vt. 接见, 对...进行面谈(试)
dinner|晚餐, 正餐, 宴会
football|足球, 橄榄球
launch|下水, 汽艇, 发射;vt. 使下水, 发射, 发动;vi. 起飞, 下水, 投入, 开始
consumer|消费者; 消费者, 用户
promote|促进, 晋升, 创办, 推销; 促进, 推广, 推销
bridge|桥, 舰桥, 桥梁, 桥牌;vt. 架桥于, 跨越; 桥, 网桥, 桥接器
appearance|出现, 露面, 外观, 外表, 出版; 外观, 版面
soft|软的, 温和的, 柔和的, 柔滑的, 温柔的, 软弱的, 坡度小的, 笨的, 纸币的;n. 柔软的东西, 笨人, 纸币;adv. 柔软地, 温和地
quiet|安静, 闲适, 平静;a. 安静的, 静止的, 寂静的, 朴素的, 从容的, 暗中的;vi. 平静下来;vt. 使平静, 使平息, 使安心, 安慰
potential|潜在性, 可能性, 潜力, 潜能, 势, 位;a. 有潜力的, 可能的, 潜在的
limit|界限, 边界, 限度, 极限, 限制;vt. 限制, 限定
session|期间, 开庭期, 会议, 学期; 会话, 对话, 会晤, 通用任务程序
religious|宗教性的, 虔诚的, 宗教上的, 严谨的;n. 修道士, 出家人
housing|遮盖, 住房供给, 居留(处), 房屋, 装饰; 外壳
flat|平坦的, 单调的, 无力的, 浅的, 萧条的, 干脆的, 无聊的;adv. 平直地, 断然地;n. 扁平物, 平面, 平地, 平原, 平板车;v. (使)变平
increasingly|逐渐地, 渐增地
TV|电视; 电视, 转移向量
proper|适当的, 固有的, 高尚的, 专属的;adv. 完全地, 彻底地
deliver|递送, 陈述, 释放, 发表, 引渡, 投递, 交付; 交运
famous|出名的, 极好的
broad|宽广的, 辽阔的, 广大的, 显著的;adv. 宽阔地;n. 宽阔部分
audience|听众, 观众, 读者; 听讼, 观众, 听众
theatre|戏院, 电影院, 剧场, 全体观众, 戏剧, 戏剧效果, 阶梯式讲堂, 场所
prince|王子, 亲王, 国君, 贵族, 诸侯, 有权势的大人物
crisis|危机, 危险期, 紧要关头; 危象; 骤退, 临界, 极期
loan|贷款, 借出;v. 借, 供应货款, 借给
representative|代表, 众议员, 典型;a. 描写的, 表现的, 代理的, 代表的, 代议制的, 典型的
usual|平常的, 通常的
respect|尊敬, 尊重, 问候;vt. 尊敬, 注意, 遵守
attract|吸引, 诱惑;vi. 有吸引力
promise|诺言, 约定的事情, 有指望;vt. 允诺, 约定, 预示;vi. 允诺, 有前途, 有指望
magazine|杂志, 仓库, 弹盒, 胶卷盒; 卡片箱, 介质装卸程序
freedom|自由, 坦率, 特权; 自由, 自主, 免除
formal|正式的, 形式的, 礼仪的, 拘于礼节的, 拘谨的;n. 正式的社交活动
writing|书写, 著作, 笔迹, 作品; 书写
reject|被拒之人, 被弃之物, 不合格品, 次品;vt. 拒绝, 抵制, 否决, 驳回, 丢弃, 呕出
flight|飞行, 射程, 逃走, 飞跃, 飞机航程, 班机, 迁徙, 飞逝;vi. 迁徙;vt. 射击(飞禽), 为(箭)装上羽毛, 使惊飞
joint|连接处, 接合, 关节;a. 共同的, 联合的, 连接的, 合办的;vt. 连接, 接合, 使有接头;vi. 贴合, 长节
rain|雨, 下雨, 雨天;vi. 下雨;vt. 使大量落下
Conservative|保守的, 守旧的, 有保存力的; 防腐剂; 保存剂
invite|邀请, 请求, 引起, 招致;n. 邀请
spring|春天, 弹簧, 跳跃, 弹性, 活力, 泉, 源泉;a. 春天的;vi. 跳, 弹跳, 涌出, 生长, 裂开, 高耸;vt. 使跳起, 使爆炸, 突然提出
ahead|领先的, 预先的, 向前的;adv. 领先, 预先, 向前, 胜于, 在前面, 在将来
factory|工厂, 产生地, 代理店; 工厂, 代理店, 商行在国外的代理处
challenge|挑战, 盘问;vt. 向...挑战, 要求, 怀疑;vi. 挑战, 对(证据等)表示异议
youth|年轻, 青年时代, 青年们, 青春; 青年, 青年时期, 青春时期
sing|唱, 唱歌, 演唱, 鸣, 啼;vt. 唱, 歌颂;n. 嗖嗖声
warn|警告, 提醒, 通知;vi. 发出警告
dream|梦, 空想, 愿望;v. 做梦, 想象, 梦想
victory|胜利, 战胜, 克服
finance|财政, 财务;vt. 供给...经费, 负担经费;vi. 筹措资金
impose|征(税), 把...强加于, 以...欺骗;vi. 利用, 欺骗, 施加影响
cry|叫声, 哭声, 大叫;vi. 哭, 叫, 喊;vt. 叫喊, 大声说, 哭出
destroy|破坏, 毁坏, 消灭
address|住址, 演说, 举止, 灵巧, 求爱;vt. 发表(演说或讲话), 对付, 写地址; 地址, 寻址
bright|明亮的, 聪明的, 鲜明的, 欢快的;adv. 明亮地, 欢快地
average|平均, 平均数, 一般水平, 海损;a. 平均的, 中等的, 平常的;vt. 算出...平均数, 平均做, 均分, 使平衡;vi. 平均为, 呈中间色
nobody|小人物, 无名小卒;pron. 无人, 没有人
egg|蛋, 卵;vt. 挑唆, 煽动, 调蛋黄
declare|宣布, 声明, 申报, 断言
worry|担心, 烦恼, 忧虑, 苦恼, 撕咬;vt. 使烦恼, 使焦虑, 使苦恼, 困扰, 折磨, 撕咬;vi. 烦恼, 担心, 撕咬
aircraft|航空器, 飞机; 航空器
decade|十年, 十
immediate|立即的, 直接的, 接近的; 直接的, 立即的
divide|分开, 分配, 分裂;vt. 分, 分开, 分裂, 除;n. 分配, 分水岭; 除
equal|对手, 匹敌, 同辈;a. 相等的, 平等的, 胜任的, 合适的, 平静的, 不相上下的;vt. 等于, 比得上; 等长度编码
leading|领导, 指挥, 神示, 铅板;a. 领导的, 主要的, 在前的
bottom|底部;a. 底部的;vt. 给...装底, 查明真相;vi. 到达底部, 建立基础
weapon|武器, 兵器;vt. 武装
murder|谋杀;vt. 谋杀, 损毁, 破坏;vi. 犯杀人罪
tape|带子, 录音带, 磁带, 窄带, 卷尺;vt. 以带子绑起, 测量, 录音; 带
female|女性, 女人, 雌性动物;a. 女性的, 女子的
overall|全部的, 全体的, 从头至尾的, 一切在内的;adv. 从头到尾, 总的说来;n. 罩衫, 工作服
recognize|认出, 认可, 承认, 公认, 识别, 赏识;vi. 承认, 具结
kid|小山羊, 小山羊肉, 小孩, 欺骗;a. 小山羊皮制的;v. 哄骗, 嘲弄
spread|传播, 散布, 伸展;a. 双唇展开的, 伸展的;vt. 展开, 铺开, 传播, 推广, 伸出, 涂, 敷, 延伸;vi. 展开, 扩大, 传开, 延伸; 展开
handle|柄, 把手, 把柄, 柄状物, 手感;vt. 触摸, 运用, 买卖, 处理, 操作;vi. 搬运, 易于操纵;n. 句柄; 句柄
expensive|贵的, 奢华的, 费用浩大的, 乱化钱的; 高价的, 昂贵的, 浪费的
recommend|推荐, 介绍, 劝告, 使受欢迎, 托付; 建议, 推荐
correct|正确的, 合适的;vt. 改正, 订正
store|商店, 贮藏, 仓库, 备用品, 存储器;vt. 储存, 贮藏, 供给;vi. 贮藏;a. 贮藏的, 现成的; 存储器操作; 存储
bottle|瓶子, 酒瓶;vt. 装瓶, 抑制, 围困
wave|波, 波浪, 波动, 起伏, 高潮, 潮涌, 挥手致意, (气压)突变;vi. 波动, 飘动, 挥手示意, 起伏;vt. 使波动, 使飘扬, 挥舞, 使成波浪形
criticism|批评, 评论, 非难; 批判, 批评, 评论
eastern|东方人, 东正教徒;a. 东方的, 向东的, 自东的
transfer|迁移, 移动, 传递, 转让, 转移, 过户, 汇兑, 换车;vt. 使转移, 调转, 调任, 改变, 传递, 转让;vi. 转移, 转学, 转职, 换车; 传送
straight|直线, 直;a. 直的, 笔直的, 正直的, 直接的, 连续的, 整齐的;adv. 直接地, 立即, 不断地
realize|了解, 实现, 使显得逼真, 变卖;vi. 变卖
dangerous|危险的; 危险的, 危害的
weather|天气, 气象, 处境;a. 迎风的;vt. 使受风吹雨打, 侵蚀, 使风化, 经受住;vi. 风化, 受侵蚀, 经受风雨
photograph|相片, 照片, 逼真的描绘;v. 照相, 摄影
lunch|午餐
critical|批评的, 决定性的, 危险的, 临界的; 危象的; 临界的, 极期的
channel|海峡, 航道, 频道;vt. 引导, 在...上挖沟, 形成河道; 信道, 通道
fee|费用, 小费, 封地, 所有权;vt. 付费给
absolutely|完全地, 绝对地, 确确实实地
Friday|星期五
waste|浪费, 废物, 损耗, 消耗, 荒地, 垃圾, 地面风化物;a. 废弃的, 荒芜的, 多余的;vt. 浪费, 消耗, 使荒芜;vi. 浪费, 消耗, 变消瘦
desire|欲望, 要求;vt. 想要, 请求;vi. 渴望
institute|学会, 学院, 协会;vt. 创立, 开始, 制定, 任命
unlikely|不太可能的
recall|回忆, 召回, 撤消;vt. 回想, 回忆, 召回, 撤消, 使恢复; 检索
double|两倍;a. 两倍的, 双重的;vt. 使加倍;vi. 加倍, 代替, 快步走; 双精度型
block|街区, 木块, 石块, 块;vt. 阻塞, 封锁, 使成块状; 块, 数据块
brain|脑;vt. 打碎脑部
guide|引导者, 导游, 指南, 路标;vt. 指导, 支配, 管理, 带领, 操纵;vi. 任向导; 辅助线
welcome|欢迎, 欢迎词;a. 受欢迎的, 可随意的, 可喜的;vt. 欢迎, 接待;interj. 欢迎
screen|幕, 银幕, 屏风, 掩蔽物, 屏蔽, 筛子;vt. 掩蔽, 放映, 拍摄, 掩护, 筛, 甄别;vi. 拍电影; 筛选; 屏幕
guest|客人, 来宾, 旅客; 客体
secure|无虑的, 安心的, 安全的, 可靠的, 保险的;vt. 固定, 获得, 保证, 使安全, 掩护, 招致;vi. 停止操作, 船抛锚
program|节目, 节目单, 程序, 纲要, 大纲, 计划;vt. 规划, 拟...计划;vi. 安排节目, 编程序; 程序
slow|慢的, 缓慢的, 迟缓的, 迟钝的, 冷漠的, 落后的;adv. 慢地, 迟缓地;v. (使)慢下来
trip|旅行, 绊倒, 摔倒, 失足, 差错, 旅程;vt. 使跌倒, 使犯错, 使失败;vi. 轻快地走, 绊倒, 失误, 犯错, 结巴, 旅行, 远足
dry|干的, 无酒的, 枯燥无味的, 干燥的;vt. 把...弄干;vi. 变干;n. 干, 干涸
dress|服装, 覆盖物;vi. 穿着;vt. 给...穿衣, 整理
violence|猛烈, 暴力, 暴虐, 暴行; 暴行, 暴力, 暴乱
Monday|星期一
captain|船长, 指挥官, 海军上校, 首领;vt. 率领, 指挥
display|显示, 陈列, 炫耀, 显示器;vt. 陈列, 显示, 表现, 夸示; 显示器; 显示
scientist|科学家; 科学家
perfect|完成时;a. 完美的, 完好的, 理想的, 熟练的, 精确的, 完成式的;vt. 使完美, 修改, 使精通, 改善, 使熟练
crowd|群众, 一伙人;vt. 拥挤, 挤满, 挤进
search|搜寻, 查究;v. 搜寻, 搜查, 探求, 调查, 搜索; 搜索, 路径检索程序
escape|逃亡, 避难设备, 逃跑;vi. 逃脱, 避开, 溜走;vt. 逃避, 避免, 被...忘掉
wild|荒野, 荒地;a. 野性的, 野蛮的, 野生的, 失控的, 任性的, 杂乱的, 轻率的, 狂热的, 疯狂的;adv. 狂暴地, 失控地
heat|热, 热度, 体温, 高潮;vi. 加热, 激昂, 加剧;vt. 把...加热, 使激动
daily|每日的, 日常的;adv. 每日地, 日常地;n. 日报
southern|南方人, 男风;a. 向南方的, 来自南方的
gun|枪; 枪
investigate|调查, 审查
professor|教授
ministry|部, 内阁, 服务; 部
neither|皆不, 两个都不;a. (两者)都不的;pron. 两者都不;conj. 既非, 既不
spot|污点, 地点, 斑点, 点, 娱乐场所, 处境, 少量;a. 当场的, 现场的, 现货买卖的, 现金交易的, 抽样的;vt. 点缀, 玷污, 认出, 准确定...的位, 用灯光照射;vi. 玷污, (从空中)侦察敌方目标
prospect|景色, 展望;vt. 勘探, 勘察;vi. 勘探, 有前途
narrow|狭窄部分, 隘路;a. 狭窄的, 仔细的, 有限的, 勉强的, 狭隘的, 手紧的;vi. 变窄;vt. 使变狭窄
earn|赚得, 获得, 博得; 欧州科学研究网
soldier|军人, 士兵, 兵蚁;vi. 从军, 尽职, 偷懒, 磨洋工
succeed|成功, 继承, 继续;vt. 继承, 接替
North|北方, 北;a. 北的, 北方的;adv. 向北方, 在北方
prepared|准备好的, 特制的
mistake|错误, 误会;vi. 犯错, 误认;vt. 误解, 弄错; 错误
alternative|两者择一, 供替代的选择;a. 两者择一的, 供选择的; 选择对象
burn|烧, 烧毁, 烧伤;vi. 燃烧, 发热, 烧毁;n. 烧伤, 烙印
wing|翅膀, 翼, 机翼, 派别;vt. 给...装上翼, 飞过, 使飞, 空运, 增加...速度;vi. 飞行
flow|流程, 流动, 流量, 洋溢, 泛滥, 涨潮;vi. 流动, 流泄, 畅流, 川流不息, 飘扬, 涌出;vt. 使流动, 淹没, 流出
approve|赞同, 核准, 为...提供证据;vi. 赞许
careful|小心的, 谨慎的
gather|集合, 聚集;vi. 聚集, 集合, 渐增;vt. 使聚集, 搜集, 积聚
clean|干净的, 清白的, 简洁的;adv. 清洁地, 完全地;vt. 清理, 使干净, 出空;vi. 被搞干净;n. 打扫
pretty|漂亮的, 优美的, 机灵的, 狡猾的, 恰当的;adv. 相当, 颇
jump|跳跃, 跳动, 暴涨, 惊跳;vt. 跳跃, 跃过, 突升, 使跳跃;vi. 跳跃, 跳, 跳动, 暴涨; 转移, 跳转
incident|事件, 事变, 小事;a. 附带的, 易于发生的, 外来的, 入射的
border|边缘, 边境, 边界, 花坛;vt. 在...上镶边, 接近;vi. 接界, 近似; 边框
winner|胜利者, 优胜者; 取胜者
conduct|行为, 举动, 指导;vt. 为人, 指挥, 管理, 实施;vi. 领导, 传导, 指挥
elect|当选人, 被选的人;a. 被选的, 选出的;vt. 选举, 选择;vi. 作选择
ride|骑马, 乘坐, 乘车, 搭便车;vt. 骑, 乘坐, 压迫, 控制;vi. 骑马, 乘车, 漂游
square|正方形, 街区, 广场, 平方, 直角尺;a. 正方形的, 正直的, 公正的, 平方的, 方正的, 结清的;adv. 成直角地, 对准地;vi. 一致, 符合, 结清;vt. 使成方形, 使平方自乘, 调正, 结清, 使…
fruit|水果, 果类, 结果; 果实, 种实
slip|滑, 滑行, 事故, 溜, 差错, 滑台, 下降, 插条, 后裔, 板条, 瘦长的年轻人;vi. 滑动, 滑倒, 失足, 溜走, 滑落, 犯错, 变坏;vt. 使滑动, 滑过, 摆脱, 闪开, 塞入, 从...取接枝;a…
restaurant|餐馆, 饭店
score|得分, 抓痕, 二十个, 刻痕, 帐目, 乐谱, 起跑线, 终点线, 大量;vt. 刻划, 划线, 获得, 评价, 把...记下;vi. 刻痕, 记分, 得分; 得分
request|请求, 需要, 申请书;vt. 请求, 要求, 邀请; 请求
estimate|估计, 判断;vt. 估计, 评价, 判断;vi. 估计
circle|圆周, 社交圈, 循环, 范围;vt. 围着, 环绕;vi. 盘旋, 循环
fast|快速的, 紧的;adv. 很快地, 紧紧地, 彻底地;n. 绝食, 斋戒;vi. 绝食, 斋戒
shot|发射, 炮弹, 射击, 射手, 投篮, 射门, 子弹, 射程, 拍摄, 注射;vt. 装弹, 使成颗粒状;a. 杂色的, 交织着的, 渗透的, 点焊的, 破旧的;shoot的过去式和过去分词
grand|庄重的, 壮观的, 显赫的, 重大的, 最高的, 雄伟的, 宏大的, 豪华的, 傲慢的; 重大的, 主要的, 伟大的
fashion|流行, 风尚, 时样;vt. 形成, 造, 作
coast|海岸, 滑坡;v. 沿海岸而行
roll|卷, 滚动, 名单, 案卷, 压路机;vi. 滚, 滚动, 飘流, 起伏, 卷, 绕;vt. 使滚动, 卷, 绕
mass|块, 大多数, 质量, 大量, 群众, 弥撒;a. 群众的, 大规模的, 整个的;vt. 使集合, 集中;vi. 聚集
desk|书桌, 办公桌, 工作台
brief|摘要, 简报;a. 简短的, 短暂的;vt. 对...作简报, 摘要, 节录
wonderful|令人惊奇的, 奇妙的, 极好的
entire|整个, 全部;a. 全体的, 完全的, 全部的
advance|前进, 进展, 行过的路程;vi. 前进, 进展, 提高, 上涨;vt. 使前进, 促进, 提出, 提高, 使提前, 预付;a. 前面的, 预先的
ticket|票, 券, 车票, 标签, 入场券, 证明书;vt. 加标签于, 为...购票
meanwhile|其时, 其间;adv. 同时, 于此时
accuse|指责, 控告, 归咎于;vi. 指责, 控告
motor|马达, 发动机, 原动力, 汽车;a. 马达的, 发动机的, 汽车的, 发动的;vt. 推动, 以汽车载运;vi. 乘汽车, 驾车
fan|风扇, 迷, 狂热者, 爱好者;vt. 煽动, 刺激, 吹拂;vi. 飘动, 成扇形散开
constant|常数, 恒量;a. 不变的, 一定的, 时常的; 常量; 常数; 恒值
ideal|理想, 典范, 观念, 思想, 最后目标;a. 理想的, 完美的, 空想的, 观念的, 唯心论的
focus|焦点, 焦距;vi. 聚焦, 注视;vt. 使聚焦, 调焦, 集中; 焦点
withdraw|撤回, 取回, 撤消, 使撤退, 拉开, 移开;vi. 撤退, 离开
severe|严格的, 尖锐的, 严肃的, 严重的, 严厉的, 朴素的; 严厉的, 苛刻的, 严重的
citizen|市民, 公民; 公民, 国民, 市民
terrible|可怕的, 令人恐惧的, 极坏的
hurt|伤害, 创伤, 损害;v. 伤害, (使)伤心, 危害, 刺痛
prisoner|囚犯, 犯人, 战俘; 犯人, 囚犯, 扣押犯
fuel|燃料, 木炭;vt. 加燃料, 供燃料;vi. 得到燃料
cancer|癌, 恶性肿瘤; 癌
editor|编者, 编辑, 主笔, 编辑器, 编辑装置; 编辑器
ill|疾病, 坏事, 罪恶, 灾难;a. 生病的, 邪恶的, 不吉利的, 敌意的, 不良的, 不顺利的;adv. 有害地, 不幸地, 几乎不
lawyer|律师; 律师
diet|日常饮食, 议会;vt. 照规定饮食;vi. 忌食
Wednesday|星期三
surround|包围, 环绕, 围绕;n. 围绕物
weak|不牢固的, 弱的, 虚弱的, 软弱的, 无力的, 无权力的, (论据等)不充分的; 疲软的
occupy|占领, 占(时间、空间等), 住进, 担任, 使从事, 使全神贯注; 占领, 占据, 占有
shock|震动, 冲突, 震惊, 冲击, 突击, 禾束堆, 休克, 长毛狗;vt. 使震动, 使休克, 使受电击, 震惊得;vi. 震动, 吓人;a. 蓬乱浓密的
plane|平面, 扁平物, 机翼, 飞机, 水准, 地位;a. 平的, 平面的;vt. 将...刨平, 刨平, 掠过水面;vi. 翱翔, 乘飞机旅行, 刨掉
odd|奇数的, 古怪的, 剩余的, 零散的, 各种各样的, 少量的;n. 奇特的事物, 怪人; 奇数, 奇校验, 光数据数字转换器
complain|抱怨, 抗议, 控诉
sharp|半升音调, 利刃, 骗子;a. 锋利的, 明显的, 敏锐的, 急剧的, 尖刻的, 严厉的, 刺耳的, 精明的;adv. 锐利地, 急速地
quote|引用;vt. 引述, 举证, 报(价);vi. 引用
paint|油漆, 颜料, 绘画作品, 涂漆;vt. 油漆, 绘, 画, 描绘, 装饰, 点缀;vi. 绘画, 涂漆
dominate|支配, 占优势
blame|过失, 责备;vt. 责备, 归咎于
struggle|斗争, 努力, 奋斗;vi. 努力, 奋斗, 挣扎
politician|政客, 政治家, 从事党派政治的人; 政客, 政治家
resident|居民, 常驻程序, 居住者, 留鸟;a. 居留的, 定居的
criminal|罪犯, 犯人, 刑事;a. 犯了罪的, 刑事的, 有罪的
thinking|思考, 思想;a. 思考的, 有理性的
taste|味道, 品味, 味觉, 感受, 体验, 爱好, 审美, 少量;vt. 尝, 察觉...的味道, 体会;vi. 品尝, 察觉味道, 有某种味道
camp|露营, 帐篷;vi. 露营, 扎营;vt. 使扎营
emergency|紧急状况, 紧急事件, 紧急需要; 紧急情况
stress|压力, 紧迫, 强调, 重音, 重点, 应力;vt. 加压力于, 着重, 重读
dismiss|解散, 开除, 解职;vi. 解散; 解散
minority|少数, 未成年, 少数民族;a. 少数的, 属于少数派的
novel|小说, 长篇故事;a. 新奇的, 异常的
tie|带子, 线, 鞋带, 领带, 领结, 关系, 束缚, 平局, 不分胜负;vt. 系, 打结, 扎, 约束, 与...成平局;vi. 结合, 打结, 不分胜负
suit|套装, 诉讼, 请求, 起诉, 套, 组;vt. 适合, 使适应;vi. 合适, 相称
prize|奖赏, 奖金, 奖品, 战利品, 捕获;a. 得奖的;vt. 珍视, 估价, 捕获, 撬, 撬动
defend|防护, 辩护, 防卫; 作...的辩护律师, 辩护, 为...答辩
arrest|逮捕, 监禁;vt. 拘捕, 抑制, 吸引, 阻止
except|除, 除外;vi. 反对;prep. 除了...之外, 若不是, 除非;conj. 只是
suspect|被怀疑者, 嫌疑犯;a. 令人怀疑的, 不可信的, 可疑的;v. 怀疑, 猜想
mix|混合物, 混乱, 糊涂;vt. 使混合, 弄混, 使结合, 混淆;vi. 相混合, 交往, 参与
tough|恶棍;a. 强硬的, 艰苦的, 坚固的, 坚韧的, 粗暴的, 咬不动的
ice|冰, 冰淇淋, 糖衣, 冷若冰霜, 矜持, 贿赂;vt. 使结冰, 冰镇, 覆以糖衣;vi. 结冰
decline|衰退, 跌落, 下降;vt. 使降低, 婉谢;vi. 下降, 衰落, 偏斜
governor|(美)州长, (英)总督, 统治者, 管理者, 理事; 节制器, 调节器
guess|猜测, 臆测;v. 猜测, 臆测
boss|老板, 上司, 岩瘤, 浮雕, 母牛;vt. 指挥, 控制, 浮雕
protest|抗议, 反对, 抗议书, 断言;v. 反对, 抗议, 断言
export|输出品, 输出;vt. 输出, 出口;vi. 输出物资; 导出
willing|乐意的, 自愿的, 甘愿的
dramatic|戏剧性的, 生动的
camera|照相机, 摄影机, 密谈室, 暗箱; 摄影
guard|守卫者, 警戒, 护卫队, 防护装置;vt. 保卫, 看守, 当心;vi. 防止, 警惕, 警卫, 看守
purchase|购买, 购买品, 紧握, 绞辘;vt. 购买, 赢得, 努力取得, 用滑轮起(锚等)
Thursday|星期四
urge|冲动, 推动力, 迫切的要求;vt. 驱策, 力劝, 竭力主张, 推动;vi. 强烈要求
bomb|炸弹;vt. 轰炸, 投弹于;vi. 失败
federal|联邦的, 联合的, 同盟的; 联邦的, 联邦制的, 联盟的
cast|演员阵容, 投掷, 铸件, 预测, 特性;vt. 投, 掷, 抛, 脱落, 铸, 使弯曲, 计算;vi. 投, 计算, 浇铸成型
cook|厨子, 厨师;vt. 烹调, 煮饭, 加热;vi. 在煮着
dance|跳舞, 舞蹈, 舞会;v. 跳舞
coach|四轮大马车, 教练;vt. 训练, 指导;vi. 坐马车旅行, 作指导
Tuesday|星期二
abuse|滥用, 虐待, 恶习, 辱骂;vt. 滥用, 辱骂, 虐待
armed|有扶手的, 武装的, 有防卫器官的; 武装的, 持械的, "F带武器的
bid|出价;v. 命令, 吩咐, 请求, 表示, 宣布, 投标
dozen|打, 十二个;a. 一打的
sad|忧愁的, 悲哀的
secret|秘密, 机密, 秘诀, 秘方;a. 秘密的, 极机密的, 隐蔽的, 暗中的, 神秘的, 偏僻的
festival|节日的, 喜庆的, 快乐的;n. 节日, 庆祝, 欢宴
rapid|迅速的, 飞快的, 急促的, 陡的;n. 急流
kick|踢, 反冲, 后座力, 凹底;vi. 踢, 反抗, 反冲;vt. 踢, 反冲
guy|家伙, 支索;vt. 用支索撑住, 取笑, 嘲弄;vi. 逃跑
print|打印, 版, 印刷物, 痕迹, 印刷业, 印刷字体, 图片, 印花布, 印章;v. 打印, 印刷, 铭记, 留印记于, 用印刷体写; DOS外部命令:在打印机上打印文件, 可一边打印文件一边执行其他工作
instance|建议, 情况, 例子, 场合;vt. 引以为例, 举例说明
reserve|储备品, 贮量, 后备军, 自然保护区, 保留, 拘谨, 节制, 储备金;vt. 保留, 保存, 预订, 延期, 推迟
cool|凉爽, 凉爽的空气;a. 凉爽的, 冷淡的, 冷静的;vi. 冷却, 平息;vt. 使冷却, 使平静
fun|乐趣, 玩笑, 娱乐;vi. 开玩笑;a. 供娱乐用的
organize|组织, 有机化, 给予生机;vi. 组织起来
pack|包裹, 一伙, 一副, 背包, 包装;vt. 包装, 捆扎, 塞满, 压紧, 挑选;vi. 包装货物, 挤, 群集, 被包装; 压缩
guarantee|担保, 抵押品, 保证书;vt. 保证, 担保
favourite|喜欢的事物;a. 喜爱的, 宠爱的
delay|耽搁, 迟滞;v. 耽搁, 延迟; 延迟, 延时
edition|版本, 版, 翻版
airport|飞机场; 航空站, 机场
chemical|化学药品;a. 化学的, 化学上用的
defeat|败北, 失败;vt. 击败, 使落空
aunt|阿姨, 姨妈, 舅妈, 姑妈, 伯母
split|劈开, 裂片, 裂缝, 分裂, 派系, 派别, 柳条;a. 劈开的;vi. 分离, 分开, 裂开, 被劈开;vt. 劈开, 切开, 使分裂, 使分离; 拆分
seed|种子, 籽, 萌芽, 子孙, 精液;vt. 在...播种, 催...发育, 脱...籽;vi. 结实, 播种
journalist|新闻记者, 从事新闻杂志业的人
found|建立, 创立, 铸造;find的过去式和过去分词
stable|马房, 牛棚;a. 稳定的, 安定的, 坚固的, 坚定的;vt. 赶入马房;vi. 被关在马厩
princess|公主, 王妃, 女巨头
schedule|时间表, 一览表, 计划表, 议事日程;vt. 预定, 编制目录, 制...表, 安排
smoke|烟, 雾气, 烟熏剂, 抽烟, 烟色;vi. 吸烟, 冒烟, 弥漫;vt. 以烟熏, 抽烟而导致...
import|进口货, 进口, 输入, 含义, 重要性;vt. 输入, 引入, 进口, 含...的意思, 重要;vi. 有关系; 引入
favour|好感, 偏爱, 喜爱, 相信, 庇护, 赞同, 支持, 信赖, 善行, 恩惠, 徽章, 礼物;vt. 赞成, 帮助, 支持, 喜爱, 偏袒, 关切, 赐与, 给与, 有利于, 有助于, 像, 体恤
ban|禁令;vt. 禁止, 取缔
addition|加法, 增加的人(或物); 加法
fat|脂肪, 脂油, 肥肉;a. 肥的, 胖的, 油腻的;n. 文件分配表; 文件分配表
movie|电影
fellow|男人, 朋友, 同事;a. 同伴的, 同事的, 同道的
classic|古典作品, 杰作, 大艺术家;a. 第一流的, 最优秀的, 古典的
cousin|堂兄弟姊妹, 表兄弟姊妹; 同辈表亲或堂亲
rival|对手, 竞争者;a. 竞争的
collapse|崩溃, 倒塌, 虚脱;vi. 倒塌, 崩溃, 瓦解;vt. 使倒塌, 折叠; 折叠
frequent|时常发生的, 频繁的, 快速的;vt. 时常来访, 常常聚集, 常与...交往
ally|同盟者, 同盟国, 助手;vt. 使联盟, 使联合, 使有关系;vi. 结盟
crash|哗啦声, 猛撞, 崩溃, 粗布;v. 撞碎, 破碎, (使)...坠毁;a. 速成的; 崩溃
running|赛跑, 流出, 运转;a. 流动的, 跑着的, 连续的
exact|精确的, 准确的, 精密的;vt. 强求, 急需
wound|创伤, 伤口, 伤疤, 伤害, 痛苦;vt. 伤害, 损害, 使受伤;vi. 打伤, 伤害;wind的过去式和过去分词
media|媒体; 媒质
all right|好, 顺利, 良好的, 正确的
latest|最近的
no one|没有人
make|制造, 安排, 创造, 构成, 使得, 产生, 造成, 整理, 布置, 引起, 到达, 进行;vi. 开始, 前进, 增大, 被制造, 被处理;n. 制造, 构造, 性情
so|如此, 如是, 如...那样;conj. 所以, 因此;pron. 这样
know|知道, 了解, 认识, 确信
part|部分, 局部, 零件, 要素, 等分, 职责, 角色, 部位;vt. 分开, 分离, 断绝, 区别, 分配;vi. 分开, 断裂, 分手;a. 部分的, 局部的;adv. 部分地, 有些
set|日落, 同伙, 组合, 集合, 装置;vt. 放, 安置, 放置, 设定, 使凝结, 点燃, 确定, 点缀, 使就位, 树立, 分配, 调整;vi. 日落, 凝固, 定型, 搁住, 结果, 适合;a. 决心的, 规定的,…
form|形状, 形体, 类型, 方式, 表格, 形式;v. 形成, 排列, (使)组成;n. 表单; 表单
right|权利, 右边, 正义, 右派, 公正;a. 正确的, 对的, 恰当的, 正常的, 正直的, 正面的, 右方的;adv. 正确地, 以有利结果, 一直, 直接, 向右;vt. 扶直, 整理, 纠正, 伸冤, 使昭雪;vi.…
live|活的, 生动的, 精力充沛的, 实况转播的;vi. 活, 生存, 居住;vt. 过着, 度过, 经历;adv. 实况地
mind|思想, 愿望, 智力, 记忆, 心理, 情绪, 理智, 主意, 心意;vi. 介意, 注意, 留心;vt. 注意, 留意, 专心于, 照看, 介意
certain|确定的, 某一个的, 必然的; 确凿的, 无疑的, 可靠的
lie|谎言, 假象, 位置;vi. 躺着, 说谎, 位于, 展现, 存在, 停泊;vt. 谎骗
watch|观察, 手表, 看守, 守护, 监视, 值班人;vt. 看, 注视, 照顾, 看守, 守护, 监视;vi. 观看, 注视, 守侯
light|光, 光亮, 灯, 日光, 发光体, 光源, 杰出人物, 火花, 眼光;a. 轻的, 少量的, 轻微的, 轻快的, 轻浮的, 明亮的, 淡色的, 容易的;vt. 点燃, 照亮;vi. 点着, 变亮, 突降, 偶然碰到;a…
deal|交易, 协定, 数量, 买卖, 松木板;vi. 处理, 应付, 做生意;vt. 分配, 发牌, 给予; 发牌
application|应用, 申请, 志愿书, 应用程序; 应用, 应用程序
secretary|秘书, 书记, 大臣; 秘书
concerned|关心的, 有关的, 参与的, 担心的
close|结束, 完结;a. 靠近的, 亲近的, 亲密的, 严密的, 关闭的, 狭窄的, 秘密的;vt. 关, 结束, 使靠近, 封闭, 使接近;vi. 关闭, 结束, 靠近;adv. 接近地, 紧密地; 关闭
fine|罚款, 罚金, 晴天, 精细;a. 好的, 晴朗的, 健康的, 细小的, 精细的;vt. 罚款, 精炼, 澄清;vi. 变清, 变细;adv. 很好; 精细
pick|精选, 选择, 掘, 精华, 牙签, 鹤嘴锄;v. 摘, 掘, 凿, 挖, 挑选; 拾取
march|三月, 进行, 行军, 步伐, 长途跋涉, 进行曲, 边界;vi. 进军, 前进, 交界;vt. 使行军, 使行进
analysis|分析; 分析机; 分析员; 分析; 分析程序
relate|讲, 叙述, 使互相关联;vi. 有关, 符合, 相处得好
compare|比较, 比喻, 对照;vi. 相比;n. 比较; 比较
obtain|获得, 达到;vi. 流行, 得到公认
hall|门厅, 走廊, 会堂
user|使用者; 用户
united|联合的, 团结的, 一致的, 和睦的; 联合的, 统一的, 一致的
appropriate|适当的; 适当的, 拨出, 占用
procedure|程序, 过程, 手续; 规程; 过程
circumstance|环境, 状况, 事件
client|客户, 顾客, 委托人; 客户, 客户机, 客户机程序
exactly|确切地, 精确地, 恰好, 完全地, 确实, 恰恰正是, 确实如此
employment|雇用, 职业, 工作; 职业, 雇用, 职工招请
medium|媒体, 方法, 媒介;a. 半生熟的, 中间的; 媒体, 中
pupil|学生, 门生, 未成年人, 瞳孔; 瞳孔
library|图书馆, 藏书, 库; 库
extent|范围, 程度, 区域; 范围
enable|使能够; 允许, 使能, 打开
speaker|说话人, 讲演者, 发言人, 喇叭, 扬声器; 扬声器
access|通路, 入口, 接近, 进入, 使用权, 发作;vt. 访问, 存取, 接近, 使用; 访问, 存取
text|文本, 正文, 课文, 主题, 圣经文句, 乐谱; 电文; 文本; 正文
easily|容易地, 轻易地, 流利地
reference|参考, 索引, 参照;vt. 给...加上参考资料;vt. 引用;vi. 引用; 引用
context|上下文, 背景, 来龙去脉;n. 上下文; 上下文
interesting|有趣的
communication|交流, 交通, 通讯; 通信
arise|站立, 出现, 起来
left|左边的, 左倾的, 左侧的, 左派的;adv. 在左面;n. 左, 左面, 左派;leave的过去式和过去分词
define|定义, 规定, 使明确; 定义
software|软件; 软设备
requirement|需求, 必要条件, 要求; 要求; 合同要求
arrangement|排列, 整齐, 安排; 排列
railway|铁路, 轨道; 铁路
concept|观念, 概念; 概念
forest|森林, 林区;vt. 植树于
mum|菊花, 沉默;a. 沉默的;vi. 演哑剧;interj. 别说话
hill|小山, 丘陵, 小土堆;vt. 作成土堆, 堆成小丘
expression|表达, 表现, 词语, 措辞; 表达式
primary|最主要者, 原色;a. 主要的, 初期的, 根本的, 原始的, 首要的, 基本的; 初等量; 主要的; 一次的
branch|树枝, 支店, 支流, 分部;vi. 分支, 出枝;vt. 分割, 用枝状叶脉刺绣花纹装饰; 分支, 目录分支
accident|意外事件, 机遇, 事故, 次要方面; 意外事故; 事故
stare|注视, 凝视, 瞪视, 显眼;vt. 盯;n. 凝视
normally|正规地, 合规则, 正常地
associate|同伴, 伙伴, 关联的事物;vt. 使联合, 使发生联系;vi. 交往; 关联
meaning|意义, 含义, 目的, 意图;a. 意味深长的
employ|雇用;vt. 雇用, 使用, 使从事于
consequence|结果, 重要性; 结果, 后果, 推断
relevant|有关联的, 有关系的, 适当的, 相应的; 有关的, 相关的
beginning|开始
proportion|比例, 比率, 均衡, 部分, 面积;vt. 使成比例, 使均衡
latter|后者的, 较后的, 近来的
practical|实际的, 现实的, 实用性的; 事实上的, 实际上的, 接近...的
understanding|理解, 谅解; 协商, 协议, 谅解
path|路径, 小路, 道路, 途径, 路线, 轨道; 路径; DOS内部命令:设定DOS读取程序的路径
appoint|任命, 指定, 下令; 派, 派任, 任命
merely|只
conclusion|结论, 结尾, 推论; 缔结, 结论, 推论
observe|觉察到, 遵守, 注意到, 庆祝;vi. 注意, 评论
belief|信念, 相信, 信仰
winter|冬季, 萧条期, 衰退期;a. 冬天的;vt. 使度过冬天;vi. 过冬
ring|环, 环形物, 拳击场, 戒指, 角逐, 小集团, 铃声, 钟声, 声调;vt. 包围, 套住, 按铃, 敲钟;vi. 成环形, 响, 鸣, 按铃, 敲钟, 回响
dad|爸爸, 爹爹
employer|雇主, 老板; 雇主, 业主
objective|目的, 目标, 宗旨, 宾格, 实物;a. 客观的, 如实的, 无偏见的, 宾格的
nevertheless|然而, 虽然如此;conj. 然而
concentrate|浓缩, 精选;v. 集中, 专心
sample|样品, 范例, 样本;vt. 抽样, 尝试; 示例, 字样
visitor|参观者, 游客, 访客; 视察人, 检视人, 检查员
somewhere|到某处, 在某处
manner|样子, 礼貌, 风格; 方式, 方法, 样式
entirely|完全, 全然, 一概
background|背景, 背景资料; 背景, 后台
previously|先, 先前, 以前, 前, (非正式)过早, 过急, 在前, 在...以前, 在先; 先前地
ordinary|平常的, 普通的, 平凡的;n. 平常的人(或事)
demonstrate|示范, 证明;vi. 示威
technical|技术上的, 专门的, 工业的, 严格根据法律的; 技巧
actual|真实的, 实际的, 现行的; 实际死亡率
bus|公共汽车; 总线; 汇流条; 母线
regulation|规则, 管理, 调整; 调整; 规章; 规则; 调节
coffee|咖啡, 咖啡色; 咖啡, 咖啡豆
wage|工资, 报应, 报偿;vt. 开展, 进行;vi. 进行
acquire|获得, 学到; 目标锁定
fairly|美观地, 公平地, 相当地, 清楚地
meal|一餐, 膳食, 粗粉;vi. 进餐
tradition|传说, 传统, 交付; 传统, 惯例, 移交
internal|内在的, 国内的; 内的, 内部的
category|种类, 类项; 分类
traffic|交通, 通行, 运输, 交通量, 贸易, 交易, 交往, 通信量;vi. 交易, 做买卖;vt. 用...作交换; 通信量, 传输量
exhibition|表现, 展览会, 展览品; 投药, 展览, 展出
sheet|床单, 张, 纸张, 印刷品, 裹尸布, 薄片;vt. 盖上被单, 遍布;vi. 大片落下;a. 片状的, 成薄片的; 工作表
improvement|进步, 改善, 利用; 改善, 好转, 进步
description|描述, 说明, 种类; 说明书(物品), 品名种类, 货物名称
construction|建筑, 构造, 建筑物; 施工
discipline|训练, 纪律;vt. 训练, 惩罚
contrast|差别, 对比, 对照物;vt. 使对比;vi. 成对照; 反差; 对比度
lip|唇, 口缘, 唇状构造;vt. 以嘴唇碰, 轻轻说出;a. 口头上的; 大型互连网信息包
gentleman|绅士, 先生
distribution|分配; 分布
retain|保持, 保有, 留住, 记得, 付定金聘请; 保留, 留存
conversation|会话, 说话, 交谈; 交谈, 社交, 性交
code|代码, 密码, 法规, 法典;vt. 把...编码; 代码
cultural|文化的, 教养的, 修养的; 培养的
unable|不能的, 不会的; 无能力的, 无资格的, 没有办法的
belong|属于, 合适
limited|有限制的, 有限的, 有限责任的;n. 特别快车
contribute|有助于, 捐助, 投稿;vi. 出力, 捐献, 投稿
hide|兽皮, 迹象, 躲藏处;vt. 藏, 隐瞒, 遮避, 剥...的皮, 隐藏;vi. 躲藏; 隐藏
pension|养老金, 退休金, 津贴, 年金, 抚恤金, 膳宿学校, 膳宿费;vt. 发给退休金, 用津贴拉拢
explanation|解释, 说明, 辩解, 表明; 解释, 注释, 说明
plate|碟, 盘子, 盆中物, 金属板, 图版, 金银餐具, 印版, 金属牌(照);vt. 镀金, 电镀, 用金属板固定, 给...装钢板, 为...制印版
lovely|可爱的, 有趣的
capacity|容量, 能力, 才能, 资格; 容量
vary|改变, 使多样化;vi. 变化, 有不同, 违反
selection|选择, 选文, 精选品; 选择, 淘汰
surely|的确地, 安全地; 保证, 保证人, 保证金
rural|乡下的, 田园的, 乡村风味的; 农村的, 乡村的, 有关农业的
intention|意图, 目的, 含义; 愈合, 意向
whereas|然而, 鉴于; 考虑到, 鉴于, 就...而论
initial|字首, 首字母;a. 开始的, 最初的, 字首的;vt. 用姓名的首字母签名
examination|考试, 测验, 审查; 检查, 诊察
definition|定义, 精确度, 清晰度; 清晰度; 清晰度
onto|在...之上
substantial|重要材料(或事物), 有实际价值的东西;a. 实质上的, 物质的, 有内容的, 结实的
output|输出, 产品, 产量; 输出
suitable|适当的, 相配的; 合适的, 适宜的, 适当的
stick|棍, 棒, 刺, 枯枝, 茎, 条状物;vt. 插进, 刺入, 钉住, 伸出, 粘贴, 停止;vi. 粘住, 停留, 坚持, 陷住, 伸出
reasonable|合理的, 明理的, 适当的; 合理的, 公道的, 正当的
offence|犯罪, 冒犯, 违反, 罪过, 过错, 攻击; 犯法, 罪过, 过错
reduction|减少, 缩影, 变化; 还原
detailed|详细的, 复杂的; 详细的, 详尽的
appointment|约会, 委任的职位, 委派; 任命, 派, 指定
afraid|害怕的, 恐怕的, 遗憾的
concentration|集中, 专心; 浓度; 浓缩
neck|脖子, 衣领, 颈;vi. 拥抱, 拥吻, 收缩;vt. 割颈
bedroom|卧室
combine|(使)联合, (使)结合;n. (企业的)联合, 联合收割机
sufficient|充分的, 足够的; 充分的, 足够的
absence|缺席, 缺乏, 没有; 失神
teaching|教学, 学说, 教导
birth|出生, 起源; 生产, 分娩
shout|呼喊, 喊声;vi. 呼喊, 喊叫, 嚷;vt. 高喊
error|错误, 过失, 失误, 误差; 错误
acid|酸, 酸类物质, 尖刻, 迷幻药;a. 酸的, 酸性的, 尖刻的, 敏锐的; 自动文档互参与索引生成程序
ear|耳朵, 倾听, 听觉, 穗;vi. 抽穗
scientific|科学的, 系统的, 符合科学规律的; 科学记数法
whilst|当...的时候, 和...同时, 虽然, 只要, 然而, 而, 尽管
pleasure|快乐, 愉快, 令人高兴的事, 娱乐, 希望;v. (使)高兴
select|挑选出来的, 极好的;v. 选择, 挑选;n. 被挑选者, 精萃; 选定
mental|心智的, 精神病的, 心理的, 颏的;n. 精神病患者
temperature|温度, 发烧, 热度; 温度
beside|在旁边
implication|牵连, 含义, 暗示; 推断, 含蓄之意, 暗示
recognition|赞誉, 认得, 识别, 承认, 认可, 认识; 认识
seriously|严肃地, 认真地, 严重地
familiar|熟悉的, 常见的, 亲密的;n. 熟友, 常客
partly|部分地, 在一定程度上
elsewhere|在别处
necessarily|必然地, 必须地, 必要地
household|一家人, 家庭, 家族, 王室;a. 家庭的, 家常的, 王室的
climb|攀登, 上升, 爬;n. 攀登, 爬升
nurse|护士, 保姆, 奶妈;vt. 看护, 照顾, 培养;vi. 喂奶, 看护病人
experiment|实验, 试验, 实验仪器;vi. 实验, 尝试
silence|沉默, 无声, 静寂, 湮没, 无声息;vt. 使缄默;interj. 安静
publication|出版物, 出版, 公布; 发布
journey|旅程, 旅行, 行程;vi. 旅行;vt. 游历
disappear|消失, 不见
tiny|很少的, 微小的
noise|噪音, 杂音, 响声, 喧闹;vt. 谣传;vi. 喧闹; 噪声
metal|金属, 金属制品, 合金, 本质, 质料;a. 金属制的;vt. 以金属覆盖
connection|连接, 关系, 前后关系; 连接
thin|薄的, 细的, 瘦的, 稀疏的, 稀薄的, 淡的, 弱的, 空洞的;vt. 使变薄, 使变细, 使稀少, 使淡;vi. 变薄, 变细, 变少, 变淡;adv. 薄地, 稀疏地, 微弱地;n. 细小部分
sum|总数, 总和, 金额, 概要, 顶点;vt. 总计, 概括;vi. 合计; 系统实用程序和维护
sky|天空, 天色, 天堂;vt. 击向空中, 挂在高处;vi. 高涨
imply|暗示, 意味; 隐含
illustrate|举例说明, 作图解, 阐明;vi. 举例说明
pool|池, 水塘, 石油层, 联营;vt. 合伙经营, 共享, 采掘, 汇聚成;vi. 汇合成塘, 淤积, 联营
map|地图, 天体图, 映像;vt. 映射, 绘制...地图, 计划; 实用程序, 映射, 制造自动化协议
phase|时期, 局面, 方面, 位相, 相, 阶段;vt. 使调整相位, 使定相, 使一致, 逐步执行, 实行; 阶段
conclude|结束, 作结论, 推断;vi. 结束, 推断
initiative|主动行动, 首创精神, 主动权;a. 自发的, 起始的
historical|历史的, 史实的, 历史上的; 历史性的
remind|提醒, 使想起
reading|阅读, 知识, 读物;a. 阅读的
theme|主题, 话题, 题目
location|位置, 场所, 特定区域; 位置
gate|门, 牌楼, 大门, 通道, 闸;vt. 装门于; 门; 栅
instrument|工具, 手段, 仪器; 仪器
cat|猫, 恶妇;vi. 呕吐;计算机辅助教育, 计算机辅助测试, 计算机辅助翻译, 计算机辅助排版; 计算机辅助教学, 计算机辅助翻译, 计算机辅助排字, 计算机辅助测试
generate|产生, 发生, 导致; 产生
emphasis|强调, 加强, 重点, 强语气
afford|买得起, 足以, 给予
inform|通知, 使了解, 使充满;vi. 提供资料, 告发
advise|劝告, 给...出主意, 通知, 建议;vi. 提意见, 商量
priority|优先权, 优先; 优先级
opening|开始, 口子, 穴, 揭幕;a. 开始的
combination|组合, 合并, 联合; 组合图
empty|空的, 空虚的, 空腹的, 空洞的;n. 空的东西, 空车;vt. 倒空, 使变空, 使排出;vi. 流空; 空
faith|信心, 信任, 忠实, 保证; 信任, 信仰, 信念
tool|工具, 机床, 傀儡;vt. 用工具加工;vi. 使用工具
married|已婚的, 婚姻的; 结了婚的, 有配偶的, 夫妇的
upper|上面的, 较高的, 上级的, 上院的, 穿在外面的, 北部的, 地表的, 后期的;n. 鞋帮, 上齿
tooth|牙齿, 齿状物, 爱好;vt. 装以齿, 将...切成齿状;vi. 啮合
hell|地狱, 邪恶势力, 苦境, 阴间, 毁坏, 训斥;vi. 狂饮, 飞驰
urban|都市的, 住在都市的, 习惯于都市的; 城市的, 都市的, 市区的
busy|忙碌的, 热闹的, 没空的;vt. 使忙;vi. 忙碌; 忙; 忙碌
tall|高的, 长的, 夸大的;adv. 夸大地
lane|小路, 巷, 弄, 单行道
crown|王冠, 王权, 顶点;vt. 使成王, 加冕, 居...之顶
coal|煤, 木炭;v. 加煤
castle|城堡, 象棋中的车;vt. 置于城堡中, 盘踞于
literature|文学, 文艺, 著作; 广告, 商品介绍等文学
motion|移动, 手势, 动作, 意向, 请求, 提议;v. 打手势
breath|呼吸, 气息, 瞬间; 呼气, 呵气, 口气, 呼吸
apparent|清晰可见的, 显然的, 表面上的; 外在的
membership|会员的资格, 全体会员, 会员数目; 会员资格, 成员资格, 会籍
suggestion|提议, 意见; 暗示
persuade|劝, 使相信, 恳求, 敦促, 说服;vi. 劝服, 被说服
cope|竞争, 应付;n. 长袍
attractive|吸引人的, 有魅力的; 有吸引力的, 有迷惑力的
passage|通道, 通过, 移居, 航行, 一段, 走廊;vi. 通过, 经过, 航行, 横渡, 争吵;vt. (使)马以斜横步前进, 使传代
pocket|口袋, 钱袋, 钱, 容器;vt. 装...在口袋里, 隐藏, 抑制, 私吞, 搁置, 击...入袋;a. 袖珍的, 小型的, 压缩的, 金钱上的
moral|道德, 品行, 寓意;a. 道德的, 品性端正的, 精神上的
shut|关闭;vt. 关上, 闭起, 幽禁, 合拢, 轧住;vi. 关上, 停止营业
index|索引, 指针, 指数, 指标;vt. 编入索引中, 指出;vi. 做索引; 下标; 附标; 变址; 索引; 编索引
valley|山谷, 溪谷, 流域, 凹地; 谷
vital|生命的, 重要的, 充满活力的, 生死攸关的, 致命的; 生命的, 生活的, 生活上必需的, 紧要的
recover|重新获得, 恢复, 复原, 拯救;vi. 痊愈, 复原, 胜诉; 恢复
thick|厚的, 粗壮的, 浓的, 迟钝的, 浑浊的, 多雾的, 过分的, 口齿不清的;adv. 厚地, 密地, 浓浓地;n. 最浓处, 最厚处, 最密集处; 暗, 粗线
specialist|专门医师, 专家;a. 专业的, 专家的
characteristic|特性, 特征, 特色;a. 特性的, 特有的, 有特色的; 阶; 指数
lake|湖, 池, 色淀;v. (使)血球溶解
tone|音调, 音质, 语调, 语气, 色调, 气氛, 状况, 思想状态;vt. 给...定色调, 增强, 使...的声调和谐, 定音调;vi. 颜色调和; 双音频
engineering|工程学, 工程, 操纵; 机器; 机器学
pub|酒馆, 客栈
religion|宗教, 信仰; 宗教, 宗教信仰, 信仰
blow|吹, 打击, 殴打, 花开;v. 吹, 风吹, 吹响, 开花
leaf|叶, 树叶, 花瓣, 页;vi. 生叶, 翻书页;vt. 在...上长叶, 翻...的页
foundation|基础, 根据, 建立; 地基
device|装置, 设计, 策略, 发明物, 设备; 设备; DOS内部命令:该命令要求DOS安装一个设备驱动程序
rare|稀罕的, 罕有的, 珍奇的, 稀薄的, 半熟的, 非常好的;adv. 非常
chain|链, 枷锁, 束缚;vt. 用铁练锁住, 束缚, 囚禁
elderly|过了中年的, 稍老的
hate|憎恨, 恨, 厌恶;vt. 憎恨, 憎恶;vi. 仇恨
ancient|古代的, 古老的, 年老的, 旧的
impression|印象, 意念, 盖印, 印记, 印数, 底色, 效果; 压迹, 印模, 印象, 影响
neighbour|邻居, 邻接的东西, 邻国, 邻座, 邻人, 世人;a. 邻接的, 邻近的;vi.vt. 邻近, 与...结邻, 邻接
capable|有能力的, 能的, 能干的
attach|附上, 使依附, 使附属, 使喜爱, 系, 缚;vi. 附属, 归属, 联系在一起; 挂接服务器命令, 关联, 挂接, 附加
typical|典型的, 象征性的; 典型的
wash|洗, 洗涤, 冲洗, 洗的衣服, 冲积物, 洼地;vt. 洗, 洗涤, 洗清, 用水冲洗, 流过, 弄湿, 粉刷, 镀金属薄层于;vi. 洗涤, 洗澡, 被冲蚀, 漂浮
atmosphere|大气, 空气, 气氛; 大气; 大气压
revolution|革命, 大变革, 旋转, 转数, 循环; 回转
panel|嵌板, 仪表板, 专题讨论小组, 全体陪审员;vt. 嵌镶板
enemy|敌人, 仇敌, 敌军;a. 敌人的
tear|泪滴, 眼泪, 撕, 扯, 裂缝, 激怒, 飞奔;vi. 流泪, 撕破, 赶快, 飞奔, 被撕破;vt. 撕裂, 戳破, 拉掉, 撕掉, 使分裂, 使精神不安, 折磨
lean|瘦肉, 倾斜, 倾斜度;a. 瘦的, 贫乏的, 歉收的;vi. 倚靠, 倾斜, 依赖;vt. 使倾斜
iron|铁, 熨斗, 铁器, 坚强, 烙铁, 镣铐;vt. 烫平, 熨, 用铁包;vi. 烫平
servant|仆人, 有用物, 公务员, 雇员; 受雇人, 服务者, 公务员
roof|屋顶, 室顶;vt. 给...盖屋顶, 遮蔽
milk|奶, 乳状物;vt. 挤乳, 榨取;vi. 产乳
explore|探险, 探测, 探究
shoe|鞋, 靴, 外胎;vt. 给...穿鞋, 为马钉蹄铁
nose|鼻子, 突出部分, 嗅觉;vt. 嗅到, 探出, 用鼻子触;vi. 闻, 嗅, 探听, 告密
engineer|工程师, 工兵;vt. 设计, 监造, 精明地处理, 策划
beneath|在...下方;adv. 在...下方
steal|剽窃;偷偷地做;偷窃;vi. 窃取;偷偷地行动;偷垒;n. ;偷窃;便宜货;偷垒;断球
soil|土壤, 土地, 国家, 国土, 温床, 污物, 粪便, 水池;vt. 弄脏, 污辱;vi. 变脏
tank|槽, 箱, 柜, 罐, 池塘, 储水池, 坦克;vt. 储于箱中
origin|起源, 起因, 出身, 开端; 原点; 起始地址; 信件来源的相关数据
beach|海滩
accompany|陪伴, 伴随, 补充, 为...伴奏;vi. 伴奏, 伴唱
unfortunately|恐怕, 不幸的是
warning|警告, 预告, 预兆, 通知; 警告, 警戒, 预告; 警告的, 注意的
minor|未成年人, 副修科目;a. 较小的, 二流的, 未成年的;vi. 副修; 次要
height|高度, 海拔, 高地, 顶点; 高度
gift|礼物, 赠予, 天才;vt. 赋予
pleased|高兴的, 喜欢的, 满足的
expense|费用, 代价, 开支, 损失; 费用, 开支, 将支出转为费用
vision|视觉, 眼光, 视力, 幻想;vt. 梦见, 想象, 显示
stretch|伸展, 张开, 连绵, 一段路, 一段时间;a. 可伸缩的, 弹性的;vt. 伸展, 张开, 曲解, 使过度伸展;vi. 伸展, 延伸; 伸展
bone|骨头, 骨, 骨制品;vt. 剔骨;vi. 专心致志
palace|宫, 宫殿, 华丽大厦
vast|巨大的, 广大的, 非常的, 大量的
academic|学院的, 学术的, 不切实际的;n. 大学生, 大学教师, 学者, 学会会员
funny|好笑的, 有趣的, 滑稽的;n. 滑稽人物
convention|大会, 协定, 惯例, 约定; 约定
trend|趋势, 倾向, 走向;vi. 倾向, 转向; 趋势
living|生活, 生计, 生存;a. 活的, 逼真的, 现存的
afterwards|然后, 后来
switch|开关, 电闸, 转换, 软枝, 鞭子, 道岔;vt. 转变, 切换, 摆动, 转换, 使转轨;vi. 转换, 变换, 摆动; 开关; 翻转; 转移
lesson|课, 课业, 教训
fix|使固定, 修理, 准备, 安装, 凝视, 牢记, 确定, 整理;vi. 固定, 注视, 确定;n. 困境, 方位, 维修, 贿赂
knock|敲, 敲打, 敲门;v. 敲击, 互撞, 攻击
justify|替...辩护, 证明;vi. 证明合法; 段落重排, 两端对齐
signal|信号, 暗号, 近因, 导火线;vt. 向...作信号, 标志, 用信号通知;vi. 发信号;a. 作为信号的, 显著的; 信号
rail|横杆, 围栏, 栏杆, 铁轨, 扶手, 秧鸡;vt. 以横木围栏, 给...铺铁轨;vi. 责骂, 抱怨
somewhat|某物, 几分;adv. 多少, 几分
comparison|比较, 对照, 比喻; 比较, 对比
expectation|期待, 指望, 展望; 期望值
pursue|追赶, 追踪, 追随, 追求, 实行, 继续, 从事;vi. 追赶, 继续
plenty|充分, 很多, 丰富;a. 很多的, 足够的, 丰富的
knee|膝, 膝盖;vt. 膝行, 用膝盖碰
gap|缝隙, 缺口, 间断, 间距, 通用汇编程序;vt. 打开缺口, 造成缝隙;vi. 豁开; 通用汇编程序, 图形应用程序, 间距
appreciate|赏识, 鉴别, 为...而感激, 领会, 欣赏;vi. 增值, 涨价
root|根, 根本, 根源, 基础, 底部;vt. 使扎根, 使固定, 根除, 肃清, 搜出, 用鼻拱;vi. 生根, 固定, 源于, 用鼻拱土, 寻找, 捧场, 支持
permanent|永久的, 不变的, 固定的, 持久的;n. 烫发; 永久的
ourselves|我们自己
originally|本来, 原来, 最初, 就起源而论, 独创地
complaint|诉苦, 抱怨, 控诉; 陈诉; 病
plastic|塑料, 可塑体, 可塑性物质;a. 塑料的, 塑造的, 有可塑性的, 造型的, 易受影响的, 有创造力的
passenger|乘客, 旅客; 乘客, 旅客
grass|草, 草原, 牧场; 草, 禾本
via|经由, 经过, 通过; 病毒灭活剂
somehow|不知何故
shadow|阴影, 荫, 影子, 影像, 阴暗, 幽灵, 少许, 隐蔽处, 庇护;vt. 遮蔽, 使朦胧, 预示, 尾随;vi. 渐变, 变阴暗; 阴影
column|专栏, 圆柱, 纵队, 列, 柱形物; 列, 柱形图
charity|慈悲, 博爱, 慈善团体, 施舍; 宽大, 宽恕, 慈善机关
crucial|决定性的, 重要的, 严厉的; 十字形的; 决断的, 定局的
inner|内部的, 内心的;n. 内部
negative|否定, 否定语, 负数, 底片;a. 否定的, 消极的, 负的, 阴性的;n. 负数, 负值; 负数, 负值
manufacturer|制造业者, 厂商; 制造人, 制造商, 制造厂
breakfast|早餐
permit|许可证, 许可, 执照, 通行证;vt. 允许, 容许, 可能, 使放手做;vi. 容许, 给以机会, 提供可能
fundamental|基本原理, 原则, 基波;a. 基本的, 重要的, 原音的
virtually|事实上
perfectly|完全地, 无瑕疵地, 完整地
massive|大而重的, 宽大的, 宏伟的; 大块的, 整块的, 大量的
engage|答应, 从事, 交战;vt. 使忙碌, 雇佣, 预定, 使从事于, 使参加
sick|病人;a. 不舒服, 有病的, 恶心的, 厌恶的, 渴望的, 病态的;vt. 呕吐, 追击, 使(狗)去攻击
exception|例外, 除外, 异议; 例外; 异常
beauty|美, 美人
licence|执照, 许可证, 特许;vt. 许可, 特许, 认可
abandon|放弃, 抛弃, 遗弃, 使屈从, 沉溺, 放纵;n. 放任, 无拘束, 狂热
construct|构造, 建造, 对...进行构思, 作图;n. 构成物
identity|身份, 相同, 一致, 特性, 恒等式; (打)标记, 标识
inquiry|质询, 探索, 调查, 询盘; 询问; 查询
contemporary|同时代的人;a. 同时代的, 属于同一时期的
fault|过错, 故障, 毛病;vt. 挑剔;vi. 产生断层, 弄错; 故障
badly|严重地, 恶劣地, 极度地
alive|活着的, 活泼的, 敏感的, 热闹的
phrase|惯用语, 词组, 成语, 措词, 乐句;vt. 用短语表达, 把(乐曲)分成短句; 短语
quantity|量, 数量, 总量; 数量; 量
angry|生气的, 愤怒的
pilot|飞行员, 领航员, 航船者, 导向器, 驾驶仪, 向导, 领导人;vt. 领航, 驾驶, 引导, 试用;a. 引导的, 控制的, 试点的; 引导
mirror|镜子, 写真, 典范;vt. 反映, 映出
unknown|不知道的, 未知的, 陌生的;n. 未知物, 未知数
naturally|自然地, 以自然力, 天生地
proceed|继续进行, 进行, 开始, 发出, 起诉; 所得, 收入, 收益
unique|独一无二的, 独特的, 稀罕的
preparation|准备, 预备, 预习; 制剂
tension|紧张, 不安, 拉紧, 张力, 压力, 电压;vt. 拉紧, 使紧张
assistance|协助, 援助; 援助, 帮助
metre|公尺, 格律, 韵律; 米, 公尺
acknowledge|承认, 告知收悉, 答谢, 报偿; 承认, 答谢, 收到的通知
moreover|而且, 此外
enormous|巨大的, 庞大的
alter|改变
rarely|很少地, 罕有地
expand|使膨胀, 详述, 扩张;vi. 张开, 发展;vt. 展开;vi. 展开; 展开; DOS外部命令:将原始DOS磁盘上的压缩文件解压缩并拷贝到硬盘上
guilty|犯罪的, 有过失的, 自觉有错的, 心虚的; 有罪的, 犯罪的, 自觉有罪的
tower|塔, 高楼, 堡垒;vi. 高耸, 翱翔
bother|烦扰, 迷惑;vi. 烦恼, 操心;n. 麻烦, 纠纷, 讨厌的人
yours|你的(东西), 你们的(东西)
lucky|幸运的, 吉祥的, 好运的, 侥幸的
coat|外套;vt. 外面覆盖, 给...穿外套
involvement|卷入, 牵连, 包含, 困窘; 财政困难, 经济上的困窘
partnership|合伙, 合股, 合作关系; 合伙(合作)关系, 全体合伙人
pollution|污染, 玷污; 污染
unusual|不寻常的, 罕见的, 与众不同的
anywhere|无论何处
inch|英寸, 身高, 小岛;vi. 慢慢前进, 慢慢移动;vt. 使缓慢地移动
depth|深度, 深处, 深奥; 深度
frame|框, 结构, 体格;vt. 构成, 设计, 制定, 使适合, 陷害; 框架, 图文框, 帧
assist|帮助, 协助;vt. 帮助, 促进;vi. 协助, 参加
port|港口, 埠, 舱门, 避风港, 左舷, 炮眼, 姿势, 意义;vt. 左转舵, 持(枪);vi. 左转舵; 端口, 移植
command|命令, 指挥, 控制, 部队, 司令部;v. 命令, 指挥, 控制; 命令; 指令; DOS外部命令:启动新的命令处理器
dear|亲爱的人;a. 亲爱的, 昂贵的, 严重的, 急迫的;interj. 啊;adv. 深爱地, 高价地
delivery|递送, 交付, 分娩, 交货, 引渡; 交货额
string|线, 细绳, 一串, 字符串;vt. 串起, 成串, 收紧, 缚, 扎;vi. 成一串; 字符串, 串
yellow|黄色;a. 黄色的
resolve|决定, 分解, 决心;vt. 使分解, 解析, 解决, 消除, 决心;n. 决定之事, 决心, 坚决
wheel|轮子, 车轮, 轮, 方向盘, 旋转, 机构, 重要人物;vt. 使旋转, 转动, 使转向;vi. 旋转, 转弯, 盘旋
boot|长靴, 踢, 解雇, 效用;vt. 使穿靴, 踢, 解雇, 有用; 引导, 自举
wake|叫醒, 激发;vi. 醒来, 醒着, 觉醒, 活跃起来;n. 守侯, 守夜, 尾迹, 痕迹
poem|诗, 诗般美的事物
extensive|广的, 广泛的, 多方面的; 广大的, 扩大的
glad|高兴的, 喜欢的, 情愿的
remaining|剩余的
net|网, 网状物, 罗网, 净利, 净价;a. 净的, 最终的;vt. 用网捕, 撒网, 净赚, 得到;vi. 编网; 网络, 网络分析程序
unlike|不像的, 不同的;prep. 不像, 和...不同
comfortable|舒服的, 轻松的;n. 盖被
efficient|有效率的, 能干的
healthy|健康的, 有益健康的, 卫生的; 健康的
cycle|周期, 循环, 自行车, 一段时间, 整套;vi. 循环, 轮转, 骑自行车;vt. 使循环, 使轮转; 环路; 周期; 循环
reckon|计算, 总计, 估计, 认为, 猜想;vi. 数, 计算, 估计, 依赖, 料想
hat|帽子;vt. 给...戴帽子
tired|疲累的, 疲乏的, 厌倦的
profession|职业, 表白, 声明; 工种; 职业
load|负荷, 担子, 重担, 装载量, 负载, 工作量, 加载;vt. 装载, 装填, 使担负;vi. 装货, 上客, 装料; 加载, 装入程序
chest|胸, 胸部, 衣柜, 箱子; 胸, 胸廓
restore|回复, 恢复, 归还, 修补, 修复;vt. 还原;vi. 还原; 还原; DOS外部命令:从备份盘中取回文件
approval|赞成, 批准; 核准
cottage|小屋, 茅舍
mostly|大概, 大部分, 主要; 大部份
reputation|名誉, 名声, 声望; 名声, 名誉, 公认证据
valuable|有价值的, 贵重的, 宝贵的, 可估价的; 有价值的, 可估价的, 贵重的
slight|轻蔑, 怠慢;a. 轻微的, 纤细的, 脆弱的, 苗条的;vt. 轻视, 忽略, 怠慢
habit|习惯, 嗜好, 习性;vt. 使穿衣
friendly|友好的, 亲切的, 互助的;adv. 友善地, 温和地
abroad|往国外, 到室外, 到处;a. 往国外的, 在室外的, 广泛四散的
silver|银, 银币, 银器;a. 银的, 银制的, 银器的;vt. 镀银;vi. 变银白色
convert|皈依者, 改变宗教信仰者;vt. 使改变信仰, 转换, 兑换, 倒置;vi. 皈依; 转换
layer|层, 产卵鸡, 放置者;vt. 分层堆积, 压植; 层
countryside|乡下地方, 乡下居民
sudden|突然, 忽然;a. 突然的, 意外的, 快速的
empire|帝国, 帝权
autumn|秋天, 成熟期
conventional|传统的, 习惯的, 约定的; 惯例的, 常规的, 传统的
relative|亲戚, 关系词;a. 有关系的, 相对的, 比较的
landscape|风景, 山水, 风景画;vi. 从事景观美化;vt. 美化...景观; 横向
shortly|不久, 简短, 唐突地
solve|解决, 付给, 溶解;vt. 求解;vi. 求解; 求解
keen|锋利的, 敏锐的, 强烈的, 敏捷的, 热心的, 渴望的;n. 挽歌, 痛哭;v. 唱挽歌, 痛哭
arrival|到达, 抵达, 到达者; 到达, 到达物
steel|钢, 钢制品, 钢铁, 坚硬, 坚固;a. 钢的, 钢制的, 钢铁业的, 坚强的;vt. 使坚强, 钢化, 使冷酷
meat|肉, 餐, 食物; 肉类
worried|担心的, 闷闷不乐的
specifically|特定地, 明确地, 按特性
self|自己, 自我, 本性, 本质, 私心, 本人;vt. 使近亲繁殖, 使自花授精;vi. 自花授精;a. 同一的
preserve|保护, 保持, 保存, 维持, 腌, 禁猎;vi. 加工食品, 禁猎;n. 加工成的食品, 禁猎地, 保护区, 防护物
predict|预知, 预言, 预报
initially|最初, 开头
illness|疾病, 恶意; 病
soul|灵魂, 心灵, 精神, 精髓, 人, 化身, 典型, 鬼魂;a. 黑人的
bread|面包, 生计, 食物;vt. 裹以面包屑
sugar|糖, 糖块, 甜言蜜语;vt. 加糖于, 使甜蜜, 粉饰, 美化;vi. 制成糖
electricity|电, 电流, 电学, 热情, 电力供应; 电学; 电
silent|沉默的, 安静的, 无声的, 静止的; 静止的, 无症状的
beer|啤酒; 啤酒
uncle|叔父, 伯父, 姨丈
temporary|暂时的, 临时的;n. 临时工, 临时雇员; 临时
drama|戏剧, 戏剧艺术
cake|蛋糕, 块, 饼;vt. 使结块, 加块状物于;vi. 结块
wealth|财富, 资源, 财产, 丰富, 富裕, 大量; 财富
resistance|抵抗力, 反抗, 耐力, 阻力, 电阻; 抵抗; 抗性; 阻力; 抗药性; 电阻
peak|山峰, 巅, 山顶, 顶点, 尖峰, 帽舌;a. 最高的, 最大值的;vi. 到达最高点, 消瘦, 变憔悴, 逐渐缩小;vt. 使竖起, 使达到最高点
muscle|肌肉, 臂力; 肌
pale|栅栏, 界线, 范围;a. 苍白的, 暗淡的, 无力的;vi. 变苍白, 变暗, 失色;vt. 使变苍白, 使失色, 用栅栏围
laboratory|实验室, 研究室, 化工厂; 实验室, 检验室, 化验室
hello|喂, 嘿
shift|变化, 移动, 轮班, 手段, 应急办法, 移位;vt. 替换, 转移, 改变, 推卸, 变速;vi. 转换, 移动, 转变, 推托, 变速; DOS内部命令:该命令可将批处理参数向左移动一个位置
owe|亏欠, 负...债, 归功于, 怀有, 应给予, 感恩;vi. 欠钱
mood|心情, 气氛, 生气, 基调; 心境
personality|个性, 人格, (团体、地方、国家)特有特性, 名人; 人格; 个性
invest|投资, 花费, 笼罩, 授予;vi. 投资, 利用
bay|海湾, 狗吠声, 月桂;vt. 吠, 使走投无路;vi. 吠
pour|流出, 倾泻, 骤雨;vt. 倒, 灌, 注, 倾泻, 诉说, 倾吐;vi. 倾泻, 蜂涌而来, 下大雨
lock|锁, 刹车, 水闸, 一缕头发;vt. 锁, 锁上, 拘禁, 隐藏, (用锁等)拴住, 刹住;vi. 锁住, (齿轮等)啮合, (船)过闸
cloud|云, 阴暗, 烟雾, 疑团;vt. 以云遮敝, 笼罩, 使黯然;vi. 乌云密布, 阴沉
zone|地带, 带, 地区;vt. 环绕, 使分成地带;vi. 分成区; 卡片顶部的三行区; 区; 区域
wet|湿气, 潮湿, 水分, 雨天;a. 湿的, 潮的, 搞错的, 下雨的, 反对禁酒的;vi. 变湿;vt. 使...湿
angle|角, 角度, 角落;vi. 钓鱼, 谋取, 博取, 斜向移动, 转变角度;vt. 使转动角度, 在...钓鱼, 获取
philosophy|哲学, 人生观, 哲学思想, 哲理, 基本原理, 见解, 达观, 沉着
competitive|竞争的; 竞争的
false|错误的, 虚伪的, 假的, 不老实的;adv. 不准确地, 欺诈地
sensitive|敏感的, 易感的, 灵敏的, 感光的; 敏感的, 灵敏的, 感度高的
retire|隐居;vi. 引退, 退役, 退休, 退去, 撤退, 退却;vt. 使...撤退, 辞退
aside|小声说的话, 旁白;adv. 在一边, 离开, 另外
tendency|趋向, 倾向; 趋向, 趋势
sweet|甜蜜, 糖果, 情人;a. 甜的, 芳香的, 悦耳的, 漂亮的, 和蔼的, 不咸的, 灵活的, 轻快的
fixed|固定的, 不变的; 固定的, 确定的, 不变的
CORE|核心, 果心, 要点;vt. 挖...的核; 内核, 核心网
chamber|室, 房间, 枪膛;vt. 装(弹药), 把...关在室内;a. 室内的
honour|荣誉, 头衔, 信用, 尊敬, 名誉, 阁下, 勋章;vt. 尊敬, 授予荣誉, 承兑, 实践
deposit|存款, 定金, 堆积物;vt. 存放, 堆积;vi. 沉淀
rent|租金, 房租, 出租物, 裂缝, 破裂处, 分裂;vt. 租用, 租出;vi. 出租;a. 分裂的, 破裂的;rend的过去式和过去分词
pure|纯的, 纯净的, 纯洁的, 清白的, 完美的, 无瑕的, 抽象的; 的, 纯净的
acceptable|可接受的, 合意的, 可忍受的
emotional|情绪的, 情感的; 情绪的
actor|男演员, 行动者; 作用物, 反应物
wedding|婚礼, 结婚, 结婚周年纪念日, 结合; 结婚, 婚礼, 结婚纪念日
cigarette|香烟, 纸烟
chip|屑片, 薄片, 碎片;vt. 削, 切, 削成碎片, 使摔倒, 凿;vi. 削下屑片; 孔屑; 组件; 晶片; 芯片
adequate|适当的, 足够的; 胜任的, 适当的, 充分的
essentially|本质上, 本来
jacket|夹克, 外套, 护套;vt. 给...穿夹克, 给...装护套
shirt|衬衫, 内衣, 汗衫
kiss|吻;vt. 吻;vi. 接吻
global|通用的, 全球的, 球形的, 综合的, 普遍的; 共用
resist|抵抗, 耐得住, 抵制, 反抗;n. 防染材料
solid|固体;a. 坚硬的, 稳固的, 固体的, 实心的, 纯质的, 立体的, 立方的; 原色
apart|成零碎, 成距离, 分别地, 分离着;a. 分离的
absolute|绝对的, 专制的, 完全的, 独立的;n. 绝对事物
routine|常规, 日常工作, 惯例, 例行公事;a. 日常的, 常规的; 例程
rough|粗糙的东西, 毛坯, 未加工品, 梗概, 草图, 暴徒, 艰难;a. 粗糙的, 粗暴的, 蓬乱的, 草率的, 大致的, 简陋的, 暴风雨的, 艰难的;vt. 使粗糙, 使不平, 使蓬乱, 粗制, 草拟, 粗暴对待, 对.…
remarkable|不平常的, 值得注意的, 显著的
precisely|精确地, 明确地, 刻板地, 拘泥地, 正好, 恰恰, 对, 正是如此, 确实如此, 不错
tourist|观光客, 旅行者;a. 旅游的
mixture|混合, 混淆, 混合物; 混合物
maximum|极点, 最大量, 极大;a. 最高的, 最大的, 最大极限的; 最大值
furniture|家具, 帆具
brilliant|光辉的, 灿烂的, 有才气的; 亮的
register|寄存器, 记录, 登记簿, 注册;vt. 记录, 注册, 提示, 表达, 把...挂号;vi. 登记, 注册, 挂号; 寄存器
monitor|监督器, 级长, 监听员, 班长, 监视器, 告诫物;v. 监视, 监听, 监督; 监视器, 监视程序; 监视
substance|物质, 实质, 主旨, 资产, 本质, 牢固; 物质
breathe|呼吸, 生存, 低语;vt. 呼吸, 使喘息, 发散, 低声说
retirement|退休, 隐居, 撤退; 退休, 退股, (固定资产)报废
recording|记录的, 记录用的;n. 录音
pipe|管, 导管, 输送管, 管状器官, 声带, 尖细的声音, 烟斗, 笛, 管乐器;vt. 以管输送, 吹哨子, 吹奏, 尖声唱;vi. 吹笛, 尖叫, 吹长哨发令; 管道
mere|小湖, 池塘;a. 仅仅的, 只不过的
celebrate|庆祝, 祝贺, 举行
intelligence|智力, 情报, 信息; 智力
bend|变弯曲, 屈服;vt. 使弯曲, 使屈服;n. 弯曲
apple|苹果, 家伙; 苹果
throat|咽喉, 喉咙, 嗓音;vt. 用喉音说, 开沟于
wooden|木制的, 呆笨的, 木然的
discovery|发现, 被发现的事物; 要求告知, 发现, 发觉
emotion|情绪, 激动, 强烈的情感; 情绪, 情感
pace|速度, 步调, 步法;vi. 踱步, 缓慢走;vt. 用步测, 踱步于
overcome|战胜, 克服, 胜过;vi. 得胜
behave|举止端正, 行为规矩;vt. 检点(自己的)行为, 使表现好
rank|等级, 排, 横列, 队伍, 阶级;a. 茂密丛生的, 恶臭的, 十足的, 粗俗的;vt. 排列, 归类于, 把...分等;vi. 列为, 列队;n. 秩; 秩
disaster|灾祸, 不幸, 彻底失败
stream|水流, 小河, 流出, 趋势, 人潮;vt. 流出, 流动, 展开;vi. 流, 涌, 飘扬; 流
permission|许可, 允许; 许可, 认可
electric|电的, 导电的, 电动的; 电的
sand|沙, 沙子, 沙滩, 光阴, 生涯;vt. 撒沙, 以沙掩盖
knife|小刀, 匕首;vt. 切割, 伤害, 切, 戳;vi. 劈开, 穿过
witness|证人, 目击者, 证据, 证词;vt. 目击, 作证, 证明, 表明;vi. 作证人, 作为证据
medicine|药, 医学, 内科;vt. 给...用药
hero|英雄, 超越常人者, 男主角
swing|摇摆, 振幅, 音律, 节奏, 涨落, 秋千, 旋转, 行动自由;vi. 摇摆, 悬挂, 旋转, 大摇大摆地走, 转向;vt. 挥舞, 使旋转, 使转向, 悬挂, 吊运;a. 旋转的, 悬挂的, 强节奏爵士音乐的
hearing|听, 听觉, 听讯; 听, 听觉
mail|邮件, 邮政, 邮递, 盔甲;vt. 邮寄, 给...穿盔甲; 邮件
birthday|生日
anger|忿怒;vt. 激怒, 使发怒;vi. 发怒
platform|站台, 月台, 讲台, 论坛, 平台; 平台
curtain|帐, 幕, 窗帘;vt. 装帘子于, 遮蔽
electronic|电子的; 电子工业协会接口
infection|传染, 影响, 传染病; 传染, 感染
presumably|推测上, 大概
genuine|真正的, 真实的, 诚恳的; 真性的
extreme|极端, 末端;a. 极端的, 尽头的, 极度的, 偏激的
rush|匆促, 冲进, 急流, 灯心草;vi. 冲, 奔, 闯, 赶紧, 匆促行事, 涌现;vt. 使冲, 匆忙地做, 突袭, 飞跃, 用灯心草做;a. 紧急的
priest|祭司, 牧师, 神父, 神质人员, 僧侣, 泰斗
joke|笑话, 玩笑, 笑柄;v. 开玩笑, 取笑, 作弄
relax|放松, 松懈, 松弛, 变从容, 休息, 休养;vt. 使松弛, 缓和, 使松懈, 使休息
salt|盐, 风趣, 刺激;a. 含盐的, 咸的, 风趣的, 辛辣的;vt. 加盐于, 用盐腌
drag|拖, 拖累;v. 拖累, 拖拉, 沉重缓慢地走, 拖动; 拖动
exciting|令人兴奋的, 刺激的; 激磁
clock|时钟, 计时器, (袜子上的)绣花边花;vt. 绣花样, 记时, 记录;vi. 记录时间; 时钟
written|书面的, 写成文字的;write的过去分词
cream|乳酪, 奶油, 面霜; 乳油, 乳皮; 乳膏, 霜
bath|沐浴, 浴室; 浴
advanced|在前的, 高级的, 先进的, 年老的; 预付的, 预支的, 垫付的
stupid|愚蠢的, 麻木的
oppose|反对, 以...对抗, 抗争;vi. 反对
pause|暂停, 中止, 停顿, 间歇, 踌躇, 休止符;vi. 暂停, 中止, 停顿, 踌躇; DOS内部命令:暂时停止批处理文件的执行
whenever|每当;adv. 不论何时, 每逢
opposite|相对的, 相反的, 对面的;prep. 对面;n. 对立面
altogether|完全地, 总而言之
truly|真实地, 不假
expose|使暴露, 使曝光, 揭穿, 陈列; 暴露, 露置
everywhere|各处, 到处
proud|骄傲的, 自大的, 自豪的, 辉煌的, 壮丽的
confident|有信心的, 有把握的
remark|评论, 注意;vt. 评论, 注意;vi. 评论, 谈论; 注释
compete|竞争, 对抗
sink|藏垢的场所, 沟渠, 污水槽;vi. 下沉, 沉没, 下陷, 减弱, 衰退, 消沉, 堕落, 渗透;vt. 使低落, 使下沉, 陷于, 投入(资金等), 挖掘
lecture|演讲, 谴责, 讲稿;vt. 演讲, 训诫, 说教;vi. 讲演
definitely|明确无疑地, 清楚地
mad|疯狂的, 发疯的, 生气的, 愚蠢的, 狂欢的;n. 狂怒
fishing|钓鱼, 鱼业;a. 钓鱼的
mount|乘骑用马, 框, 衬纸, 山;vi. 乘马, 爬上, 增长;vt. 爬上, 使上马, 装上, 装裱, 安放, 制作...的标本, 设置, 上演; 安装
luck|运气, 幸运, 好运, 侥幸;vi. 靠好运成功
formula|客套语, 公式, 准则; 公式
install|安装, 安置, 使就职; 安装, 安装程序; DOS内部命令:安装常驻程序
tail|尾部, 后部, 辫子, 随员, 特务, 燕尾服, 踪迹, 限定继承(权);a. 在后面的, 从后面而来的, 限定继承的, 尾部的, 后部的;vt. 为...装尾, 附于其后, 尾随, 使搭牢, 跟踪, 监视;vi. 跟踪…
anxiety|焦虑, 忧虑, 令人焦虑的事; 焦虑
whisper|耳语, 密谈, 谣传, 沙沙声;vi. 耳语, 密谈, 沙沙地响;vt. 低声说
fortune|财富, 运气, 兴隆, 大量财产, 好运, 命运; 命运, 财产, 大量财产
deserve|该得到, 值得;vi. 应得报答
barrier|障碍, 栅栏; 势垒; 阻片; 阻挡层
anxious|忧虑的, 发愁的, 渴望的
tip|顶, 尖端, 梢, 末端, 倾斜, 垃圾场, 小费, 轻击, 指点, 秘密消息;vt. 装顶端, 使倾斜, 使翻倒, 泄露, 告诫, 暗示, 给...小费, 轻击;vi. 倾斜, 翻倒, 倾覆, 踮脚走, 给小费; 终端…
nervous|神经紧张的, 不安的, 神经的; 神经的; 神经质的, 神经过敏的
conscious|有意识的, 知觉的, 觉察的; 有意识的, 清醒的
tackle|工具, 复滑车, 滑车, 装备, 扭倒;vt. 固定, 处理, 抓住;vi. 扭倒
symbol|符号, 象征, 代号, 信条; 符号; 码元
sweep|扫除, 打扫, 肃清, 视野, 范围, 全胜;vt. 扫除, 掸去, 猛拉, 扫荡, 肃清, 冲走, 刮起, 环视, 掠过, 扫射;vi. 扫, 打扫, 袭击, 席卷, 扫视, 掠过
satisfied|感到满意的
borrow|借, 借入, 借用;vi. 借; 借位; 借位数
climate|气候, 社会趋势, 气候区; 气候
moon|月亮, 月球, 月光;vi. 闲荡;vt. 虚度
basically|基本上, 主要地
heaven|天堂, 上帝, 天空
bury|埋葬, 埋藏
smell|味道, 气味, 嗅觉, 嗅, 臭味, 气息;vt. 闻, 探出, 察觉, 发出...的气味;vi. 嗅, 散发气味, 发臭
pitch|程度, 坡度, 顶点, 前倾, 倾斜, 投掷, 音高, 螺距, 节距, 摊位, 树脂, 沥青;vt. 投, 掷, 向前倾跌, 扎营, 竭力推销, 为...定调, 定位于, 用沥青涂;vi. 搭帐篷, 投掷, 向前跌, 猛…
alcohol|酒精, 酒; 醇; 乙醇; 酒精
crop|农作物, 产量, 平头;vt. 收割, 修剪, 种植;vi. 收获; 裁剪
capture|抓取, 战利品, 捕获之物;vt. 抓取, 获得, 迷住; 截获命令
awful|可怕的, 庄严的, 虔敬的
stomach|胃, 食欲, 欲望, 肚子;vt. 吃下, 忍受
opponent|对手, 敌手, 反对者;a. 敌对的, 反对的, 对面的
snow|雪, 积雪, 下雪, 雪花形干扰;vi. 下雪, 似雪般落下;vt. 使雪白, 用雪覆盖, 使像雪般落下
enthusiasm|巨大的热情, 热心
cease|停止;v. 停止, 终了
impressive|给人深刻印象的, 威严的
honest|诚实的, 坦直的, 可靠的
smooth|平滑的, 平稳的, 流畅的, 和蔼的, 安祥的, 圆滑的, 调匀的, 无毛的;vt. 使光滑, 烫平, 使平和, 消除;vi. 变平滑, 变平静;n. 一块平地, 平滑部分
remote|遥远的, 偏僻的, 疏远的, 微少的; 远程, 远程访问实用程序
qualify|取得资格, 有资格;vt. 使有资格, 使合格, 限定, 限制, 准予
shell|贝壳, 壳, 外形, 炮弹;vt. 去壳, 脱落, 炮轰;vi. 剥落, 脱壳; 外壳; DOS内部命令:指定命令行处理程序
tube|管, 软管, 隧道;vt. 把...装管, 使通过管子; 管子
transform|使转换, 改变, 改造, 使...变形;vi. 改变, 转化, 变换; 变换
pink|粉红色, 石竹花, 化身, 典范, 头面人物, 极度;a. 粉红的, 石竹科的, 比较激进的, 脸色发红的, 精致的, 有点下流的;vt. 刺, 扎, 刺痛, 射伤, 使面红耳赤, 使变粉红色;vi. 变粉红色
holy|神圣的, 圣洁的, 至善的;n. 神圣的东西
slide|滑, 滑道, 山崩, 雪崩, 幻灯片;vt. 使滑动, 偷偷放入;vi. 滑动, 滑落, 不知不觉陷入, 偷偷地走
bowl|碗, 木球, 大酒杯;v. 滚木球, 快而稳地行驶
dish|盘子, 碟, 菜肴; 皿, 碟
outstanding|杰出的, 突出的, 未偿付的, 未决定的; 未解决的, 未偿付
minimum|最小的, 最低的;n. 最小值; 最小值
cheese|乳酪; 干酪
related|讲述的, 叙述的;有关系的, 有关联的
complicated|复杂的; 并发的
alongside|在旁边, 靠拢着;prep. 在...旁边, 与...在一起
accurate|正确的, 精确的; 准确的, 精确的
pose|姿势, 姿态, 装模作样, 伪装;vi. 摆姿势, 装模作样, 假装;vt. 使摆好姿势, 提出, 造成
lend|借, 贷款给, 增添, 提供, 出租;vi. 贷款
proof|证据, 证明, 试验, 检验, 考验;a. 不能透入的, 证明用的, 防...的, 耐...的;vt. 检验, 试验, 校对, 使不被穿透; 审稿
wire|电线, 电报, 电信, 铁丝网, 金属丝;vt. 用金属丝捆扎, 拍电报;vi. 打电报
strain|紧张, 拉紧, 张力, 过劳, 扭伤, 血缘, 种, 族, 气质, 曲调, 旋律, 口吻;vt. 使劳累, 拉紧, 过分使用, 扭伤, 滥用, 曲解, 滤;vi. 尽力, 努力, 紧拉, 弯曲, 被滤出
salary|薪水;vt. 给...加薪
steam|蒸汽, 精力;a. 蒸汽的;vi. 蒸发, 行驶, 发怒;vt. 蒸, 煮, 散发
extraordinary|非常的, 特别的, 非凡的; 非常的, 特别的, 临时的
visible|看得见的, 明显的, 显然的;n. 可见物
plain|平原, 草原, 朴实无华的东西, 无格式;a. 简单的, 明白的, 平常的, 不好看的, 朴素的, 清晰的, 普通的, 平坦的, 十足的;adv. 清楚地, 显然地; 无格式
shopping|买东西, 购物; 购物, 买东西
label|标签, 称号, 商标, 标志;vt. 贴标签于, 标注; 标志; 标注; DOS外部命令:用于建立改变或删除磁盘卷标号
lover|爱人, 爱好者
tunnel|隧道, 地下道;vi. 挖隧道;vt. 掘隧道于
musical|音乐片, 音乐舞台剧;a. 音乐的, 声音美妙的, 喜爱音乐的
poetry|诗, 韵文, 诗歌艺术
grab|抓握, 掠夺, 强占, 东方沿岸帆船;vi. 抓取, 抢去;vt. 攫取, 捕获, 霸占
gentle|温和的, 文雅的
scream|尖叫声;vi. 尖叫, 大笑, 尖啸, 令人震惊;vt. 尖叫着说, 大叫大嚷着要求
pot|盆, 罐, 壶, 坩埚, 奖杯;vt. 装入盆中, 在锅中煮, 随手射击;vi. 随手射击
ultimately|最后, 最终; 最后, 终究, 总之
breast|胸部, 乳房, 胸怀;vt. 以胸对着, 面对
tight|紧的, 密封的, 吝啬的, 严厉的;adv. 紧紧地
violent|暴力的, 猛烈的, 激烈的, 极端的, 凶暴的
sensible|有感觉的, 敏感的, 明智的; 可感觉的
dig|挖, 翻土, 发掘;vi. 挖掘;n. 挖掘; 数字, 数位
adjust|调整, 使适应于, 校准;vi. 适应于, 被调节, 相互熟悉而适应
mystery|秘密, 神秘, 奥秘
vegetable|蔬菜, 植物, 无精打采之人;a. 蔬菜的, 植物的
reward|报酬, 酬谢, 赏金;vt. 奖赏, 酬谢, 给...应有报应
junior|年少者, 地位较低者, 大学三年级学生;a. 年少的, 下级的, 后进的
bathroom|浴室, 厕所
grade|等级, 年级, 阶段, 成绩, 程度, 坡度, 斜坡;vt. 分等, 分级, 评分;vi. 属于某等级, 逐渐变化
consult|商讨, 商量, 协商, 会诊;vt. 向...请教, 查阅, 考虑
comfort|舒适, 安慰, 安慰者;vt. 安慰
imagination|想像, 听觉, 想像力; 想像
bell|铃, 钟; 响铃命令
draft|气流, 草稿, 汇票, 草案;vt. 起草, 征兵; 草稿
till|直到, 在...以前, 迄;conj. 直到...为止;vt. 耕种;n. 放钱的抽屉, 备用现金, 冰碛
inevitable|不可避免的, 必然的; 不可避免的, 无法规避的, 必然的
outline|大纲, 轮廓, 概要;vt. 描画轮廓, 描述要点;n. 大纲, 分级, 轮廓; 大纲, 分级, 轮廓
highlight|加亮区, 精彩场面;vt. 加亮, 使显著, 以强光照射, 突出; 突出
personally|亲自地, 个别地, 当面, 就本人而言, 针对个人地
trace|痕迹, 踪迹, 微量, 迹线, 缰绳;vt. 追踪, 回溯, 描绘;vi. 追溯, 沿路走
newly|重新, 最近
belt|带子, 地带; 带, 腰带, 束带, 地带, 区
storm|暴风雨, 骚动, 风波, 风暴, 猛攻;vi. 起风, 猛冲, 怒吼;vt. 猛攻
rid|免除, 以...清除, 使获自由, 使摆脱; 免除, 清除, 摆脱
dirty|肮脏的, 卑鄙的;vt. 弄脏;vi. 变脏
assistant|助手, 助理, 助教;a. 有帮助的, 辅助的, 助理的
sail|帆, 篷, 帆船, 航程, 帆状物;vi. 航行, 启航, 张帆而行;vt. 航行于, 驾船
pride|骄傲, 自尊心, 自豪, 精华, 勇气;vt. 以...自豪
pleasant|愉快的, 可爱的, 活泼的, 亲切的
joy|欢喜, 乐事, 高兴;vt. 使快乐, 令人高兴;vi. 欢喜
twin|双胞胎中一人, 一对非常相像的人(或物)中的一个;a. 双胞胎的, 成对的, 孪生的;vi. 生双胞胎, 成对;vt. 怀(双胞胎), 使成对
entitle|给...权利, 取名为, 给予名称, 叫做; 给...权利, 使有资格, 称呼
venture|冒险, 风险;vt. 敢于, 冒...的危险;vi. 冒险
encounter|相会, 相遇, 遭遇;vt. 遇见, 邂逅, 会战;vi. 偶然相遇
universe|宇宙, 星系, (思想等)范围
steady|稳定的, 不动摇的, 沉着的, 稳固的, 坚定的, 经常的;vt. 使稳定, 使坚定;vi. 变为沉着, 稳固
react|起反应, 起作用, 反攻; 应答, 发生反应
loose|发射, 放任, 放纵;a. 宽松的, 松的, 宽的, 不牢固的, 散漫的, 自由的, 不精确的;vt. 释放, 放枪, 开船;vi. 变松, 开火;adv. 松散地
blind|蒙蔽物, 窗帘;a. 盲目的, 瞎的, 不加思考的;vt. 使失明, 蒙蔽, 遮暗;adv. 盲目地
dust|灰尘, 尘埃, 粉末, 花粉, 土, 骚乱;vt. 拂去灰尘, 撒, 弄成粉末;vi. 拂去灰尘, 化为粉末
diary|日记; 日记簿
desperate|不顾一切的, 危急的, 令人绝望的, 极渴望的
horror|惊骇, 恐怖, 惨状; 恐怖, 恐惧
delighted|高兴的, 快乐的
repair|修理, 补救, 修复;vt. 修理, 修补, 补救, 恢复, 补偿;vi. 修理, 修补, 补救, 恢复, 去, 常去, 集合
concert|音乐会, 和声, 一致;vt. 协力, 协调;vi. 协力; 美国北卡罗来纳州Internet网
cow|母牛, 母兽;vt. 威胁
Pole|波兰人, 极点, 磁极, 电极, 杆, 竿, 相反的极端;vt. 用竿支撑;vi. 撑篙
cap|盖子, 帽子;vt. 戴帽子, 覆盖, 胜过;vi. 脱帽致意; 调用程序分析, 容量, 代码分析程序, 计算机辅助生产, 计算机辅助印刷
chart|图表, 海图;vt. 制成图表; 图表
leather|皮革, 皮制品, 马镫的皮带;vt. 覆以皮革, 鞭苔, 抽打;a. 皮革的, 皮制的
button|钮扣, 按钮;vi. 扣住;vt. 钉钮扣于, 扣紧; 按钮
raw|擦伤处, 半成品;a. 生的, 未加工的, 生疏的, 不成熟的, 阴冷的, 刺痛的, 擦掉皮的;vt. 擦伤; 写后读
lost|失去的, 遗失的, 迷惑的;lose的过去式和过去分词
ultimate|终极, 根本, 顶点, 基本原则;a. 终极的, 根本的, 极限的, 最远的, 最后的, 最大的
publicity|名声, 宣传, 公开场合; 宣传, 广告
alarm|惊恐, 警报, 警钟;vt. 使惊恐, 警告; 报警信号
nerve|精神, 勇气, 叶脉, 神经;vt. 鼓起勇气
communicate|显露, 传达, 感染;vi. 通讯
stir|骚动, 轰动, 搅动, 监狱;vt. 移动, 摇动, 激起, 惹起, 搅拌;vi. 走动, 传播, 搅拌
burst|破裂, 突发, 爆发;v. 爆裂, 突发, 充满; 二进制位组; 字符组; 脉冲串
potato|马铃薯
ocean|海洋, 广阔, 许多, 一大片; 海洋, 海
traveller|旅行者; 旅行商
pen|钢笔, 笔, 笔调, 笔杆子, 作家, 围栏, 栅栏, 禽畜;vt. 写, 关入栏中, 囚禁;vi. 动笔, 写作
craft|技艺, 手艺, 诡计;vt. 精心制作
clever|聪明的, 精明的
van|货车, 篷车, 先锋, 前驱, 前卫;vt. 用货车搬运; 增值网
chicken|小鸡, 鸡肉
cable|电缆, 海底电报, 缆, 索;vi. 打海底电报;vt. 发海底电报, 缚住; 电缆
swim|游泳, 漂浮, 潮流, 眩晕;vi. 游泳, 游, 漂浮, 浸, 覆盖, 充溢, 大量拥有, 旋转, 眩晕;vt. 游过, 使浮起
govern|统治, 支配, 管理
equivalent|同等物, 等价物, 相等物;a. 相等的, 相当的, 同意义的; 等价的
mate|配偶, 对手, 助手, (象棋)将死;vt. 使配对, 使一致, 结伴, (象棋)将死;vi. 成配偶, 紧密配合
wise|明智的, 慎虑的, 聪明的, 博学的, 狡猾的, 机灵的;vi. 知道;vt. 教导, 告诉, 劝导;n. 方法, 方式; 教育信息系统
weigh|称...重量, 衡量, 把...压弯, 考虑, 权衡, 起锚;vi. 称分量, 有意义, 重压, 起锚;n. 过秤, 称分量
sympathy|同情, 赞同, 怜悯, 慰问, 吊唁; 交感;, 同感;, 感应, 同情
strip|长条, 条状, 带, 脱衣舞;vt. 脱衣, 被剥去, 剥夺, 拆卸;vi. 脱衣服
strict|严厉的, 绝对的, 详尽的, 严格的, 精确的; 严格的, 精确的, 绝对的
friendship|友谊, 友爱, 友善
ease|安乐, 安逸, 悠闲;vt. 使安乐, 使安心, 减轻, 放松;vi. 减轻, 放松, 灵活地移动
bitter|苦的, 痛苦的, 怀恨的;adv. 刺骨;v. (使)变苦
plot|小块土地, 地区图, 图, 阴谋, 情节;vt. 划分, 绘图, 密谋;vi. 密谋, 策划; 绘制
illegal|违法的, 不合规定的; 非法的, 犯规的
confront|使面对, 对抗, 遭遇, 使对质, 比较; 对证, 使对质, 比较
nowhere|无处, 到处都无
planet|行星, 命运星辰, 杰出的人, 重大影响的事
wrap|外套, 围巾, 包裹物, 限制, 约束, 秘密, 换行;vt. 包装, 卷, 缠绕, 包, 裹, 覆盖, 遮蔽, 隐藏, 掩护;vi. 缠绕, 穿外衣, 包起来; 换行
chocolate|巧克力;a. 巧克力制的
discount|折扣, 贴现率;vt. 打折扣;vi. 贴现
bound|跃, 回跳, 范围, 边界;a. 受约束的, 装有封面的, 有义务的, 关联的, 被束缚的, 准备去...的, 便秘的;vi. 跳跃, 弹起;vt. 使跳, 限制, 形成...的疆界;bind过去式和过去分词; 装订的
reverse|相反, 背面, 倒退, 挫折, 失败;a. 反面的, 相反的, 反向的, 颠倒的;vt. 使颠倒, 使逆转, 使倒退, 使反向;vi. 倒退, 反向, 倒转, 反转; 反转
invitation|邀请, 请柬, 引诱; 邀请, 招待, 吸引
generous|慷慨的, 有雅量的, 大量的, 丰富的
trick|诡计, 欺诈, 谋略, 恶作剧, 习惯, 决窍;vt. 愚弄, 欺骗, 装饰;vi. 哄骗, 戏弄;a. 有决窍的, 特技的, 欺诈的, 漂亮的, 靠不住的
excuse|原谅, 申辩, 做为...的托辞;n. 致歉, 理由, 饶恕, 借口
cancel|取消, 撤消, 盖销(邮票);vt. 取消, 删去, 抵销, 盖销;vi. 相互抵销; 作废
automatic|自动手枪, 自动机械;a. 自动的, 机械的, 必然的, 无意识的
ambition|野心, 志向
weekly|周刊, 周报;a. 每周的, 一周一次的, 周刊的;adv. 每周, 一周一次
entertainment|娱乐, 款待, 娱乐表演
harm|伤害, 害处;vt. 伤害, 损害
resort|度假胜地, 手段, 凭借, 常去之地;vi. 诉诸, 常去
convince|说服, 使相信; 使确信, 使信服, 使人认识错误
shade|荫, 阴暗, 遮光物, 灯罩, 帘, 浓淡, 微量, 底纹;vi. 渐变;vt. 使阴暗, 使渐变, 遮蔽, 微减; 底纹
loud|大声的, 不断的, 喧吵的;adv. 高声地, 大声地
dare|挑战, 挑动, 大胆;v. 敢, 胆敢
mayor|市长; 市长
suspicion|怀疑, 觉察, 嫌疑; 怀疑, 疑心, 嫌疑
prompt|激励, 提示, 提醒物, 提词, 付款期限;a. 迅速的, 敏捷的, 立刻的, 提词员的;vt. 激励, 鼓动, 提示;adv. 准时地; 提示符; DOS内部命令:设定DOS命令行的提示符
humour|幽默, 诙谐, 情绪, 体液;vt. 使满足, 迁就
cotton|棉花;vi. 和谐, 有好感, 理解
grain|谷粒, 颗粒, 谷类, 纹理, 本质;v. (使)成谷粒
pop|砰然声, 枪击, 含气饮料, 流行音乐, 通俗艺术;a. 流行的, 热门的, 通俗的;vt. 使发出爆裂声, 开枪打, 突然伸出;vi. 发出爆裂声, 射击, 突然出现, 瞪大;adv. 突然, 砰地; 出现点, 邮局协…
pile|堆, 大堆, 大厦, 建筑群, 电池, 大量, 桥桩, 软毛, 痔疮;vi. 堆起, 堆积, 积累, 挤, 猛烈攻击;vt. 堆于, 累积, 堆叠, 打桩于, 用桩支撑
spiritual|精神上的, 神圣的, 崇高的, 高尚的, 鬼的, 招魂术的;n. 有关教会的事
bet|打赌, 赌注;v. 打赌
urgent|紧急的, 急迫的, 催逼的; 紧急的, 急迫的
pregnant|怀孕的, 充满的, 思想丰富的, 成果丰硕的; 妊娠的, 有孕的
admire|赞美, 钦佩, 爱慕;vi. 称赞, 惊奇
explosion|爆发, 激增, 爆炸(声); 爆炸
tap|轻打, 水龙头;vt. 轻打, 轻敲, 敲打出, 选择, 装上嘴子, 使流出, 开发, 分接, 向...乞讨;vi. 轻叩, 轻拍, 啪塔啪塔地走; 接头
curious|好奇的, 求知的, 古怪的
fence|围墙, 栅栏, 买卖赃物的人, 剑术;vt. 用篱笆围住, 练习剑术, 防护;vi. 击剑, 搪塞
interior|内部, 内政;a. 内部的, 心灵的, 内地的, 内政的
ceremony|典礼, 仪式, 礼节; 典礼, 仪式
cinema|电影院, 电影
nearby|附近的, 近旁的;adv. 在附近, 近旁地;prep. 在...附近
publishing|出版, 刊印, 发行
unexpected|料想不到的, 突然的, 意外的; 不能预料的, 意外的
disappointed|失望的
clothing|衣服
trap|圈套, 陷阱, 诡计, 存水弯;vi. 设圈套, 设陷阱;vt. 诱捕, 诱骗, 抓住, 使受限制; 俘获; 陷井
navy|海军, 海军人员, 海军军力, 烟蒂
chase|追求, 狩猎, 追逐;vt. 追捕, 追逐, 雕刻, 在...上镶嵌宝石;vi. 追赶, 奔跑
celebration|庆祝, 庆典
spell|符咒, 魅力, 轮值, 轮班, 工作时间, 一次发作;vt. 拼写, 拼成, 琢磨, 理解, 招致, 轮换, 迷住;vi. 轮换, 拼字
brand|商标, 牌子, 烙印;vt. 打烙印于
squeeze|紧握, 挤, 榨, 榨取, 佣金;vt. 紧握, 挤, 榨取;vi. 压榨, 榨
gear|齿轮, 工具;vt. 以齿轮连起, 开动, 使适应, 安排;vi. 连接上, 适合
delight|高兴, 愉快;vt. 使高兴, 乐于;vi. 感到高兴(或愉快、快乐)
butter|奶油, 黄油;vt. 涂黄油于
toy|玩具, 小玩艺儿, 小型的东西, 消遣;a. 供玩耍的, 作为玩具的;vi. 玩弄, 戏弄, 调情
brush|刷子, 毛笔, 争吵;vt. 刷;vi. 擦过, 掠过; 电刷
rhythm|旋律, 节奏, 韵律, 匀称, 张弛节律; 节律
innocent|无罪的, 不懂事的, 无知的;n. 天真的人, 笨蛋
desert|沙漠, 应得的赏罚, 功劳;a. 沙漠的, 不毛的;vt. 放弃, 遗弃, 擅离;vi. 逃掉
romantic|浪漫的, 风流的, 传奇性的, 夸大的, 空想的, 浪漫派的
mess|食堂, 伙食, 用膳, 一份食品, 混乱, 乱七八糟, 困境;vt. 将...弄糟, 妨碍, 使紊乱, 使就餐;vi. 陷入困境, 搞乱, 用膳
anniversary|周年纪念
hire|租金, 租用, 雇用;vt. 雇请, 出租;vi. 受雇
counter|计算器, 计算者, 柜台, 筹码;a. 反方向的, 相反的;adv. 反方向地, 相反地; 计数器; 计数字
rumour|谣言, 传闻;vt. 谣传
mixed|混合的, 形形色色的, 弄糊涂的; 混合的
float|漂流物, 浮舟, 漂浮, 浮萍, 彩车;vi. 浮动, 飘动, 散播, 摇摆, 动摇, 浮动;vt. 使漂浮, 容纳, 淹没, 发行, 实行; 浮动
flag|标志, 旗标, 旗子, 信号旗, 菖蒲;vt. 悬旗, 打旗号, 铺石板;vi. 无力地下垂; 标志; 属性标记命令
uniform|制服;a. 统一的, 一律的, 始终如一的
superior|长者, 占优势的人, 上级;a. 上级的, 出众的, 高傲的
freeze|冻结, 冷冻, 僵硬, 楞住;vt. 使结冰, 使冻住, 使呆住;n. 结冰, 凝固; 冻结
businessman|商人, 实业家, 工商业家
singer|歌手
virus|病毒, 滤过性病毒, 毒害; 病毒
emphasize|强调, 加强语气, 着重
spare|剩余, 备用品, 备件, 备用零件, 备用轮胎;a. 多余的, 备用的, 空闲的, 节约的, 瘦的;vi. 节约, 省掉, 宽恕;vt. 节约, 省用, 剩下, 饶恕, 赦免
coloured|有色的, 有...色的, 经过渲染的, 有色彩的, 伪装的, 有色人种的, 混血种的;n. 有色人种的人, 混血人; 着色的
stroke|笔划, 打, 中风, 抚, 摩, 冲程;vt. 划尾桨, 抚, 摩, 划去; 笔划
intelligent|聪明的, 智能的, 了解的
unhappy|不快乐的, 不幸的, 不适当的
unfair|不公平的, 不正直的, 不正当的; 不正直的, 不公平的, 偏颇的
continent|大陆, 洲;a. 自制的
grave|墓穴, 坟墓, 终结, 死亡;a. 庄重的, 严肃的, 重大的, 低沉的;vt. 雕刻
truck|卡车, 货车, 对...进行交易, 来往, 实物工资, (供应市场的)蔬菜, 废物, 废话;vt. 对...进行交易, 交往, 以卡车运输;vi. 驾驶卡车, 以物易物
midnight|午夜, 子夜, 半夜;a. 午夜的, 半夜的
painful|痛苦的, 困难的, 令人烦恼的; 疼痛的
courage|勇气, 胆量
aggressive|侵略的, 挑畔的, 进取的; 侵略的, 爱挑衅的, 行为过火的
amazing|令人惊异的
shame|羞耻, 羞愧, 耻辱;vt. 使羞愧, 侮辱
twist|一扭, 扭曲, 曲折, 歪曲, 螺旋状, 新手法;vt. 拧, 扭, 捻, 编织, 使扭转, 缠绕, 盘绕, 歪曲, 使转动, 使苦恼, 使混乱, 使旋转;vi. 转向, 弯曲, 缠绕, 扭动, 呈螺旋形
hip|臀部, 蔷薇果, 忧郁;a. 熟悉内情的;vt. 使忧郁, 给(屋顶)造屋脊;interj. 喝彩声
pet|宠物, 受宠爱的人, 宠坏的孩子, 不悦, 生气;a. 宠爱的, 表示亲昵的, 养着观赏的, 特别珍爱的, 格外的;vt. 宠爱, 溺爱, 抚摸;vi. 拥抱, 爱抚, 生气, 发脾气
musician|音乐家, 乐师, 作曲家
apartment|房间, 公寓
breed|种类, 品种;v. 养育, 引起, 饲养, 繁殖
juice|汁, 活力, 体液;vt. 挤出汁来, 加汁
tune|歌曲, 主旋律, 心情, 声调, 和谐, 一致, 语调, 程度;vt. 为...调音, 调整, 调谐, 使一致;vi. 协调, 调谐
regret|遗憾, 后悔, 悔恨, 抱歉, 歉意;vt. 为...感到遗憾, 后悔, 惋惜, 懊悔, 抱歉;vi. 感到抱歉
mild|温和的, 温柔的, 淡味的, 适度的, 轻微的, (肥皂等)软性的; 轻的, 缓和的
upset|弄翻的, 混乱的, 心烦的;vt. 弄翻, 颠覆, 推翻, 打乱, 使不适, 使心烦;vi. 翻倒
giant|巨人, 大力士, 巨大怪物;a. 庞大的, 巨大的
brave|勇敢的, 美好的, 华丽的;n. 勇敢者;vt. 勇敢地面对
neat|整洁的, 巧妙的, 匀称的, 简洁的;n. 牛
elegant|优雅的, 端庄的, 高雅的
crazy|发狂的, 狂热的
concrete|凝结物, 混凝土;a. 具体的, 实在的, 混凝土的;v. (使)凝结, 用混凝土浇筑
spin|旋转, 自旋, 疾驰, 情绪低落;vt. 纺织, 纺, 使旋转, 编造;vi. 纺纱, 吐丝, 作茧, 结网, 旋转, 自旋, 疾驰
lonely|孤单的, 孤寂的, 荒凉的
ingredient|成分, 因素; 配合剂; 拼料; 成分; 组分
divorce|离婚;vt. 与...离婚
rescue|援救, 解救, 营救;vt. 援救, 救出, 营救
contest|竞赛, 争论;vt. 竞争, 争取, 争辩;vi. 竞争
stamp|印, 邮票, 打印器, 戳子, 图章, 印花税票, 标志, 特征, 类型, 跺脚;vt. 盖章于, 顿足, 贴上邮票, 铭刻, 捣碎, 扑灭;vi. 捣碎, 跺脚
striking|醒目的, 惊人的, 打击的, 罢工的; 罢工的, 罢市的, 罢课的
explode|爆炸, 爆发, 激增;vt. 使爆炸
ton|吨; 吨
peaceful|平静的, 和平的, 和平时期的, 爱好和平的, 喜爱安静的; 和平的, 爱好和平的, 和平时期的
magic|魔术, 魔法;a. 魔术的, 有魔力的, 不可思议的
decorate|装饰
orange|柑橘, 桔子, 橘色;a. 橘色的
flavour|味, 调味香料, 滋味, 香味, 气味, 风味, 情味, 情趣, 风韵;vt. 给...调味, 给...增添风趣, 加香料, 加味于
fold|折层, 折, 羊栏, 折痕, 信徒;vt. 折叠, 包, 合拢, 交迭;vi. 折叠起来, 彻底失败; 折叠; 合并
forecast|预想, 预测, 预报;vt. 预想, 预测, 预报; 趋势预测
rider|骑手, (文件后的)附件, 扶手; 游码
flash|闪光, 闪现, 一瞬间;vi. 闪光, 闪现, 反射;vt. 使闪光, 反射
criticize|批评, 吹毛求疵, 非难
bye|再会, 回头见; 结束命令
impress|印象, 特征, 印记;vt. 使有印象, 印, 铭刻, 传送, 影响, 强征;vi. 给人印象
shelter|庇护所, 避难所, 庇护, 隐蔽处, 掩蔽;vt. 庇护, 保护, 隐匿;vi. 躲避
advertise|做广告, 通知, 公布;vi. 做广告
determined|坚决的, 已下决心的
smart|聪明的, 漂亮的, 刺痛的, 剧烈的, 敏捷的, 巧妙的, 伶俐的, 潇洒的;n. 刺痛, 痛苦;vi. 刺痛
flood|洪水, 大量之水, 涨潮;vt. 淹没, 使泛滥, 注满;vi. 被淹, 溢出, 涌进
evil|邪恶, 不幸, 罪恶;a. 邪恶的, 不幸的, 有害的, 讨厌的
cooking|烹饪; 熬炼; 热炼; 蒸煮
rice|米, 米饭, 稻;vt. 将...压成米粒状
dump|垃圾场;vt. 倾倒, 倾销;vi. 倒垃圾, 倾销商品; 转出; 转储; 倾卸; 切断电源
killing|谋杀, 杀戮;a. 杀害的, 疲惫的, 迷人的
drum|鼓, 鼓声;vi. 击鼓, 作鼓声;vt. 打鼓奏出; 磁鼓
comedy|喜剧, 有趣的事情
sauce|酱油, 调味汁, 酱;vt. 给...调味, 使增加趣味
missing|不见的, 缺少的; 行踪不明的, 失踪的, 遗失的
praise|赞美, 称赞, 崇拜;vt. 称赞, 赞美;vi. 赞扬, 表扬
penny|便士, 一分, 小钱, 点滴; 便士
pan|平锅, 浅盘, 盆地, 硬土层, 拍摄全景;v. 上下左右移动, 摇镜头, 淘洗, 淘金
hunt|狩猎, 追捕, 搜寻, 猎区;vt. 狩猎, 打猎, 搜索;vi. 打猎, 猎食, 搜寻
qualified|有资格的; 合格的, 有条件的, 有限制的
hook|钩, 钩状, 镰刀, 陷阱;vt. 挂...于钩上, 钩住, 引上钩, 偷窃;vi. 弯成钩状, 钩紧; 钩
slice|薄的切片, 一部分, 菜刀;vt. 切成薄片, 切下;vi. 切; 片
smash|打碎, 粉碎, 打碎时哗啦声, 猛击, 扣球, 杀球, 经营失败, 破产, 硬币, 假硬币;a. 非常轰动的, 了不起的;vt. 打碎, 粉碎, 击溃, 使破产, 使裂变, 使用假硬币;vi. 碎裂, 猛撞, 破产, 扣…
runner|跑步者, 赛跑者, 送信人, 走私船, 操作者, 滑槽; 碾碎机; 压碎机
mobile|移动的, 易变的, 机动的;n. 活动物体
calm|平稳, 风平浪静;a. 平静的, 冷静的;vi. 平静下来, 镇静;vt. 使平静
entertain|娱乐, 招待, 怀抱;vi. 款待
bunch|串, 束; 骨肿块(马)
manufacture|产品, 制造;vt. 制造, 假造;vi. 制造
rear|后面, 背后, 后方;a. 后面的, 背面的, 后方的;vt. 养育, 培养, 饲养, 举起, 树立, 栽种;vi. 高耸, 暴跳
pin|大头针, 针, 别针, 栓, 销子, 图钉, 插头, 管脚, 品(液量单位);vt. 将...用针别住, 钉住, 压住, 牵制, 使不能动, 归罪于;a. 针的, 销子的, 闩的
substitute|代理, 代理人, 代用品, 代替者, 代替物;vt. 代替;vi. 替代, 取代, 代用;a. 代替的, 代用的, 代用品的; 置换; 替代
kilometre|公里, 千米
allied|联盟的, 联姻的, 联系起来的
behalf|利益, 方面
sack|麻布袋, 洗劫;vt. 把...装入袋, 洗劫
deliberate|深思熟虑的, 故意的, 从容的;v. 仔细考虑
chat|闲谈;vi. 闲谈, 聊天
bargain|交易, 买卖协定, 特价商品;v. 讲价, 交易
boil|煮沸, 沸腾, 疖;v. 煮沸, 激动
pill|药丸, 弹丸, 屈辱, 胡说;v. 做成药丸, 形成丸状, 服药丸, 挫败, 抢劫
prior|更重要的, 较早的, 在先的;n. 小隐修院院长, 大隐修院副院长
broadcast|广播, 传播;a. 广播的;v. 广播;adv. 经广播, 四散地; 广播命令, 广播
cure|治疗, 治愈, 治疗法;vt. 治疗, 治愈, 改正, 腌制, 加工处理, 使硫化;vi. 受治疗, 被加工处理, 被硫化
thorough|十分的, 彻底的
underground|地下, 地铁, 地道, 秘密活动;a. 地下的, 秘密的;adv. 在地下, 秘密地
punch|打洞器, 钻孔机, 冲压机, 冲床, 潘趣酒;vt. 以拳重击, 开洞, 冲压;vi. 用拳猛击
gradual|逐渐的, 渐增的;n. 弥撒升阶圣歌
injured|受伤的, 受损害的, 被触怒的; 受害的, 被害的
ruin|毁灭, 推翻, 废墟;vi. 毁灭, 衰败, 破坏, 破产, 堕落;vt. 使毁灭, 毁坏, 使破产
pepper|胡椒粉, 胡椒, 辣椒; 胡椒; 辣椒; 花椒
winning|胜利, 获得, 成功, 赢得物;a. 得胜的, 胜利的
spray|水沫, 浪花, 水花, 喷雾, 喷雾器, 小树枝;vt. 喷雾, 扫射, 喷射;vi. 喷, 溅开
chop|肋条肉, 排骨, 砍, 戳记, 商标;vt. 剁碎, 砍, 切击, 割断;vi. 砍, 突然转向
cough|咳嗽;vi. 咳嗽;vt. 咳出
bore|令人讨厌的人, 激浪, 枪膛, 孔;vt. 使烦扰, 钻孔;vi. 钻孔;bear的过去式; 内径; 孔径
offensive|令人不快的, 侮辱的, 攻击性的; 攻击的, 进攻的, 冒犯的
bake|烘焙, 烤;vi. 烤面包;n. 烘焙, 烤
infect|传染, 感染; 传染, 感染
hi|喂
senator|参议员, (某些大学的)理事; 参议员, 上议员
heal|痊愈;vt. 使复原, 使和解, 治愈
attorney|代理人, 律师; 律师, 代理人
racing|赛马, 赛车; 空转, 急转
shaped|成某种形状的, 制成一定形状的, 有某种形状的, 合适的, 计划好的, 有目标的; 具形的, 形似的
fry|油炸食物, 鱼苗;v. 油炸, 煎
organized|有组织的, 组织起来的
abandoned|被抛弃的, 无约束的, 恣意放荡的
threatening|胁迫的, 危险的; 威胁的, 恐吓的, 危险的
gamble|赌博, 冒险;v. 赌博, 孤注一掷
spite|恶意, 怨恨, 使人烦恼的事物;vt. 故意刁难, 欺侮
CD|镭射碟, 镭射唱片; 光盘, 压缩盘, 载波检测, DOS内部命令:显示或改变当前目录
in|在...期间, 在...之内, 处于...之中, 从事于, 按照, 穿着;adv. 进入, 朝里, 在里面, 在屋里;a. 在里面的, 在朝的;n. 执政者, 交情
can|装罐;n. 罐头, 容器;aux. 能, 可以; 作废字符
up|向上的, 起床的, 涨的;adv. 向上, 上涨;prep. 在...上面, 向...的较高处
well|井, 泉水, 源泉, 好;v. 涌出;a. 健康的, 良好的, 适宜的, 恰当的;adv. 很好地, 适当地, 好意地, 很, 完全;interj. 好啦
down|向下的;adv. 下, 下去, 降下;prep. 往下, 沿着;n. 丘陵, 软毛, 开阔的高地; 向下, 退下命令
last|最后的, 末尾的, 最近的;vi. 持续, 支持, 维持;vt. 使维持, 够...用;adv. 最后, 后来;n. 最后, 末尾, 鞋楦头
mean|低劣的, 卑贱的, 简陋的, 吝啬的, 惭愧的, 平均的, 中间的, 普通的;vt. 意谓, 想要, 意欲, 预定;vi. 用意, 有意义;n. 平均数, 中间, 中庸
case|情形, 情况, 箱, 容器, 事实, 病例, 案例, 框子;vt. 装箱, 包盖
place|地方, 地点, 位置, 住所, 座位, 地位, 处境, 特权, 空间, 余地, 职务, 位;vt. 放置, 寄予, 认出, 评定, 任命;vi. 名次列前
long|长的, 长久的, 冗长的, 做多头的;vi. 渴望, 热望, 极想;adv. 长久, 始终;n. 长时间, 长信号, 长整型; 长, 长整型
court|法院, 庭院, 奉承;vt. 献殷勤, 追求, 招致;vi. 求爱
lead|铅, 铅条, 领导, 超前量, 领引, 榜样, 主角, 导线;vt. 引导, 带领, 领导, 指挥, 致使, 加铅于, 用铅包;vi. 领导, 带头, 导致, 用测深锤测深, 被铅覆盖;a. 带头的, 最重要的
kind|种类, 性质, 方式;a. 亲切的, 仁慈的, 和蔼的
short|短的, 近的, 矮的, 短期的, 简短的, 少量的;adv. 简短地, 突然;n. 扼要, 短片, 缺乏;vt. 故意少给, 使短路
foreign|外国的, 外交的, 外省的, 外来的, 不相关的; 外来的
present|现在, 礼品, 瞄准;a. 现在的, 出席的;vt. 介绍, 引见, 赠送, 提出, 呈现, 上演;vi. 举枪瞄准
fire|火, 炉火, 电炉, 火灾, 闪光体, 炮火, 热情;vt. 点燃, 烧制, 使发光, 激动, 放枪, 解雇;vi. 着火, 烧火, 开枪, 射击, 激动
round|圆, 圆形物, 巡回, 循环, 一轮, 一回合, 一局, 范围, 轮唱;a. 圆的, 球形的, 丰满的, 肥胖的, 完全的, 大概的, 完美的, 圆润的;prep. 围着, 附近, 绕过, 在...周围;adv. 围绕着…
sound|声音, 语音, 吵闹, 声调, 听力范围, 探条, 海峡;a. 健全的, 可靠的, 合理的, 健康的, 彻底的, 资金充实的;adv. 彻底地, 充分地;vi. 发出声音, 回响, 测深, 试探, 听起来;vt. 使发声…
sun|太阳, 日, 日光, 阳光;vt. 晒;vi. 晒太阳
post|柱, 杆, 准星, 邮件, 邮政, 标竿, 职位, 岗位, 哨所, 兵营;vt. 张帖, 邮递, 公布, 登入帐, 使熟悉, 布置;vi. 快速行进;adv. 急速地; 记入; 登记, 上电自检
fit|适宜, 合身, 发作, 痉挛;a. 适宜的, 对的, 准备好的;vt. 适合, 安装, 使合身, 使适应, 使合格;vi. 适合, 符合, 合身; 非特
consideration|考虑, 原因; 考虑, 思考, 报酬
content|内容, 满足, 意义, 要旨;a. 满足的, 满意的;vt. 使...满足, 使...安心; 内容
estate|不动产, (人生的)阶段, 阶层, 财产; 房地产, 遗产, 财产
cross|十字架, 十字架形物件, 交叉, 十字标, 交叉路, 磨难, 杂交;a. 生气的, 交叉的, 相反的;v. 交叉, 横过, 越过; 交叉, 十字标
commitment|委托, 交押, 承担义务, 赞助; 院禁
introduction|介绍, 传入, 采用, 初步
row|排, 行, 街道, 划船, 吵闹;vt. 使成排, 划, 划船, 参加(赛船), 痛骂;vi. 划船, 划动, 争吵; 行
instruction|指令, 教导, 命令; 指令
congress|国会, 会议, 讨论会; 会议, 会合
interpretation|解释, 演出, 翻译; 插值; 插值法; 解释
variation|变更, 变化, 变种, 变奏; 变异, 变易; 变度
derive|得自;vi. 起源
criterion|标准, 准则, 规范; 判据
effectively|有效地, 有力地, 实际上
observation|观察, 注意, 观测, 观察力; 观察
drawing|图画, 制图, 拉; 绘图
hence|因此, 从此
exclude|除外, 排除, 排斥; 除外(诊断)
mine|矿, 矿藏, 地雷;vt. 挖掘, 开采, 在...布雷, 破坏;vi. 开矿, 埋设地雷;pron. 我的
achievement|完成, 成就, 功业
similarly|相像地, 类似于
connect|连接, 联合, 联系
accommodation|膳宿, 预订铺位, 适应性调节, 调和, 贷款; 调节(眼); 适应
topic|主题, 论题, 话题
interpret|解释, 演出, 翻译, 理解;vi. 翻译, 解释
secondary|中级的, 中等的, 次要的, 第二的, 从属的, 辅助的; 仲(指CH-3...CH(CH-3)-型支链烃基或指二元胺及R-2CHOH型的醇); 第二
extension|延长, 扩充, 范围, 扩展名;a. 伸缩的; 扩展名, 扩充名
possess|持有, 占有, 拥有, 克制, 支配, 迷住; 持有, 占有, 具有
analyse|分析, 细察, 分解; 分析
calculate|计算, 预测, 计划, 打算
restrict|限制, 限定, 约束; 限制
distinguish|区别, 辨别
creature|人, 动物, 创造物, 生物
locate|找出, 设于, 位于;vi. 定居
presentation|赠与, 描述, 介绍; 简报
possession|拥有, 占有, 所有, 财产, 领土, 领地, 自制, 着迷; 占有, 持有
certificate|证书, 证明书;vt. 发给证明书, 用证书批准, 用证书证明
custom|习惯, 风俗, 海关, 自定义;a. 定制的; 定制; 自定义
qualification|资格, 条件, 限制; 限定
cheek|颊, 厚颜, 脸蛋; 颊
carpet|地毯, 地毯状物;vt. 铺以地毯, 铺盖
curve|曲线, 弯曲, 曲线球;vt. 弯, 使弯曲;vi. 成曲形
briefly|简短地, 扼要地, 简明地, 简单地
helpful|有帮助的, 有益的, 有用的
assure|保证, 使确信, 弄清楚, 担保; 确信, 保证, 保障
preference|偏爱, 优先, 喜爱物; 首选项
prayer|祈祷, 恳求, 祷辞, 祈祷者
concerning|关于; 关于
distribute|分配, 散布, 分发; 分配, 分发
measurement|尺寸, 度量, 度量单位; 度量, 度量单位
disabled|残废的, 有缺陷的, 失效的; 失效的
primarily|主要地, 首先地
satisfaction|满足, 满意, 快事, 赔偿, 赎罪, 报仇的机会; 偿还, 赎回
interval|间隔, 距离, 间歇, 间隙; 时间间隔
confusion|混乱, 混淆, 无秩序; 含混
provided|倘若, 以...为条件
sheep|羊, 胆小者
summary|摘要, 概要;a. 摘要的, 简略的; 摘要; 概要
practise|实践, 实行, 练习, 实习, 从事(职业)
cheque|支票
precise|精确的, 严谨的, 明确的; 精密的, 正确的
satisfy|使满意, 满足, 符合, 使确信, 赔偿;vi. 令人满意, 替人赎罪
determination|决心, 果断; 判定; 测定
silly|愚蠢的, 糊涂的
bush|矮树丛; 管衬
brick|砖块, 积木;a. 用砖做的;vt. 用砖造, 用砖砌
adapt|使适应, 改编;vi. 适应
unemployed|失业的, 未被利用的; 没有被雇用的, 失业的, 没有被利用的
tongue|舌, 语言能力, 讲话方式, 语言;vt. 舔, 斥责, 发...的音;vi. 使用舌头, 吹管乐器
classroom|教室
mouse|老鼠, 胆小羞怯的人, 鼠标;vi. 捕鼠, 窥探;vt. 探出; 鼠标
weakness|虚弱, 薄弱, 弱点; 欲振乏力
ceiling|天花板; 顶点, 顶线, 上限
absorb|吸收, 使全神贯注, 同化, 买进, 理解, 承受, 忍受, 承担; 吸收
pretend|假装, 伪称, 自命, 自称
grateful|感谢的, 感激的, 令人快意的, 受欢迎的
aged|老的, 陈的, 有...岁的; 老化的; 老化了的; 陈化的; 陈化了的
excitement|刺激, 兴奋; 兴奋, 激动
deaf|聋的; 聋的
confine|限制, 使不外出, 禁闭;vi. 邻接, 交界;n. 边缘, 范围, 区域
reception|接待, 接受, 招待会; 接受, 感受
purely|纯粹地, 清白地, 贞洁地
shelf|架子, 搁板; 架子
continuous|连续的, 继续的, 连续不断的; 连续的
tin|锡, 马口铁, 罐头;vt. 在...镀锡于;a. 锡制的; tin阅读程序
clerk|办事员, 职员, 文书;vi. 当店员
trousers|裤子, 长裤
grammar|语法学, 入门书; 语法检查
funeral|葬礼, 出殡
pig|猪, 猪肉, 贪婪的人, 猪一样的人;v. 生小猪, 象猪般地生活
wander|游荡, 漫步, 徘徊, 迷路, 离题, 蜿蜒;vt. 在...漫游
punishment|处罚, 刑罚, 惩罚; 罚, 处罚, 刑罚
flesh|肉, 肉体, 肉欲, 人性, 亲属, 人类, 众生, 人体;vt. 以肉喂, 激起...的杀戳情绪, 使肥, 赋以血肉;vi. 长胖
asleep|睡着的, 长眠的, 麻木的;adv. 熟睡地
hurry|匆忙, 急忙, 急促;vt. 急派, 催促;vi. 匆忙, 赶快
printer|印刷工, 打印机; 打印机
upstairs|楼上的;adv. 在楼上, 向楼上, 处于更高地位;n. 楼层
hers|她的
outer|外部的, 外面的, 在外的, 远离中心的; 外部的, 外面的, 外侧的
machinery|机器, 机械装置, 机构; 机械
petrol|汽油; 汽油, 挥发油, 石油
organ|风琴, 器官, 元件, 机构, 机关; 风琴
anticipate|预期, 占先, 加速, 提前使用; 提前出现, 先期发生
attraction|吸引, 吸引人的事物, 吸引力; 吸引
garage|车库, 汽车修理厂, 机库;vt. 把车送入修车场
slope|倾斜, 斜坡, 斜率, 扛枪姿势;vt. 使倾斜, 弄斜, 扛;vi. 倾斜, 走, 逃走
informal|非正式的, 不拘礼的, 通俗的; 非正式的, 日常使用的
silk|丝, 绸, 绸锻类, 丝织品;a. 丝的, 丝织的
disc|圆盘, 唱片;vt. 灌唱片
essay|随笔, 短文, 评论, 企图;vt. 试图
logical|合乎逻辑的, 合理的; 逻辑的, 符合逻辑的
electrical|电的, 有关电的; 电的
logic|逻辑, 逻辑学, 推理的方法, 推理, 逻辑性; 逻辑
flame|火焰, 火舌, 热情, 光辉;vt. 焚烧, 用火焰给...灭菌, 用火焰传送(信号), 点燃, 激动;vi. 燃烧, 爆发, 闪耀; 无聊邮件, 无益邮件
wherever|无论哪里
rubbish|废物, 垃圾, 胡说
valid|有确实根据的, 有法律效力的, 正当的, 正确的; 有效的
mineral|矿物, 无机物, 苏打水;a. 矿物的, 似矿物的
swear|发誓, 咒骂, 使宣誓;vi. 发誓, 诅咒;n. 诅咒, 誓言
stranger|陌生人, 门外汉; 局外人, 非当事人, 第三者
rub|摩擦, 困难, 障碍, 磨损处;vt. 擦, 搓, 摩擦, 惹怒;vi. 摩擦, 擦破
needle|针, 尖;vt. 用针缝;vi. 缝纫; 探针
disturb|扰乱, 妨碍, 使不安; 滋扰, 扰乱
advertisement|广告, 启事, 广告宣传; 广告, 公告, 告示
hesitate|犹豫, 迟疑, 踌躇, 支吾, 停顿
translate|翻译, 解释, 转化, 转变为, 调动;vi. 翻译, 被译; 转换
swallow|燕子, 吞咽, 喉;vt. 咽, 淹没, 吞没, 耗尽, 轻信, 忍受, 抑制;vi. 吞下, 咽下
farming|农业, 耕作
removal|移动, 移居, 迁移, 排除, 切除; 切除, 除去
cloth|布料, 织品, 布; 布
taxi|出租车;vi. 乘出租车;vt. 用出租车送
shine|光泽, 阳光;vt. 使发光;vi. 照耀, 发光, 发亮
dictionary|字典, 词典; 词典
rope|绳, 索, 粗绳, 绞索, 决窍;vt. 捆, 缚, 绑, 圈起, 以绳将...系住;vi. 拧成绳状
lamp|灯;vt. 照亮; 逻辑模拟分析系统
knit|编织, 结合
tonne|吨, 公吨; 吨
interrupt|中断, 妨碍, 插嘴;vi. 打断;n. 中断; 中断
forgive|原谅, 宽恕, 免除; 免除, 宽恕, 原谅
battery|电池, 殴打; 蓄电池
devote|投入于, 献身
typically|代表性地;作为特色地
piano|钢琴
insect|昆虫, 卑鄙的人; 昆虫
closed|关闭的, 限于少数人的; 关闭指令
convenient|方便的, 合宜的; 适当的, 合理而可行的, 方便的
artificial|人造的, 假的, 非原地产的; 人工的, 人造的, 伟牟
heating|加热, 供热, 暖气设备, 供暖系统, 暖气装置;a. 加热的, 供暖的
naked|裸体的, 无装饰的, 无保护的, 赤贫的; 裸露的
strictly|严格地, 确实地
regarding|关于
...
uncertain|不确定的, 无常的, 不确信的, 不可预测的; 不确定的, 未定的, 不确信的
heel|脚后跟, 踵, 后部, 倾侧;vt. 尾随, 装以鞋跟, 倾侧, 追赶;vi. 紧随, 用脚后跟传球
toilet|厕所, 梳妆;vi. 梳妆, 打扮, 上厕所;vt. 给...梳妆打扮
menu|菜单, (功能)选择单; 菜单
chemistry|化学, 化学过程; 化学
nail|钉子, 指甲;vt. 用钉钉牢, 使固定, 截住, 揭露
adventure|冒险, 冒险经历;v. 冒险
refusal|拒绝, 推却, 优先决定权; 拒绝, 谢绝, 取舍权
painter|画家, 油漆匠; 油漆匠, 喷漆匠
formerly|从前, 以前
skirt|裙子, 下摆, 边缘, 郊区;vt. 位于...边缘, 绕过, 回避;vi. 位于边缘
mathematics|数学; 数学
confused|困惑的, 混乱的
realistic|现实的, 逼真的, 现实主义的, 实在论的
unite|联合, 接合, 混合;vt. 使联合, 统一, 使粘合, 使结合
ridiculous|荒谬的, 可笑的
receipt|收据, 收入, 收到;vt. 开...的收据
unnecessary|不必要的
invent|发明, 创作, 虚构; 发明
educate|教育, 培养, 训练
envelope|信封, 封套, 封袋; 膜, 包袋
hungry|饥饿的, 荒年的, 渴望的, 不毛的; 欠鞣皮
fetch|取得, 拿, 诡计, 魂;vt. 接来, 取来, 售得, 带来, 推出, 引出, 杀死, 吸引, 到达;vi. 取物, 前进; 取
crack|裂缝, 爆裂声;v. (使)爆裂, (使)裂开, (使)发出爆裂声;a. 第一流的;adv. 啪地一声
cupboard|食橱, 碗柜, 餐具柜
faint|昏厥, 昏倒;a. 模糊的, 微弱的, 无力的;vi. 昏倒, 变得微弱
accent|重音, 口音, 特点, 注重点;vt. 重读, 加重音号于, 强调
shower|阵雨, 淋浴, 一阵, 展出者, 显示者;vi. 淋浴, 下阵雨;vt. 淋湿, 倾注
physics|物理学, 物理过程, 物理现象; 物理; 物理学
delicate|细致优雅的, 微妙的, 美味的; 柔弱的
wool|羊毛, 毛织物, 毛线, 绒线; 羊毛, 绒毛, 棉
steep|浸渍, 悬崖;a. 险峻的, 陡峭的, 急剧升降的, 夸大的;v. 浸, 泡
insert|插入物;vt. 插入, 把(人造卫星)射入(轨道), 添写;vi. 附着; 插入
forever|永远
dull|钝的, 无趣的, 呆滞的, 阴暗的;vt. 使迟钝, 使阴暗, 缓和;vi. 变迟钝, 减少
backwards|向后
pity|遗憾, 同情, 怜悯, 憾事, 可惜;vt. 同情, 怜悯;vi. 觉得可怜, 有同情心
packet|小包, 一批信件, 大量, 信息包;vt. 打包, 装进小包; 分组, 分组报文, 数据分组
skilled|熟练的; 熟练的, 有技能的
lung|肺, 肺脏, 空地; 肺
swimming|游泳, 眩晕
damp|潮湿, 湿气;a. 潮湿的;vt. 使潮湿, 使阻尼, 抑止;vi. 变潮湿, 衰减
hunting|狩猎, 猎狐, 探求; 寻找平衡; 寻找
vertical|垂直的, 直立的; 垂直的, 顶的, 头顶的
ambulance|救护车; 救护车
nest|巢, 窝, 休息所, 隐匿处;vi. 筑巢, 找鸟巢;vt. 为...设窝, 使套叠; 嵌套
parallel|平行, 对比, 相匹敌之物;a. 平行的, 相似的;vt. 与...平行, 与...相似, 相比, 使平行; 并联; 并行
exhibit|显示, 显现, 展览品, 陈列品, 展览;vt. 展现, 陈列, 展览;vi. 开展览会
tropical|热带的, 热情的; 热带的
disappointment|失望
diamond|钻石, 菱形; 菱形
neighbourhood|邻接, 周围, 附近一带, 邻近, 邻居关系, 地区, 街道, 街坊, 四邻; 邻域
ours|我们的
thief|小偷, 贼; 取样
geography|地理学, 地理; 地理
pint|品脱(干量或液量的单位); 量磅, 品脱
translation|翻译, 译文, 转化, 调任, 平移, 转译; 转换
toe|足趾, 趾部, 脚趾;vt. 以趾踏触, 用脚尖走;vi. 动脚尖
blade|叶片, 刀锋, 刀口, 剑; 页;, 叶片, 刀片, 刀刃, 刀口
alternatively|非此即彼
substantially|实质上, 本质上, 大体上
unfortunate|不幸的, 不合适的, 不吉利的
freely|自由地, 随意地, 无拘束地, 直率地, 坦白地, 慷慨地, 免费地, 大量地; 浮动地
definite|明确的, 一定的; 明确的, 确切的, 一定的
upwards|以上, 向上
supermarket|超级市场; 超级市场, 自助售货商店
nonsense|无意义的事, 荒谬言行, 荒唐
horn|角, 角质, 喇叭, 号角;a. 角制的;vt. 用角触, 长角于
awkward|笨拙的, 棘手的
affection|影响, 病, 喜爱, 情感, 倾向; 疾患, 病变, 病; 感情
excited|兴奋的, 已励磁的, 已激发的, 激昂的, 激动的
dissolve|溶解, 解散
stiff|坚硬的, 严厉的, 呆板的, 生硬的, 刚强的, 强烈的, 粘的, 稠的, 艰难的;n. 死尸, 醉鬼, 钞票;vt. 不肯付...小费
boring|烦人的, 无聊的, 无趣的; 成孔期, 搪孔
container|容器, 集装箱; 集装箱; 贮存箱; 容器(任何一种)
arrow|箭, 箭状物, 箭头记号
dot|点, 圆点, 小数点, 小东西, 嫁妆;vt. 作小点记号, 加小点于;vi. 打上点; 点
lively|活泼的, 鲜明的, 生动的
reservation|保留, 预定, 保留品, 保留地; 预定, 预约, 权益保留
artistic|艺术的, 艺术家的, 富有艺术性的
suck|吸, 吮, 吸入, 吮吸, 吸收;vi. 吸, 吸奶;n. 吸, 吸入, 吮吸
ruler|统治者, 管理者, 尺, 直尺;n. 划线板; 标尺
reproduce|繁殖, 再生, 复制, 生殖; 复制
elbow|手肘, 弯头, 扶手;v. 用手肘推开, 推挤
tent|帐篷, 帷幕, 住处, 塞条, 塞子;vi. 住帐蓬, 宿营, 暂时居住;vt. 用帐篷遮盖, 使住帐篷, 用塞条嵌入
sleeve|袖子, 套管;vt. 缝上袖子
exam|考试, 测验
drawer|抽屉, 开票人; 抽屉
grandfather|祖父, 始祖; 原始资料组
drunk|喝醉了的;drink的过去式
oven|烤箱, 灶, 子宫; 烘箱
broadly|宽广地, 明白地, 无礼貌地
biscuit|饼干; 素坯; 饼干
chin|下巴, 颏; 颏
indirect|间接的, 非直截了当的, 不坦率的; 间接的
decrease|减少, 减少量;v. 减少
atom|原子, 核能, 微粒, 微量; 原子
encouragement|鼓励, 激励, 奖励; 怂恿, 煽动, 助长
depressed|沮丧的, 降低的; 抑郁的, 阻抑的, 压低的, 凹;的, 扁平的
shallow|水浅的地方, 浅滩;a. 浅的, 肤浅的;v. (使)变浅
powder|粉, 粉末, 火药;vt. 搽粉于, 搽粉, 撒粉, 使成粉末;vi. 搽粉, 变成粉末
signature|签字, 识别标志, 调号; 签名附件
nut|坚果, 核心, 螺帽; Novell NetWare服务器实用程序
sympathetic|有同情心的, 合意的, 赞成的;n. 交感神经, 容易感受的人
spoil|战利品, 赃物, 奖品, 变质, 次品;vt. 损坏, 破坏, 溺爱;vi. 腐坏, 掠夺
soap|肥皂, 阿谀;vt. 以肥皂洗, 阿谀; 评语
beef|牛肉, 肌肉;vt. 养(牛), 宰(牛);vi. 抱怨, 告发
zero|零, 零点, 零度, 无, 乌有, 最低点;a. 零的, 没有的;vt. 调零, 对(炮火等)作协调校正; 零
absent|缺席的, 不在的, 缺乏的, 漫不经心的;vt. 使缺席
lump|块, 瘤, 很多, 肿块, 笨人;vt. 使成块状, 混在一起;vi. 结块
whoever|任何人, 无论谁
blank|空格, 空白;a. 空白的, 空虚的, 完全的, 无色的;vi. 消失, 成为空白;vt. 使无效, 取消, 封锁; 空白
grandmother|祖母, 女祖先
liquid|液体, 流体, 流音;a. 液体的, 透明的, 明亮的, 流动的, 易变的
Polish|波兰的;n. 波兰人, 上光剂, 光泽, 优雅;vt. 擦亮, 擦去, 使完美;vi. 擦亮, 变得光亮
soup|汤, 马力;vt. 加速, 增加马力
waist|腰部, 腰; 腰
ankle|踝; 踝, 踝关节
wrist|手腕, 腕关节; 腕
tomato|番茄, 西红柿
...
loyal|忠诚的, 忠实的, 忠贞的
suspicious|可疑的, 多疑的, 怀疑的; 怀疑的, 令人怀疑的, 可疑的
uncomfortable|不舒服的, 不自在的, 不安的
suffering|苦难, 受苦
highway|公路, 大道, 捷径; 公路, 大路
cruel|残酷的, 令人极痛苦的; 残忍的, 残酷的
embarrassment|困难, 阻碍, 困窘; 窘迫
ugly|丑陋的, 邪恶的, 险恶的, 不祥的;n. 丑陋的人(或物)
tyre|轮胎;vt. 装轮胎于
thumb|拇指;vt. 以拇指拨弄, 笨拙地摆弄, 用拇指翻旧, 迅速翻阅, 作搭车手势
honestly|真诚地, 公正地
statue|以雕像装饰;n. 雕像
pencil|铅笔, 色笔, 眉笔, 画笔, 光线束;vt. 用铅笔写或涂, 草拟
melt|熔化, 熔化物, 溶解;v. (使)熔化, (使)溶解, (使)消散, (使)变软
glove|手套;vt. 给...戴手套
timetable|时间表
lid|盖子, 限制, 眼睑;vt. 给...盖盖子
decoration|装饰, 装饰品
bored|无聊的;烦人的;无趣的
worship|崇拜, 礼拜, 尊敬;vi. 参加礼拜;vt. 崇拜, 尊敬
lemon|柠檬, 柠檬树, 柠檬色; 柠檬
girlfriend|女朋友
dancer|舞蹈演员, 跳舞者
salad|色拉
confuse|使混乱, 使狼狈, 使困惑; 混淆
useless|无用的, 无效的, 无益的; 无用, 无价值, 无效
disagree|不一致, 不适宜; 抵触, 不同意, 争执
punish|处罚, 惩罚, 严厉对待;vi. 惩罚
unpleasant|使人不愉快的, 使人厌恶的, 煞风景的
shooting|发射, 猎场, 射击
embarrassed|尴尬的;窘迫的
bullet|子弹; 弹, 子弹, 距节(马)
varied|不同的, 杂色的, 各式各样的; 不同的, 种种的, 变化的
invention|发明, 创作能力, 虚构的故事; 发明
mysterious|神秘的, 难解的, 不可思议的
jewellery|宝石, 贵重饰物, 珠宝, 宝石饰物, 受珍视的人/物, 宝贝, 有价值的人/物
tablet|平板, 门牌, 笔记簿, 碑, 匾, 药片; 片剂
awake|醒着的;vt. 唤醒, 唤起, 使意识到;vi. 醒来, 被唤起, 意识到
feather|羽毛;vi. 长羽毛;vt. 用羽毛装饰
towel|手巾, 毛巾;v. 擦干身子
jeans|工装裤, 牛仔裤
boyfriend|男朋友
passing|通过, 逝去, 死, 流逝;a. 经过的, 流逝的, 目前的, 短暂的, 及格的, 仓促的
exit|出口, 退场, 离去, 去世;vi. 退出, 脱离, 去世; 退出; DOS内部命令:本命令用于退出当前的命令处理器(COMMAND.COM);恢复前一个命令处理器
steer|引导, 驾驶, 航行, 控制;vi. 驾驶, 掌舵, 行驶;n. 驾驶指示, 劝告
patience|耐性, 忍耐
revise|校订, 修正, 改样;vt. 校订, 修正, 校正
pronounce|发音, 宣告, 断言
dislike|嫌恶;vt. 讨厌, 不喜欢
obey|服从, 遵从, 顺从;vi. 服从
hammer|锤, 铁锤, 钉锤;vt. 锤打, 敲打, 钉;vi. 连续锤打; 锤头
openly|公开地, 坦率地, 直率地, 公然地
crush|压碎, 粉碎, 群众, 迷恋;vt. 压破, 征服, 塞, 弄皱, 榨出;vi. 被压碎, 起皱, 挤
polite|有礼貌的, 文雅的, 客气的, 有教养的
fashionable|时髦的, 上流社会的, 流行的
devoted|投入的, 深爱的
headache|头痛, 令人头痛之事; 头痛
surroundings|环境, 周围的事物; 环境
thread|线, 丝, 纤维, 线索;vt. 穿线于, 穿过, 通过, 用线穿成;vi. 穿过; 线索, 线程
scratch|抓痕, 搔, 抓, 擦伤, 刮擦声, 乱写, 零分, 起跑线;vt. 搔, 抓, 挖出, 擦, 刮, 乱涂, 勾抹掉;vi. 搔, 抓, 发刮擦声, 勉强糊口;a. 碰巧的, 凑合的, 打草稿用的; 擦除
unconscious|未意识到的, 无意识的, 无知觉的; 人事不省的, 神志丧失的; 无意识的
multiply|繁殖, 乘, 增加; 乘
fur|毛皮;vt. 以毛皮制作, 使生苔, 使生水垢;vi. 生苔, 积水垢
chemist|化学家, 药剂师; 化学家; 化学师; 化学工作者; 药剂师; 药房
fame|名望, 名声, 传说
cheerful|快活的, 高兴的, 兴高采烈的
frighten|使惊吓;vi. 惊恐
disagreement|不合, 争论, 不一致; 不一致, 不同意, 陪审团的意见不一
sailor|水手, 船员, 海员; 水手, 船员, 海员
knot|结, 群, 难题;v. 打结, (使)纠缠
sock|短袜, 鞋垫, 一击;vt. 重击, 猛投, 给...穿袜;vi. 打击;adv. 正着地, 不偏不倚地;a. 非常成功的
snake|蛇, 阴险的人;vi. 曲折行进;vt. 迂回, 拉, 急抽
scared|害怕的, 担惊受怕的, 惊慌的, 吓坏了的
unacceptable|无法接受的, 不受欢迎的; 不能接受的, 不受欢迎的, 难以承认的
onion|洋葱;vt. 因洋葱使掉泪
sweat|汗, 汗水, 水珠, 焦急;vi. 出汗, 渗出, 冒出水气, 结水珠, 烦恼, 懊恼;vt. 使出汗, 流出, 榨出, 使汗流浃背
curl|拳曲, 鬈发;vt. 弄卷;vi. 拳曲, 弯曲
rob|抢夺, 抢掠, 剥夺
retired|隐退的, 退休的, 退役的; 退休的, 已收回的
noisy|嘈杂的, 喧闹的; 噪声的, 嘈杂的
ending|终止, 终了, 收场; 末梢
frozen|冻结的, 冰冷的, 严寒的, 冻伤的, 冷酷的;freeze的过去分词
worrying|使人烦恼的, 忧虑重重的
rubber|橡皮, 橡胶, 做摩擦动作的人, 按摩师, 决胜盘;vt. 用橡胶制造, 涂橡胶于
dying|垂死的; 快要死的, 垂死的, 临终的
passport|护照, 手段, 通行证; 通行证, 护照
ashamed|惭愧的, 羞耻的
quit|离开, 辞职, 停止;vt. 离开, 放弃, 使解除, 停止;n. 离开; 结束, 退出
shy|惊跳, 惊避;a. 胆怯的, 畏缩的, 迟疑的, 羞怯的;vi. 惊退, 乱投, 乱掷, 厌恶, 避开;vt. 乱投, 乱掷
bicycle|自行车
inability|无能, 无力
purple|紫色, 帝位;a. 紫色的, 帝王的, 华而不实的;v. (使)成紫色
fever|发烧, 发热, 热病; 发热, 热
hatred|憎恨, 仇恨, 憎恶; 敌意, 憎恨, 憎恶
flour|面粉, 粉沫, 碎粉; 面粉, 麦粉
bin|(贮存谷物等的)容器, 箱子; 二进制, 商业信息网
keyboard|键盘; 键盘
outdoor|户外的, 屋外的, 露天的
biology|生物学; 生物; 生物学
photography|摄影, 摄影术; 照相术
screw|螺旋, 螺杆, 螺钉, 螺旋桨, 吝啬鬼;vt. 调节, 扭紧, 旋, 拧, 加强, 压榨, 勒索;vi. 转动, 旋, 拧
fridge|电冰箱
swell|增大, 隆起的部分, 巨浪, 肿胀;a. 优秀的, 一流的;vi. 增大, 膨胀, 肿胀, 增强, 骄傲;vt. 使膨胀, 使增大, 使上涨, 使骄傲
promptly|敏捷地, 迅速地
offend|犯罪, 冒犯, 违反, 进攻
faithful|忠实的, 详确的, 可靠的;n. 信徒
umbrella|伞, 雨伞, 保护伞;a. 伞的, 包罗万象的;vt. 用伞遮掩
underneath|在下面;prep. 在...的下面
bubble|泡沫;vi. 冒泡, 沸腾;vt. 使冒泡, 滔滔不绝地说
jam|果酱, 拥塞之物, 堵塞, 困境;vt. 挤进, 使塞满, 混杂, 压碎, 使堵塞;vi. 堵塞, 轧住, 拥挤
unwilling|不愿意的, 勉强的; 不愿意的, 勉强的, 不服从的
nicely|漂亮地, 谨慎地, 恰好地
fork|叉子, 叉状物, 分岔;vi. 分支, 分歧;vt. 做成叉形, 叉起; 派生指令
dirt|污垢, 泥土; 污垢
poison|毒药, 毒, 毒物, 有毒害的事物;vt. 毒害, 毒杀, 使中毒;vi. 放毒, 下毒
beard|胡须;vt. 抓住胡须, 公开反对
unusually|不寻常地, 异乎寻常地, (非正式)非常
disappointing|使失望的, 期待落空的, 令人沮丧的
rude|粗鲁无礼的, 粗陋的, 粗暴的, 原始的, 未开化的, 大略的, 崎岖不平的, 狂暴的
unsuccessful|不成功的
repeated|重复的, 再三的; 反复的, 再三的, 屡次的
chew|咀嚼, 嚼碎;vi. 咀嚼, 细想;n. 咀嚼, 咀嚼物
jealous|嫉妒的, 羡慕的, 留心的, 戒备的
packaging|包装, 包装业, 包装术; 组装; 封装
sailing|航行, 航海术, 启航;a. 航行的
restricted|受限制的, 有限的
litre|升, 公升; 升
spider|蜘蛛, 设圈套者; 星形轮
goodbye|再见
waiter|侍者
exaggerate|夸大, 夸张
cheat|欺骗, 作弊, 骗子;v. 欺骗, 逃脱, 骗取
crowded|拥挤的, 塞满的
plug|塞子, 栓, 插头;vt. 插入, 塞住, 接插头;vi. 被塞住
kindly|和蔼的, 温和的, 爽快的;adv. 温和地, 亲切地
hobby|嗜好, 癖好, 爱好
enjoyable|可从中得到乐趣的, 令人愉快的
ink|墨水, 墨汁;vt. 涂墨水于, 签署, 加墨水
decay|衰退, 腐败;v. (使)衰退, (使)腐败
gallon|加仑; 加仑
carrot|胡萝卜; 胡萝卜
sticky|粘的, 有粘性的, 顽固的
dentist|牙科医生; 牙医师
attempted|企图的;未遂的
spoon|匙, 调羹, 匙形工具;vt. 以匙舀起, 调情, 使成匙状
decorative|装饰性的
indoor|户内的, 室内的
blonde|(头发)亚麻色的, 淡色的, 白肤金发碧眼的, 白里透红的, 白皙的, 淡黄色的;n. 肤色白皙的金发女人
confusing|令人困惑的;混淆的;混乱的
noticeable|显而易见的, 显著的, 值得注意的
amusing|有趣的, 引人发笑的
finished|完成的, 完结的, 精巧的, 完美的
tidy|椅子的背罩, 装杂物的容器;a. 整齐的, 有条理的;vt. 弄整齐, 收拾, 整理;vi. 整理, 收拾
satisfying|满意的, 充分的, 足可相信的
lazy|懒惰的, 怠惰的, 缓慢的;vi. 懒散
harmful|有害的, 伤害的
shiny|有光泽的, 发光的, 辉煌的, 磨光的, 磨损的
sore|悲伤的, 痛的, 引起痛苦的;n. 痛处, 溃疡, 疮
wildly|狂暴地, 激动地, 狂热地, 鲁莽地, 轻率地
suitcase|手提箱
click|咔哒声, 啪嗒声;vi. 作咔哒声;vt. 使发咔哒声; 单击
license|执照, 许可证, 特许;vt. 许可, 特许
climbing|攀缘而登的, 上升的;n. 攀登
sweater|毛衣, 毛线衫, 运动衫, 出汗者; 发汗器
depressing|抑压的, 沉闷的, 阴沉的
downwards|向下
insult|侮辱, 无礼, 损害;vt. 损害, 侮辱, 攻击
moving|动人的, 令人感动的, 鼓动的, 原动的, ;活动的, 转动的
accidental|意外的, 偶然的, 非主要的, 附属的;n. 临时记号, 次要方面
singing|歌唱, 歌声; 振鸣; 蜂鸣
whistle|口哨, 汽笛, 啸啸声, 口哨声;vi. 吹口哨, 鸣汽笛, 发嘘嘘声;vt. 用口哨或吹哨传意, 用口哨演奏
educated|受过教育的, 有教养的
harmless|无害处的, 未受损害的, 无辜的, 无恶意的; 无害的, 无恶意的, 无损害的
hollow|洞, 窟窿, 山谷;a. 空的, 虚伪的, 空腹的, 凹的;vi. 形成空洞;vt. 挖空
curb|抑制, 勒马绳, 边石;vt. 抑制, 束缚, 勒住
impatient|不耐烦的, 着急的, 急切的
stripe|斑纹, 条纹; 纹, 条纹
shave|修面, 刮胡子, 幸免, 剃刀;vt. 修面, 剃, 修剪, 掠过;vi. 刮脸, 勉强通过
crisp|脆的, 新鲜的, 活泼的;v. (使)烘脆, (使)拳曲, (使)起皱;n. 松脆物
shocking|令人震惊的, 极坏的, 不正当的
excite|刺激, 使兴奋, 激励
scare|惊吓, 恐慌;vt. 惊吓, 使恐慌;vi. 受惊
sour|酸的, 酸臭的, 发酵的, 愠怒的, 讨厌的, 拙劣的, 不健全的;vi. 变酸, 发酵, 厌烦, 变坏;vt. 使变酸, 使失望;n. 酸味, 酸饮料
pants|裤子, 长裤, 短衬裤, 女式运动短裤
spice|香料, 药料, 香气, 调味品, 情趣, 少许;vt. 加香料, 使添趣味
irritate|激怒, 使发怒, 使兴奋, 使发炎;vi. 引起不快
disgust|厌恶, 嫌恶;vi. 令人厌恶;vt. 使作呕
glue|胶, 粘性物;vt. 粘合, 胶合
alcoholic|酒鬼, 酒精中毒者;a. 酒精的
sincere|诚实的, 正直的, 真挚的, 纯净的
pointed|尖的, 有尖顶的, 锐利的, 率直的, 显然的
backward|向后地, 相反地;a. 向后的, 相反的; 倒推
sting|叮, 刺痛, 刺激, 讽刺;vt. 叮, 刺痛, 刺激, 使苦恼;vi. 叮, 刺痛
gram|克, 绿豆, 鹰嘴豆; 克
apologize|道歉, 辩解
exaggerated|夸大的, 夸张的, 言过其实的
mistaken|犯错的, 错误的;mistake的过去分词
embarrass|使困窘, 使局促不安, 阻碍
vacation|假期, 休假; 假期, 停审期, 休庭期
covering|覆盖物, 掩蔽物;a. 掩护的, 掩盖的; 覆盖
faithfully|忠实地, 诚心诚意地, 深信着地
approximate|大约的, 接近的, 近似的;vt. 接近, 使接近, 粗略估计;vi. 接近于
cent|分; 美分
riding|骑, 乘车, 乘, 骑术, 骑马
amaze|使吃惊
...
mom|妈妈
confined|被限制的, 狭窄的, 在分娩中的, 坐月子的; 有限的, 狭窄的
engaged|忙碌的, 使用中的
bent|弯曲的, 决心的;n. 爱好;bend的过去式和过去分词
grandchild|孙, 外孙女, 外孙, 孙女, 孙子
gasoline|汽油; 汽油
stair|梯级, 楼梯, 阶梯
bacteria|细菌; 细菌, ;杆菌
...
post office|邮局; 邮局
swimming pool|游泳池
take|拿, 取, 抓, 带领, 获得, 就座, 接受, 吃, 吸引, 采取, 乘, 需要, 花费;vi. 吃掉对方棋子, 抓住, 起作用, 依法获得财产;n. 拿, 取, 收成, 奏效
just|正直的, 合理的, 正确的, 应得的;adv. 刚刚, 正好, 仅仅
even|平坦的, 相等的, 连贯的, 均等的, 公平的, 偶数的, 平均的, 平衡的, 恰好的;vt. 使平坦, 使相等;vi. 变平, 成为相等;adv. 甚至, 实际上, 完全, 十分;n. 偶数, 偶校验; 偶数, 偶校验
might|力量, 权力;aux. 可能, 也许
home|家, 避难所, 故乡;a. 家庭的, 国内的, 打中目标的;adv. 在家, 在本国, 打中目标地; 返回始位
minute|分, 分钟, 片刻, 备忘录, 笔记;vt. 记录, 摘录, 测定时间;a. 微小的, 详细的
bank|银行, 堤, 岸; 库
common|通常的, 共同的, 通俗的, 公共的; 公用块
used|使用过的, 二手的, 习惯的
planning|计划的制订, 策划, 设计, 规划; 计划, 规划
bear|熊;vt. 忍受, 支承, 产生, 怀有, 通过卖空使跌价;vi. 忍受, 结果实, 压挤, 行进, 转向
directly|径直地, 直接地, 直率地, 正好地, 直截了当地, (非正式)立即, 马上;conj. 一...(就...), 一当...就...; 直接的
senior|年长者, 资深者, 毕业班学生;a. 年长的, 高级的, 资深的
equally|相等地, 同样地, 平等地
unemployment|失业, 失业人数; 失业
count|计算, 视为;vi. 计数;n. 计算, 合计, 计数, 伯爵; 计数
entrance|入口, 进入点, 入场, 入学, 进入, 开始(阶段), 就任;vt. 使出神, 使入迷; 入口
disk|圆盘, 磁盘; 磁盘
broken|坏掉的, 打破的, 断掉的;break的过去分词
coin|硬币, 金钱, 货币;vt. 铸币, 创造, 杜撰
injure|伤害, 损害, 使受冤屈; 损伤
specially|特别地, 专门地
happily|幸福地, 快乐地, 幸好
diagram|图表;图解
fancy|想象力, 幻想, 喜好;a. 想象的, 精美的, 新奇的, 奇特的, 高价的, 特级的;vt. 想象, 设想, 相信, 喜爱;vi. 想象, 幻想
walking|步行, 步态;a. 步行的, 步行用的
washing|洗涤, 浸, 洗涤物; 涂浆, 洗涤
seal|印章, 封条, 海豹, 海豹皮, 火漆, 封蜡, 玺, 保证, 批准, 象征, 标志;vt. 封闭, 盖印, 盖章;vi. 猎海豹
ad|广告; 地址, 模拟-数字
driving|赶, 操纵, 驾驶;a. 推进的, 强劲的, 精力旺盛的
width|宽度, 宽广, 广博; 宽度
vocabulary|词汇(量), 词汇表; 词表
privately|秘密地;私下地
ideally|完美地, 理想地
probable|很可能的, 大概的, 可信的;n. 很有希望的候选人, 很可能的事情
horizontal|水平线, 水平面, 水平位置;a. 水平线的, 平坦的, 横的;n. 水平; 水平
triangle|三角形, 三个一组, 三角关系; 三角, 三角形
sincerely|真诚地
enjoyment|享乐, 快乐, 享受; 使用权
unreasonable|不合理的, 过度的, 不切实际的; 不讲道理的, 非理智的, 不合理的
spelling|拼, 拼字, 拼法; 拼写检查
aloud|出声地, 大声地
knitting|编结, 针织法, 针织, 编结法, 编结物, 针织品; 骨愈合
comfortably|安乐地, 舒服地, 宽裕地
matching|相同的, 协调的; 匹配, 对比
undo|解开, 取消, 破坏, 毁灭, 扰乱;vi. 松开; 撤消
nephew|侄子, 外甥
sew|缝纫, 缝合, 缝;vi. 缝纫
homework|家庭作业, 家里做的工作; 家庭作业
curved|弯曲的;弄弯的
disgusting|令人厌恶的
sideways|向旁边, 向侧面地;a. 旁边的, 向侧面的
calmly|平静地, 安静地, 冷静地
stove|火炉, 窑;vt. 用火炉烤;stave的过去式和过去分词
amused|愉快的, 被逗乐的
worse|更坏的事, 更恶劣的事, 败局;a. 更坏的, 更恶劣的;adv. 更坏地, 更恶劣地
imaginary|想像的, 虚构的, 假想的
transparent|透明的, 显然的, 清晰的; 透明
web|网, 蛛丝, 蹼, 织物, 圈套, 卷筒纸;vi. 结网, 形成网;vt. 织蜘蛛网于, 使落入圈套
grandson|孙子, 外孙
kindness|仁慈, 亲切, 和蔼
annoyed|恼怒的;烦闷的
wallet|皮夹; 皮包, 皮夹, 钱袋
oddly|奇怪地
fasten|拴紧, 使固定, 系, 集中于, 强加于;vi. 扣紧
luggage|行李, 皮箱
cooker|炊事用具, 炉灶, 锅, 炊具, 烹饪用水果, 窜改者, 伪造者; 蒸锅
pleasing|令人喜爱的, 愉快的, 舒适的
midday|正午, 中午;a. 正午的
grandparent|祖父母
unload|卸货;vt. 从...卸下, 摆脱...之负担, 倾销, 卸(货); 卸载
...
hairdresser|美发师, 理发师
niece|侄女, 甥女
jelly|果冻, 果冻甜食, 胶状物;v. (使)结冻, (使)成胶状
clap|拍手, 拍手声, 霹雳声, 花柳病;v. 鼓掌, (使)啪地关上
flu|流感, 流行性感冒
pronunciation|发音, 读法
skilful|灵巧的, 熟练的, 制作精巧的
disapprove|不赞成
unlucky|不吉利的, 不祥的, 不幸的
cardboard|薄纸板; 咭纸; 特等纸板; 卡纸板; 卡片纸板
infectious|有传染性的, 易传染的; 传染性的
disapproval|不赞成
striped|有斑纹的
scissors|剪刀; 剪
amuse|消遣, 娱乐, 使发笑
...
baggage|行李; 行李
centimetre|厘米, 公分
depress|使沮丧, 压低, 降低, 使萧条; 推下
humorous|富幽默感的, 滑稽的, 诙谐的
complicate|弄复杂, 使错综, 使恶化;vi. 变复杂
surname|姓, 别号, 绰号;vt. 呼以姓氏, 起绰号
unimportant|不重要的
disappoint|使失望
poisonous|有毒的, 恶毒的, 讨厌的; 有毒的
annoying|恼人的, 讨厌的
untidy|不整齐的, 懒散的, 混乱的
motorcycle|摩托车; 机动车, 机踏车, 摩托车
millimetre|毫米; 公厘
refrigerator|电冰箱, 冷藏库; 冷冻机; 致冷器
excluding|把...排除在外, 不包括..., 不计...
dishonest|不诚实的; 不忠实的, 不诚实的, 欺诈的
sewing|缝制品, 缝纫
swollen|肿大的, 涨水的, 夸张的, 骄傲的;swell的过去分词
ruined|毁灭的, 没落的, 荒废的
curly|拳曲的, 卷毛的, 弯曲的
beak|鸟嘴, 喙; 嘴, 喙
awfully|恶劣地, 非常地, 极端地
bandage|绷带; 帘布筒; 实心轮胎; 紧带; 绷带
yawn|哈欠;vi. 打哈欠, 裂开;vt. 打着哈欠说
candy|糖果, 冰糖;vt. 用糖煮, 使结晶为砂糖;vi. 结晶为砂糖
tire|轮胎, 头饰;vt. 使疲倦, 使厌烦, 打扮;vi. 疲劳, 厌倦
alphabet|字母; 字母表
covered|隐蔽着的, 掩藏着的, 有屋顶的; 涂抹了的, 覆盖了的, 掩盖了的
uncontrolled|不受抑制的, 不受控制的, 自由的
tiring|引起疲劳的, 累人的; 轮箍术(髌骨骨折时)
immoral|不道德的, 邪恶的, 放荡的; 不道德的, 道德败坏的, 邪恶的
mall|林荫路
unkind|不仁慈的, 不亲切的
underwater|在水中的;adv. 在水下
granddaughter|孙女, 外孙女
disgusted|厌恶的;厌烦的
thirsty|口渴的, 渴望的, 干燥的
cracked|破碎的, 破裂的, 声音嘶哑的; 有裂缝的, 裂化的
closet|壁橱, 小室;a. 秘密的, 空谈的;vt. 把...关入小室
garbage|垃圾, 废物; 无用信息
elevator|电梯, 升降机; 提升机
PT|点, 处理时间, 可编程序终端; 铂(78号元素)
unfriendly|不友善地
wrapping|用于包裹的材料; 绕接
photocopy|影印, 复印件;v. 影印
entertainer|表演娱乐节目的人, 演艺人员
swelling|肿胀, 肿大, 隆起部, 身上的肿胀处, 膨胀, 增大;a. 肿大的, 突起的
outdoors|户外, 野外活动;adv. 在户外, 在野外
spicy|香的, 多香料的, 辛辣的, 下流的
salty|有盐分的, 咸味浓的, 海洋的, 辛辣的, 有经验的
kilogram|千克, 公斤; 千克, 公斤
stressed|感到有压力的;紧张的
suited|适合的
cookie|饼干, 小甜点; 糕点
milligram|毫克; 毫克
...
quickly|很快地
Dr|博士, 医生; 英钱
western|西方人, 西部片, 西部小说;a. 向西方的, 来自西方的, 西方的, 西洋的, 西部的
importance|重要, 重要性, 重要地位, 自大; 重要, 重要性
completely|完全地, 十分地, 圆满地
contribution|捐助, 捐助之物, 贡献; 贡献, 捐款, 补助品
driver|驾驶员, 驱动器, 驱动程序; 驱动器
relatively|相对地, 比较地, 相当地, 相关地; 相对地
slowly|慢慢地, 迟缓地
additional|附加的, 另外的, 额外的; 加添的, 附加的
writer|作家, 撰稿者, 抄写员; 记录器
carefully|小心地, 谨慎地
currently|现在, 当前, 一般, 普通; 当前
investigation|调查, 审查; 调查, 调查研究
northern|北方人;a. 北方的, 向北的, 自北方来的
existence|存在, 生存; 存在, 存在状态, 实体
...
widely|广泛地
closely|接近地
marketing|行销, 买卖; 推销, 在市场买卖, 销售
surprised|感到惊讶的
strongly|强有力地, 坚强地, 激烈地
rapidly|飞快地, 迅速地, 赶紧地
independence|独立, 自立, 自主; 自主性, 独立性
buyer|买主, 买方; 买主, 买方, 买手
supporter|支持者, 后盾, 迫随者, 护身织物; 支持者, 赡养者, 抚养者
manufacturing|制造业;a. 制造业的
significantly|值得注目地;意味深长地
heavily|很重地, 严重地, 难以忍受地
saving|存款, 挽救, 节约;a. 搭救的, 节约的, 保留的, 补偿的;prep. 除...之外
quietly|安静地, 沉着地, 秘密地
advertising|广告业, 广告;a. 广告的; 发广告
occasionally|有时候, 偶而
firmly|坚固, 坚定, 断然
gently|温和地, 温柔地, 轻轻地, 逐渐地
restriction|限制, 限定, 约束; 限定
regularly|有规则地, 一丝不苟地, 正式地
trading|交易
gradually|逐渐地
deeply|深刻地, 在深处, 深沉地
promotion|晋级, 创建, 增进; 推广, 推销, 促进
producer|生产者, 制作者, 制作人; 发生器; (炉煤气)发生炉; 制气炉; 生产者
surprising|令人惊讶的
enquiry|询问; 询价, 询盘
judgement|审判, 判决, 判断; 判定, 审定, 鉴定
successfully|成功, 结果良好, 有成就
greatly|很, 非常
constantly|不变地, 不断地, 时常地
reasonably|适度地, 相当地
indication|指示, 象征, 暗示; 指示, 指征, 适应征
inevitably|不可避免地
considerably|非常地, 很, 颇
deliberately|故意地
automatically|自动地, 机械地
approximately|大约, 大致, 近于; 大约, 近似
departure|离开, 出发, 违背, 偏离; 启运
surprisingly|使人惊奇, 出人意外, 惊人, 令人惊讶
sufficiently|足够, 充分
commonly|一般, 普通, 通常
sharply|锐利地, 严厉地, 厉害地; 剧烈地
softly|柔和地, 静静地, 温柔地
destruction|破坏, 毁灭; 破坏
potentially|可能地, 潜在地
roughly|概略地, 粗糙地, 粗暴地
calculation|计算, 考虑, 计算的结果; 计算
formally|正式地, 形式上
...
fighting|战斗的, 容易引起争斗的, 适于格斗的, 好斗的, 好战的, 斗争的, 搏斗的;n. 战斗, 斗争, 搏斗
expected|预期的;预料的
traditionally|传统上;传说上;习惯上
physically|按自然规律, 完全地, 实际上, 真正地, 身体上地
desperately|拼命地;绝望地;极度地
lightly|轻轻地, 少许, 不费力地
mentally|心理上, 精神上, 智力上; 精神上, 智力上
correctly|对, 正确, 恰当, 符合一般性准则, 符合行为准则, 端正, 符合
flying|飞的, 飘扬的, 飞速的;n. 飞行, 飞花
sadly|悲痛地, 悲惨地, 悲伤地, 说来遗憾
separation|分离, 分居, 缺口, 退职; 分离
OK|好, 不错, 可以;adv. 好, 不错, 可以;n. 批准, 认可; 确定
separately|;分开, 不相连, 分隔, 分离, 不同, 单独, 独立, 各自, 各别, 脱离肉体, 灵魂; 分离地
officially|作为公务员, 职务上, 官方地
locally|地方性地, 局部性地, 在当地
severely|严格, 尖锐, 严肃, 严重, 严厉, 朴素
safely|安全地, 确实地
tightly|紧紧地, 坚固地
surrounding|环境;a. 周围的
happiness|快乐, 幸运, 适当
photographer|摄影师, 摄影者
steadily|稳定地, 无变化地, 有规则地
politically|政治上
downstairs|楼下;a. 楼下的;adv. 在楼下
...
performer|表演者, 执行者, 完成者; 执行者, 履行者, 实行者
jointly|共同地, 连带地
annually|一年一次, 每年; 年度的, 每年的
loudly|高声地, 大声地, 吵闹地
gray|灰色, 暗淡;a. 灰色的, 灰白的, 面色苍白的, 年老的, 老练的, 阴沉的;v. (使)变灰色
angrily|愤怒地
theirs|他们的
disturbing|引起烦恼的, 令人不安的
smoothly|平滑地, 流畅地, 流利地
frightening|令人恐惧的;引起突然惊恐的
controlled|受约束的, 克制的; 受管制的, 受控制的, 受管辖的
breathing|呼吸, 瞬间, 微风;a. 呼吸的, 逼真的
sexually|性别地;两性之间地
admiration|赞赏, 钦佩, 引人赞赏的对象
indirectly|间接, 曲折, 迂回, 不直截了当, 不诚实, 不坦率; 间接地
strangely|奇妙地, 奇怪地, 不可思议地
continuously|不断地, 连续地; 连续地
...
thickness|厚度, 密度, 愚钝, 含混不清; 厚度
wounded|受伤的; 受伤者; 受伤的, 受了损害的
interruption|打扰, 中断, 障碍物; 间断, 阻断, 中止
politely|有礼貌地, 文雅地, 客气地
brightly|生辉地, 明亮地, 鲜明地
spoken|口头讲的, 口语的;speak的过去分词
emotionally|在情绪上
secretly|秘密地, 背地里
proudly|傲慢地, 自大地, 得意洋洋地
intended|有意的, 故意的;n. 未婚夫(妻)
...
deserted|被遗弃的, 废弃的; 被遗弃的, 无人的, 放弃的
...
relaxing|令人轻松的
insulting|侮辱的, 损害人体的
farther|更远的, 进一步的;adv. 更远的, 此外, far的比较级
awkwardly|笨拙地;无技巧地
thickly|厚地;浓地
separated|分居;分开的;不在一起生活的
...
blankly|茫然地, 毫无表情地
divorced|离婚的
folding|可折叠的; 折叠; 折叠效应
alphabetical|依字母顺序的, 字母的
carelessly|不注意地, 粗心地
unsteady|不稳固的, 摇摆的, 不稳定的, 易变的, 不安定的, 不规则的, 古怪的, 无常的;vt. 使不稳定, 使不安定, 动摇
knitted|knit的过去式和过去分词
disapproving|不满的, 反对的;v. 不赞成( disapprove的现在分词 )
upsetting|镦(粗); 镦锻
...
arms|武器, 军事行动; 武器, 军械, 枪械
internet|因特网, 国际互连网, 网际网络, 互连网络, 广域网
coughing|咳嗽( cough的现在分词 ); （从喉咙或肺中）咳出; （突然）发出刺耳的噪音
approving|赞成的
lacking|缺乏的, 不足的
cellphone|蜂窝式便携无线电话;大哥大
located|处于, 位于;坐落的
...
give birth|使诞生, 生（孩子）
glasses|眼镜;双筒望远镜;玻璃（glass的复数形式）
go bad|变质; 坏
...
ought to|应该
pay attention|专心
per cent|每百中, 百分之..., (英)利息...厘的证券, (非正式)百分率; 每百分, 百分数
...
three|三, 三个
four|四, 四个; 四冲程循环
going|去, 离去, 工作情况, 地面状况, 行为;a. 进行中的, 流行的, 成功的, 现存的
five|五, 五个
six|六, 六个
million|百万, 无数;num. 百万
lot|运气, 签, 抽签, 份额, 许多, 一堆;vt. 划分;vi. 抽签, 抓阄
hundred|百, 百个东西;num. 百, 百个;a. 一百的, 许多的
ten|十, 十个
seven|七, 七个
eight|八, 八个
twenty|二十, 二十个
thousand|千;a. 成千的, 许多的;n. 许许多多
nine|九, 九个
thirty|三十, 三十个
fifty|五十, 五十个
forty|四十, 四十个
...
eleven|十一, 十一个
eighteen|十八, 十八个
percent|百分比, 百分数, 部分; 百分率
fourteen|十四, 十四个
sixteen|十六, 十六个
thirteen|十三, 十三个
photo|相片, 照片, 逼真的描绘;v. 照相;a. 照相的, 摄影用的, 详细记录的, 逼真的, 酷似的
seventeen|十七, 十七个
coming|来临;a. 就要来的, 接着的
accord|一致, 调和, 协定;vt. 给与, 使一致;vi. 相符合
...
you've|you have 你（们）已经
third|第三, 三分之一; 第三; 第三的
someone|有人, 某人
refer|提交, 归诸于, 把...提交, 使求助于;vi. 提到, 涉及, 查阅, 查询, 咨询
okay|好, 可以, 行, 对, 好吗, 很好;adv. 好, 可以, 行, 对, 好吗, 很好;n. 同意, 签认, 批准, 认可;vt. 同意, 签认, 批准, 认可
earlier|早的;初期的
involved|难懂的, 复杂的, 不易懂的, 卷入...之中的, 累及..., 与...有关, 被纠缠的; 包含, 涉及
Christmas|圣诞节
born|天生的;bear的过去分词
administration|行政, 管理, 政府机关; 给药
assess|估定, 对...征税, 评定; 估计, 估价, 确定(税款罚款等)的金额
asset|资产, 有益的东西
fourth|第四, 四分之一
everybody|每个人, 人人
settlement|安顿, 解决, 处理, 结算, 殖民, 殖民地, 沉降; 居住区; 沉渣
democratic|民主的; 民主的, 民主政体的, 平民的
republic|共和国, 共和政体, 团体, 界
treaty|条约, 谈判; 协议, 协定, 协商
supposed|想象上的, 假定的, 被信以为真的; 推测的, 想像的, 被信以为真的
liberal|自由主义者;a. 慷慨的, 不拘泥的, 宽大的, 自由主义的
troop|军队, 一群, 一队;vi. 群集, 结队, 成群而行
deputy|副手，代理人
leadership|领导能力, 领导阶层
championship|冠军身份, 冠军称号, 捍卫
negotiation|谈判, 磋商, 交涉; 谈判, 协商
champion|冠军, 拥护者, 战士;vt. 保卫, 拥护;a. 优胜的
democracy|民主政治, 民主主义; 民主, 民主政治, 民主政体
territory|领土, 领地, 版图, 地区, 活动范围; (推销员等的)推销区域
inflation|胀大, 夸张, 通货膨胀; 充气吹胀; 膨胀
resolution|解析, 决心, 坚定, 决定, 决议, 消除, 解答, 分解;n. 图形分辨率; 图形分辨率
dispute|争论;v. 争论
currency|货币, 通货, 流通, 通用; 货币, 货币型
spokesman|发言人, 代言者
communist|共产主义者, 共产党员; 共产主义的, 共产党的
critic|批评家, 鉴定家
poll|投票, 民意测验, 选举投票, 投票数, 一组人中的一个, 头颈和后脑部, 鹦鹉;vt. 对...进行民意测验, 获得...票, 剪树枝, 轮询;vi. 投票;a. 剪过毛的, 修过枝的; 轮询
recession|后退, 凹处, 衰退, 归还; 退缩
radical|激进分子, 词根, 基础, 根式, 根;a. 激进的, 根本的, 基本的, 根的
bond|捆绑物, 结合, 债券, 契约, 粘合剂, 保证人, 键, 关栈保留;vt. 存入关栈, 使黏合;vi. 结合
fifth|第五, 五分之一
investor|投资者; 投资者
mortgage|抵押, 约束性义务, 抵押借款;vt. 抵押, 以...作担保, 把...许给
journal|日记, 杂志, 日报; 轴颈
nineteenth|第十九, 十九分之一
negotiate|商议, 谈判, 交涉;vt. 谈妥, 转让, 处理
mission|任务, 代表团, 使命, 传教团;vt. 派遣, 向...传教
talent|天才, 才能, 有才干的人, 天资
democrat|民主人士, 民主主义者, 民主党党员; 民主党
stake|桩, 炮烙刑, 木柱, 赌注, 奖金;vt. 打桩, 用桩撑, 下赌注, 资助;vi. 打赌
economics|经济学; 经济学
refugee|难民, 流亡者; 避难者, 流亡者, 难民
summit|顶点, 最高阶层, 最高级会议;a. 政府首脑的, 最高级的
deficit|赤字, 不足额; 短缺
album|粘贴簿, 唱片套; 白色物
sixth|第六, 六分之一
maker|制造者, 上帝; 制造者, 出票人
inspire|使感动, 激发, 启示, 吸入, 鼓舞, 产生, 使生灵感;vi. 吸入, 赋予灵感
correspondent|通讯记者, 通信者; 客户, 代理商行, 代理银行
voter|选民, 投票人; 选民, 选举人, 投票人
rebel|叛徒, 反叛者;vi. 造反, 反抗, 抵抗, 反感;a. 造反的, 反抗的
airline|航线, 航线的设备, 航空公司
eighteenth|第十八, 十八分之一
reporter|记者, 报告者; 指示器
allege|宣称, 主张, 提出, 断言; 断言, 指称, 指证
analyst|分析者, 精神分析学家; 分析员; 化验员
AIDS|爱滋病(获得性免疫缺陷综合征); 高级综合数据系统, 先进交互调试系统, 自动图解文档编制系统;美国决策学学会, 信息自动显示系统, 自动综合调试系统
twentieth|第二十, 二十分之一
republican|共和主义者, 共和党员;a. 共和政体的, 共和国的, 共和主义的
sterling|英国货币, 标准纯银;a. 英国货币的, 标准纯银的, 含标准成分的
sanction|核准, 制裁, 处罚, 约束力;vt. 制定制裁规则, 认可, 核准, 同意
gay|欢快的, 艳丽的, 快乐的, 放荡的
seventh|第七, 七分之一
eighth|第八, 八分之一
...
reporting|报道; 报告, 汇报
tenth|第十, 十分之一
hostage|人质, 抵押品; 人质, 抵押品
accepted|公认的, 一般承认的; 已承兑, 已认付
ninth|第九, 九分之一
...
caption|说明, 字幕, 标题;vt. 加上标题, 加上说明; 标题
fiftieth|第五十, 五十分之一
thirtieth|第三十, 三十分之一
Christian|基督徒, 正派人;a. 基督的, 基督教的
fortieth|第四十, 四十分之一
millionth|第一百万的, 百万分之一的;n. 第一百万, 百万分之一
eightieth|第八十, 八十分之一
sixtieth|第六十, 六十分之一
seventieth|第七十, 七十分之一
ninetieth|第九十, 九十分之一
aren't|不是（are not）
gone|离去的, 死去的, 用完的;go的过去分词
hadn't|had not 没有
hasn't|=has not
haven't|=have not
he'd|他将, 他会, 他已经, 他有
let's|let us 让我们
she'd|she had 她已经; she would 她可以
she's|she has 她（已经）; she is 她是
they'd|(=they had, they would)厚皮的
they'll|they will 他们将
they've|they have 他们曾经
tion|象征式互动;支票电托收
we'll|(we shall或 we will 的常用口语形式)
weren't|不是
what's|（尤当 has 为助动词时, what is 或 what has 的常用口语形式）; 乌
who's|who is 谁是…
provision|(政府提供的)钱和设备, 准备, 供应品, 规定, 条款;vt. 供给...食物及必需品
prime|最佳部分, 初期, 全盛期;a. 主要的, 最初的, 根本的;v. 加油启动, 灌注, 填装
species|种, 类, 外形; 茶剂; 种
existing|存在的, 目前的, 现存的, 现有的; 现成的, 已有的, 现存的
etc|及其他, 等等
legislation|立法, 法律; 立法, 法规
consist|组成, 存在于, 一致
ought|应该, 大概;n. 责任
enterprise|企业, 事业心, 进取心, 干事业; 企业
nod|点头, 打盹, 晃动;vi. 点头, 打盹;vt. 点头表示, 点(头)
assembly|与会者, 集会, 装配, 组件; 装配
solicitor|(英)律师, 初级律师, (美)法务官, (美)掮客, 游说者, (美)募捐者; 募损者, 律师
component|元件, 组件, 成分;a. 组成的, 构成的; 组件
assumption|假定, 自负, 担任, 假装; 假定, 承担
gallery|走廊, 最高楼座, 画廊, 收集, 图库; 图库
rely|信赖, 依赖, 信任
bloody|血腥的, 嗜杀的, 有血的
revenue|收入, 岁入, 税收, 税务局; 岁入, 税收, 税务局
anybody|任何人;n. 重要人物
mechanism|机械, 机构, 结构, 机理, 技巧; 机理; 历程; 机构
welfare|福利, 安宁, 幸福, 福利事业;a. 福利的
establishment|确立, 制定, 设施; 企业, 公司, 商店
being|存在, 性质, 生命, 人, 生物, be的现在分词
outcome|结果, 出口
notion|概念, 观念, 想法, 打算, 别致的小东西; 概念, 打算, 想法
corporate|社团的, 合伙的, 公司的; 团体的, 法人的, 社团的
Co|钴(27号元素)
corporation|公司, 合作, 法人团体; 法人团体, 社团, 法人
subsequent|后来的, 接下去的; 后来的
parliamentary|国会的, 议会的, 议会制度的
mill|压榨机, 磨坊, 制造厂;vt. 碾磨, 磨细, 搅拌, 使乱转;vi. 乱转, 被碾磨
constitution|构成, 宪法, 体格; 体质; 结构, 组织
implement|工具, 器具, 手段;vt. 实现, 使生效, 执行
gene|基因; 基因(遗传因子)
agricultural|农业的; 农业的, 耕作的
regime|政权, 当权期间, 政体, 社会制度, 体制, 情态; 制度, 生活制度
glance|一瞥, 闪光, 掠过, 辉矿类;vi. 扫视, 闪光, 掠过, 提到, 略说;vt. 扫视, 反射, 使掠过
protein|蛋白质;a. 蛋白质的
crew|全体人员, 一群人, 全体队员;crow的过去式
principal|校长, 首长, 本金, 主犯, 资本, 委托人;a. 主要的, 最重要的, 首要的
golden|金的, 含金的, 金色的, 贵重的, 繁盛的; 金制的, 金色的, 兴隆的
recovery|恢复, 复原, 痊愈, 重获; 恢复
voluntary|自动的, 自愿的, 故意的, 志愿的, 自发的;n. 自愿行动, 志愿者, 自由调
inspector|检查员, 巡视员; 检查员
agriculture|农业; 农业, 农学
shareholder|股东; 股东, 股票持有人
penalty|处罚, 刑罚, 罚款, 罚球, 报应, 不利结果, 妨碍; 罚金(款), 违约金
perspective|远景, 透视感, (观察问题的)视角, 透视法, 看法, 透视图;a. 透视的, 透视法的; 透视
judgment|裁判, 宣告, 判决书; 判断
symptom|症状, 征候, 征兆; 症状
alliance|联盟, 联合; 同盟, 联盟, 联姻
comprehensive|广泛的, 有理解力的, 综合的; 广泛的, 综合的, 全面的
dealer|经销商, 商人; 交易员, 贩卖商
lad|青年, 家伙, 少年, 情人
policeman|警察; 淀帚
tale|故事, 谎言, 谣言, 陈述, 叙述; 虚语, 诽语, 谣言
cricket|蟋蟀, 板球
golf|高尔夫球;vi. 打高尔夫球
literary|文学的, 文艺的, 精通文学的; 文学的, 从事文学的, 从事写作的
guitar|吉他
sake|目的, 缘故, 理由
circuit|电路, 环(行)道, 巡回; 线路; 电路
demonstration|示范, 实证; 示教, 实物教授
resign|辞职, 放弃, 使顺从;vi. 辞职, 屈从
adviser|顾问, 劝告者, 指导教师; 顾问, 劝告者
personnel|人员, 人事部门, 人事科(处); 人事, 全体人员, 职工
classical|古典的, 正统派的, 经典的; 古典的; 标准的, 典型的
province|省, 地方, 职权, 领域; 省, 地方, 领域
acquisition|获得, 获得物; 收购, 招揽, 取得
socialist|社会主义者, 社会党党员; 社会主义的
occupation|职业, 占有, 占有期, 占领, 占领军; 占有, 占用, 职业
catholic|天主教徒;a. 天主教的, 普遍的, 广泛的, 宽宏大量的
numerous|很多的, 数目众多的, 多数的; 多数的, 甚多的
consultant|顾问, 征询意见者; 顾问医师
percentage|百分比, 比率, 部分, 可能性; 百分比
compensation|补偿, 赔偿金, 工资; 代偿(机能), 补偿
poet|诗人
earnings|所赚的钱, 工资, 收入; 工资, 收入, 收益, 盈余
widespread|充分伸展的, 广布的, 普及的, 流传广的
observer|观察者, 遵守者, 观察员; 观察者, 观察员, 监场员
given|赠予的, 沉溺的, 约定的;give的过去分词
poverty|贫穷, 贫困, 缺乏; 贫乏, 缺乏
enhance|提高, 加强, 增加
consistent|一致的, 坚持的, 并立的, 坚固的
ownership|所有权, 物主身份; 所有权, 所有制
burden|负担, 重载, 担子, 责任;vt. 装货于, 烦扰, 使负担
operator|操作员, 行家, 经纪人, 算子, 运算符; 运算符
strengthen|加强, 变坚固;vi. 变强, 股票上涨
publisher|出版者, 发行人; 发行人, 出版者, 报刊发行者
dominant|占优势的, 支配的; 优性的, 显性的
strategic|战略的, 战略上的; 战略的
childhood|孩童时期; 儿童期
merchant|商人, 店主;a. 商业的, 商人的
designer|设计者, 谋划者, 制图者; 设计员
fabric|织物, 布, 结构, 构造, 建筑物; 组织, 建筑物, 工厂
sustain|承受, 支持, 供养, 继续, 忍受, 蒙受, 证实, 准许; 持续
vessel|船, 容器, 脉管; 管, 脉管, (容)器
participate|参加, 分享, 参与, 带有;vt. 分享, 分担
tissue|薄的织物, 薄纱, 棉纸, 组织, 一套; 组织
rugby|橄榄球, 橄榄球赛
unity|一致, 联合, 单一(性), 个体; 统一
squad|班, 小队, 小集团;vt. 编成班
profile|侧面, 轮廓, 传略;vt. 描绘...轮廓, 写...的传略; 提问档; 剖面图法; 剖面法
headquarters|总部, 司令部, 总部人员; 本部, 总部, 总署
announcement|公告, 发表, 告知; 通告, 布告, 公告
surgery|外科, 手术, 手术室, 换球术
psychological|心理学的, 精神上的, 心灵的; 心理上的, 心理学的
conviction|定罪, 信服, 坚信; 定罪, 证明有罪, 判罪
snap|使突然中断, 猛咬, 争夺, 拉断, 使有啪啪声, 厉声说, 突然射击, 用快照拍摄;vi. 咬, 扑, 抓, 折断, 劈啪地响, 厉声说, 砰然关上;n. 猛咬, 猛扑, 劈啪声, 申斥, 快照, 活力, 一般时期的寒…
tennis|网球
monetary|货币的, 金钱的; 货币的, 金融的
amendment|修订, 改善, 改良, 改正; 调理剂; 修正
pit|深坑, 矿井, 果核, 地窖, 深渊, 绝境, 陷阱;vt. 窖藏, 使凹下, 使有麻点, 去...之核, 使留疤痕, 使相斗, 使竞争;vi. 起凹点, 凹陷
gesture|手势, 姿态;vi. 作手势, 作姿态
treasury|国库, 宝库, 财政部, 国库券; 库存, 国库, 金库
detective|侦探;a. 侦探的
transition|转变, 转换, 变迁, 过渡时期, 临时转调; 跃迁
occasional|偶然的, 临时的; 偶然的, 特殊场合的
lower|低的, 下级的, 下层的;vi. 降低, 跌落, 减弱;vt. 放下, 降下, 减弱, 贬低
passion|激情, 酷爱, 热爱, 强烈感情, 耶稣受难(故事)
folk|人们, 家人, 亲属, 民族;a. 民间的
margin|页边的空白, 边缘, 界限, 余裕, 差数, 差额, 保证金;vt. 加边于, 加旁注于; 页边距
fulfil|实践, 履行, 实行, 完成, 结束, 满足; 履行(契约), 满期
assault|攻击, 袭击;vt. 袭击, 攻击;vi. 发动攻击
seize|抓住, 逮捕, 俘获, 没收, 扣押, 掌握;vi. 突然抓住, 利用
psychology|心理学, 心理状态; 心理学
opera|歌剧
consciousness|意识, 知觉, 自觉; (有)意识, 清醒
overseas|海外的, 国外的;adv. 在海外, 在国外
cite|引用, 引证, 表彰; 引证, 指引
coalition|结合体, 结合, 联合; 联合, 联盟
vulnerable|易受伤害的, 有弱点的, 易受影响的, 脆弱的, 成局的; 易损的
volunteer|志愿者;a. 志愿的;v. 自愿
sophisticated|复杂的, 久经世故的; 尖端的, 高级的, 非常有经验的
agenda|议程, 日常工作事项; 待议事件
creative|有创造力的, 创作的, 产生的
exploit|功绩, 勋绩;vt. 开发, 利用, 开拓, 剥削
intellectual|有知识者, 知识分子, 凭理智做事者;a. 智力的, 用脑力的, 聪明的
lease|租约, 租期, 租;vt. 出租, 租出, 租得
portrait|肖像, 人像, 半身像, 描写, 竖排格式; 纵向
jury|陪审团, 评判委员会;a. 应急的
dividend|被除数, 股利; 被除数
carbon|碳, 副本, 复写纸; 碳
charter|特许状, 执照, 宪章;vt. 特许, 发给特许执照
sigh|叹息;vi. 叹息, 渴望;vt. 叹息着说
eliminate|除去, 排除, 剔除, 消除
wipe|擦拭, 用力打, 凸轮;vt. 擦, 揩, 消灭, 涂上, 拭去;vi. 擦, 打
depression|不景气, 消沉, 沮丧, 洼地; 抑郁;, 阻抑, 压低, 凹, 窝, 衰退, 俯角
suspend|悬, 吊, 使悬浮, 暂停, 中止, 推迟;vi. 暂停, 中止, 悬浮, 停止偿付债务; 暂停
commissioner|委员, 理事, 行政长官; 委员, 政府的特派员, 地方地官
flexible|易曲的, 灵活的, 柔顺的, 能变形的, 可通融的; 能屈的
compose|组成, 写作, 作曲, 使平静;vi. 创作, 排字; 编写
collective|集体的, 聚集的, 共同的; 集体的, 集合的
commander|司令官, 指挥官
native|本地人, 土产, 当地人;a. 本国的, 与生俱来的, 自然的
exposure|暴露, 揭发, 揭露; 曝光量; 照射; 照射量
resignation|辞职, 辞呈, 听从; 辞职
revolutionary|革命者, 革命党人;a. 革命的, 革命性的
modest|谦逊的, 羞怯的, 端庄的, 适度的; 适当的
fate|命运, 运气;vt. 注定
barely|几乎不
bare|赤裸的, 缺少的, 无遮蔽的, 坦率的;vt. 使赤裸, 露出
gross|总数, 总量;a. 总共的, 未打折扣的, 恶劣的, 粗野的;vt. 总共收入
intense|非常的, 强烈的, 紧张的, 热情的; 强的
withdrawal|提款, 撤退, 退回, 撤消, 退隐, 戒毒过程; 戒除, 脱瘾
prominent|卓越的, 显著的, 突出的, 凸出的
condemn|判刑, 责备, 谴责; 定罪, 判刑, 宣告有罪
declaration|宣告, 说明, 宣布; 说明
historic|历史上著名的, 有历史性的
bike|自行车, 脚踏车
youngster|小孩, 年轻人, 少年; 儿童, 少年, 青年
ethnic|人种的, 种族的; 人种的
federation|联邦, 联合, 联盟; 联邦, 联盟, 联邦政府
molecule|分子, 些微; 分子
reliable|可靠的, 可信赖的; 可靠的, 可信赖的, 确实的
tide|潮, 潮汐, 趋势, 潮流, 涨潮, 高潮;vt. 使随潮漂流;vi. 顺潮行驶
acre|英亩
clinic|诊所, 临床教学; 诊所(门诊部); 临床(讲解); 临床(学)科
mutual|相互的, 共有的; 相互的
Jew|犹太人, 守财奴, 犹太教信徒;vt. 欺骗, 杀价
era|时代, 纪元, 时期
laughter|笑, 笑声; 笑, 大笑
satellite|人造卫星; 伴行静脉, 陪静脉, 陪病部, 随体, 卫星
competitor|竞争者; 竞争者, 竞争对手
yield|生产量, 投资收益;vt. 出产, 给予, 让出, 放弃, 使屈服;vi. 出产, 屈服, 投降, 倒塌
coverage|覆盖的范围, 保险总额, 新闻报导; 可达范围; 覆盖度
miner|矿工, 开矿机, 坑道工兵; 矿工
integrate|综合, 使完整, 使成整体;vi. 成一体;a. 完整的, 完全的
ruling|判决, 裁定, 统治;a. 统治的, 支配的, 普遍的
equity|公平, 公正; 权益, 产权
electoral|选举人的, 选举的, (有关)选举的; 选举的, 选举人的, 由选举人组成的
grip|紧握, 柄, 握力, 握手方式, 手提包, 掌握, 支配, 控制;vt. 抓紧, 抱住, 吸住, 掌握;vi. 握牢, 有吸引力
marked|有记号的, 显著的, 醒目的; 有记号的; 显著的
superb|极度的, 华丽的, 极好的
await|等候;vi. 等待着
shortage|不足, 缺乏; 缺额
undermine|在...下面挖, 渐渐破坏, 暗地里破坏; 暗中破坏, 以阴谋中伤伤害
flee|逃避, 逃跑, 逃走;vi. 逃, 消失
myth|神话, 虚构的事, 虚构的人
invasion|侵犯, 侵入, 侵害; 侵袭, 侵入, 发病
fleet|舰队, 港湾, 小河;a. 快速的, 敏捷的, 浅的, 短暂的;adv. 浅;vi. 疾驰, 飞逝, 掠过;vt. 消磨, 变换船(或船员)的位置
crystal|水晶, 水晶装饰品, 结晶;a. 水晶的, 水晶一样的, 透明的
leap|跳跃, 剧增, 急变, 被越过之物;vi. 跳跃, 突然经过;vt. 跃过, 使跃过
raid|袭击, 突袭, 搜捕;v. 奇袭, 搜捕; 廉价磁盘冗余阵列
therapy|治疗; 疗法, 治疗
controversial|争论的, 论争的, 被议论的
banking|银行业务; 银行业, 银行事务
temple|圣堂, 庙宇, 教堂, 礼拜堂, 太阳穴, 鬓角; 颞颥, 颞部
allegation|断言, 主张, 申辩; 声明, 事实陈述, 断言
controversy|论争, 辩论, 论战, 争论; 论战, 争论, 争吵
merger|合并, 归并; 购并
tournament|比赛, 竞赛, 锦标赛, 联赛
hint|暗示, 提示;v. 暗示, 示意
recruit|新兵, 新手, 新会员, 补给品;vt. 恢复, 补充, 充实, 征募;vi. 征募新兵, 复原, 得到补充
tremendous|巨大的, 非常的, 可怕的
fade|褪色, 消失, 凋谢;vt. 使褪色;n. 淡入, 淡出;a. 平淡的
tragedy|悲剧, 惨案, 悲剧作品; 惨事, 灾难, 不辛
rape|抢夺, 掠夺, 强奸, 葡萄渣, 芸苔;vt. 掠夺, 抢夺, 强奸
reluctant|不情愿的, 勉强的; 不愿的, 勉强的, 难以处理的
echo|回声, 回音, 回波;vi. 发回声, 随声附和;vt. 摹仿, 重复, 反射; 回显; DOS批处理命令:控制MS-DOS命令是否在屏幕上显示
shore|海岸, 海滨, 斜撑柱;vt. 把...送上岸, 支撑, 支持
drift|漂流物, 漂流, 动向;v. (使)漂流
harbour|港, 避难所;v. 庇护, 藏匿, (使)入港停泊
triumph|凯旋, 胜利, 欢欣;vi. 得胜, 成功
testing|测试;a. 吃力的, 试验的
gang|队, 群, 帮;vi. 成群结队, 结成一伙;vt. 使成群结队
provoke|激怒, 惹起, 诱导; 刺激, 煽动, 激怒
stimulate|刺激, 激励, 鼓舞;vi. 起刺激作用
colonel|陆军上校, 长官
diplomatic|外交的, 老练的; 外交的, 外交上的, 文献上的
marine|舰队, 水兵, 海景画;a. 海的, 海产的, 海底的, 船舶的, 海运的
retail|零售;a. 零售的;vt. 零售, 详述, 传播;vi. 零售
liberty|自由, 特权, 许可, 冒失; 自由, 自由权, 自由区域
carrier|运送者, 邮递员, 带菌者; 载波
fantasy|幻想, 想象的产物; 幻想
spectacular|公开展示的, 惊人的, 壮观的;n. 奇观, 惊人之举, 展览物
monthly|月刊;a. 每月的, 每月一次的
dialogue|对话;vi. 对话;vt. 用对话表达
suicide|自杀, 自杀者;v. 自杀;a. 自杀的
fraud|欺骗, 欺诈, 诡计, 骗子; 欺诈, 舞弊, 骗子
fool|愚人, 受骗者, 奶油拌水果;vt. 愚弄, 欺骗, 浪费;vi. 干傻事, 开玩笑, 游荡;a. 傻的
compromise|妥协, 折中, 折中方案, 和解;vi. 妥协处理;vt. 危害
killer|(非正式)杀人者, 屠杀者, 猛兽, 致死(疾病), 杀手, 止痛药, 限制器, 瞄准器; 删除程序; 断路器
graduate|毕业生, 量杯;a. 已得学位的, 研究生的, 毕业的;vi. 毕业, 得学位, 逐渐变为;vt. 准予...毕业, 授予...学位, 分等级, 刻刻度
execute|执行, 实行, 完成, 处死, 制成; 执行
delegate|代表;vt. 委派...为代表
premium|额外补贴, 奖金, 奖赏, 保险费; 保险费
missile|发射物, 导弹, 飞弹, 火箭;a. 可发射的
associated|联合的; 关联的; 结合的
panic|恐慌, 惊慌;a. 惊慌的, 没有理由的, 恐慌的;vt. 使惊慌, 使狂热;vi. 惊慌
bean|豆子; 油嘴; 豆
riot|暴动, 喧闹, 放纵;vi. 发动, 暴动, 纵情, 放荡;vt. 浪费, 挥霍
nightmare|梦魇, 恶梦, 可怕的事物(或情景、人物); 梦魇, 恶梦
teenager|十三岁到十九岁的少年
scandal|丑闻, 中伤, 耻辱, 反感, 流言蜚语; 丑事, 丑闻, 干丑事的人
instruct|教, 教育, 命令, 通知; 托办, 指导, 指示
tactic|一项战术, 一条策略;a. 战术的, 顺序的, 排列的
opt|选择
trader|商人, 商船; 交易者, 商船
concession|特许, 让步, 认可; 核准, 许可, 特殊(权)
jet|喷射流, 喷嘴, 煤玉;v. 射出, 迸出, 喷射;a. 黑而发亮的, 墨黑的
besides|除...之外;adv. 而且, 此外
concede|承认, 退让;vi. 让步
ray|光线, 射线, 闪烁, 光辉;vi. 射出光线, 浮现, 放射光线;vt. 放射, 显出
clash|冲突, 撞击声, 抵触;vi. 冲突, 抵触;vt. 使发出撞击声; 对撞
disclose|揭露, 透露; 揭发, 揭露, 公开
delegation|代表团, 派遣代表团, 代表的地位(或权力); 派遣, 委任, 委托
coup|砰然的一击, 妙计, 出乎意料的行动, 政变; 发作, 中, 击
peer|同等的人, 匹敌, 贵族;vi. 凝视, 窥视, 费力地看, 隐现;vt. 与...同等, 封为贵族
subsidy|补助金, 津贴; 补助金, 津贴, 补贴
boom|繁荣, 隆隆声;vi. 急速发展, 发隆隆声;vt. 使兴旺, 发隆隆声
deck|甲板, (汽车后部的)行李仓;vt. 装饰, 打扮, 装甲板; 纸牌背面图案
fierce|凶猛的, 猛烈的, 热烈的, 暴躁的
drain|排水沟, 消耗, 排水;vt. 排出, 喝光, 耗尽;vi. 排水, 流干
edit|编辑, 编校, 修订, 剪辑; 编辑; DOS外部命令:该命令是一个用于编辑文本文件的全屏幕编辑程序
casualty|意外事故, 伤亡, 受害者; 事故
fighter|斗士, 战士, 好战者, 战斗机
rating|等级, 额定功率, 责骂; 等级评定
venue|犯罪地点, 审判地, 发生地点
boost|推进, 吹捧;vt. 推进, 提高, 宣扬, 促进
counterpart|副本, 复本, 配对物, 相应物; 副本, 正副二份中之一
advocate|提倡者, 拥护者;vt. 主张, 提倡
interim|暂时的, 临时的, 间歇的;n. 过渡时期
premier|总理, 首相;a. 首位的, 最初的
cutting|切断, 切下, 路堑; 切屑
chaos|大混乱, 混沌; 混沌; 浑沌
script|手迹, 手稿, 正本, 手写体;vt. 改编为演出本; 手写体, 小型程序
lap|膝盖, 舔, 一圈, 下摆, 衣兜, 山坳;vi. 重叠, 围住, 轻拍, 舔;vt. 包围, 抱...在膝上, 使重叠, 舔, 拍打, 泼溅; 链接访问程序
sponsor|保证人, 赞助者, 发起者, 倡议者, 教父;vt. 发起, 赞助, 倡议
super|跑龙套角色, 冗员, 特级品, 特大号, 管理人;a. 上等的, 特大的, 超级的, 极好的, 十分的, 过分的;adv. 非常
helicopter|直升机;vt. 由直升机运送;vi. 乘直升机
cave|洞, 穴;vi. 凹陷, 塌落;vt. 挖洞, 使凹陷, 损坏...的基础
verdict|裁决, 判决, 判断性意见, 定论, 结论; 定论, 判断, 意见
commerce|商业, 商务, 贸易; 商业, 贸易, 商务
medal|奖牌, 勋章;vt. 授勋予
broadcasting|广播; 广播
rally|重振旗鼓, 集合, 群众集会, 跌停回升;v. 重整旗鼓, 集合, 恢复精神, 团结, 挖苦, 嘲笑
debut|初次登台, 开张;v. 初次登台
inspect|检查, 检阅, 检验;vi. 检查
mask|面具, 假面具, 掩饰, 石膏面模;vt. 戴面具, 掩饰, 使模糊;vi. 化装, 戴面具, 掩饰, 参加化装舞会; 屏蔽; 掩码
pump|抽水机, 打气筒, 泵, 抽吸;vt. 用唧筒抽水, 打气, 盘问, 倾注, 使疲惫;vi. 抽水, 上下(或往复)运动
trail|踪迹, 痕迹, 一串, 尾部, 小径, 持枪姿势;vt. 拖, 尾随, 追踪, 落后于, 开出路;vi. 拖曳, 垂下, 落后, 飘出, 蔓生
banker|银行家, 庄家; 银行业者, 银行家
abortion|流产, 堕胎, 失败, 夭折, 中止; 流产, 小产; 顿挫
corruption|腐败, 堕落, 贪污; 论误
halt|停止, 立定, 休息;vt. 使停止, 使立定;vi. 立定, 停止, 蹒跚, 踌躇, 有缺点; 停止
auction|拍卖;vt. 拍卖
naval|海军的, 军舰的, 有舰队的; 海军的, 军舰的, 船的
embassy|大使馆, 大使馆全体人员; 大使馆
terrorist|恐怖分子; 恐怖份子, 恐怖主义
segment|片段, 部分, 分节, 段;v. 分割, 分裂; 段
takeover|接管, 接收; 接收
referendum|（就重大政治或社会问题进行的）全民公决，全民投票
weaken|削弱, 减弱, 使虚弱;vi. 变弱, 变软弱
barrel|桶;vt. 装入桶内
shed|车棚, 小屋, 脱落之物, 分水岭;vt. 使流出, 放射, 脱落, 散发, 摆脱;vi. 流出, 散布, 脱落
fare|费用, 旅客, 食物;vi. 进展, 进步, 经营, 过活
headline|大标题, 新闻摘要;vt. 为...做标题, 写标题
eager|热心的, 渴望的, 热望的
overwhelming|压倒性的, 无法抵抗的
stem|茎, 干, 柄, 船首, 血统, 堵塞物;vt. 摘掉茎, 装柄于, 阻止, 堵住, 逆行;vi. 堵住, 逆行
plunge|钻进, 跳进, 跳水, 跳水池, 猛跌, 落下, 投入, 开始从事, 盲目投资;vi. 投入, 投身于, 跳进, 陷入, 下降;vt. 使投入, 使插入, 使陷入, 使遭受
excess|过度, 剩于, 超过, 超额;a. 过量的, 额外的
moderate|适度的, 稳健的, 中等的, 节制的;vt. 节制, 减轻, 使缓和;vi. 变缓和, 主持会议
racial|人种的, 种族的; 种族的
ambassador|大使; 大使, 使节, 代理
yacht|快艇, 游艇;vi. 驾游艇, 乘游艇
faction|小派系, 内讧; 宗派, 派别, 小集团
commentator|评论员, 实况广播员, 注释者, 时事评论员
wicket|小门, 腰门, 售票窗
forth|往前, 以后, 向外
slim|瘦的, 苗条的, 微小的, 稀少的, 微薄的;vi. 变苗条;vt. 使苗条
offering|提供, 奉献物, 牲礼, 上市的股票(或证券等); 出售物
bat|蝙蝠, 球棒;v. 用球棒打, 眨眼; 成批
surplus|剩余, 过剩, 盈余;a. 过剩的, 剩余的
actress|女演员
rage|愤怒, 情绪激动, 狂暴;vi. 大怒, 狂吹, 流行
convict|囚犯, 罪犯;vt. 宣告有罪, 使知罪
vitamin|维生素; 维生素
fiscal|财政的, 国库的; 财政上的, 会计的, 国库的
soccer|英式足球
Islamic|伊斯兰教的, 穆斯林的
guerrilla|游击队
renew|使更新, 使恢复, 复兴, 修补, 补充, 继续, 重订, 重申, 续借;vi. 更新, 重新开始
foreigner|外国人, 外地人; 外国人, 进口货, 外国货
overnight|前一天晚上, 一夜的逗留;a. 通宵的, 晚上的, 前夜的;adv. 在前一夜, 整夜, 昨晚一晚上
instant|立即, 瞬间;a. 紧急的, 立即的, 即时的
incredible|难以置信的
exhaust|排气, 排气装置, 废气;vt. 抽完, 用尽, 耗尽, 使精疲力尽;vi. 排气
trigger|触发器, 扳机;vt. 触发, 发射, 引起;vi. 松开扳柄; 切换开关
alert|警觉的, 灵敏的, 留心的;n. 警报;vt. 使警觉, 通知, 使意识到
confrontation|对抗;对质;面对
backing|后退, 衬背, 后援, 支持者; 衬垫
amateur|业余爱好者, 外行, 爱好者; 业余家
surrender|交出, 放弃, 使投降, 让与;vi. 投降, 自首;n. 交出, 放弃, 投降
civilian|平民, 民法专家;a. 平民的, 百姓的, 民用的
spur|马刺, 刺激物, 鼓舞;vt. 刺激, 激励, 用马刺策(马)前进;vi. 用马刺驱马, 疾驰
motivate|给与动机, 刺激, 提高...的学习欲望, 促动; 促动, 激发, 激励
cheer|愉快, 振奋, 欢呼;vi. 欢呼, 喝彩, 快活起来;vt. 使振奋, 欢呼
jail|监牢, 监狱, 拘留所;vt. 监禁, 下狱
exile|放逐, 流放, 被放逐者;vt. 放逐, 流放, 使背井离乡
worldwide|全世界的
pact|契约, 协定, 条约; 合同
presidency|总统职权, 总裁职位
luxury|奢侈, 豪华;a. 奢侈的, 豪华的
cautious|谨慎的, 小心的
homeless|无家的, 无养主的
sacrifice|牺牲, 供奉, 祭品;vt. 牺牲, 祭祀, 贱卖;vi. 献祭
deadline|最后期限, 截止期限; 截止日期
lobby|大厅, 休息室, 游说议员者;vi. 游说议员, 游说;vt. 游说
retreat|休息寓所, 撤退, 隐居, 退避;vi. 撤退, 隐退, 向后倾;vt. 退(棋)
broker|掮客, 经纪人; 经纪人, 掮客
amid|在其间, 在其中; 在...中
prosecute|告发, 起诉, 彻底进行, 执行, 从事;vi. 告发, 起诉, 作检察官
immigration|移民, 移居; 移民
ballot|投票, 投票用纸, 抽签;vi. 投票, 抽签;vt. 投票选出, 拉选票
blast|一阵风, 爆炸, 枯萎病;vt. 炸, 使枯萎;vi. 炸, 猛攻, 猛烈抨击, 枯萎
combat|争斗, 战斗;vi. 战斗, 争斗;vt. 与...战斗, 与...斗争
immune|免疫的, 免除的, 不受影响的;n. 免疫者
pledge|诺言, 保证, 誓言, 抵押, 信物, 保人, 祝愿;vt. 许诺, 保证, 使发誓, 抵押, 典当, 举杯祝...健康
jazz|爵士乐, 喧闹;a. 爵士乐的, 喧吵的;vi. 演奏爵士乐, 跳爵士舞, 游荡;vt. 奏爵士乐, 使活泼
hunter|猎人, 猎犬, 追求者
stadium|露天大型运动场; 期, 病期
leak|漏洞, 漏处, 漏出, 泄漏;vi. 漏, 泄漏;vt. 使渗漏
whip|鞭子, 抽打, 车夫, 搅拌器;vt. 鞭打, 搅拌, 煽动, 召集, 仓促制成;vi. 拍击, 急走, 抽打
rocket|火箭, 烟火;vi. 急升, 猛涨, 飞驰;vt. 用火箭运载
counsel|商议, 忠告, 法律顾问;v. 商议, 劝告
immigrant|移民;a. 移入的, 移民的
cruise|巡航, 巡弋, 漫游;v. 巡航, 巡弋, 漫游
diplomat|外交官, 有外交手腕的人; 外交家, 外交官, 有权谋的人
ski|滑雪橇;vi. 滑雪
considering|就...而论;conj. 考虑到
spark|火花, 火星, 闪光, 无线电报务员, 瞬间放电, 活力, 朝气, 花花公子, 情郎;vi. 闪光, 发火花, 求婚;vt. 发动, 鼓舞, 使有朝气, 求婚
veteran|老手, 退伍军人, 老兵, 老树;a. 老兵的, 老练的, 经验丰富的
speculate|深思, 推测, 投机; 投机
cue|提示, 线索;vt. 给...暗示(或提示); 尾接指令
antique|古董, 古物;a. 古老的, 古风的, 旧式的, 过时的
athlete|运动员, 运动选手; 运动员
ceasefire|（通常指永久性的）停火, 停战; 停火命令
caring|有同情心的;表示或感到关怀或关心的
violate|违犯, 亵渎, 违反, 侵犯, 妨碍; 违犯, 违反
opposed|反对的, 敌对的, 对抗的, 相对的; 反对的, 相反的, 对立的
jersey|运动衫
torture|拷问, 苦闷;vt. 拷问, 曲解, 折磨, 使弯曲
peg|钉, 桩, 栓, 藉口, 销子, 借口;vt. 钉木钉, 固定, 限制, 使受约束;vi. 坚持不懈地奋力于, 疾行
editorial|社论, 评论;a. 编辑的, 主笔的, 社论的
lens|透镜, 镜头, 镜片, 晶状体;vt. 给...摄影
vice|恶习, 恶行, 罪恶, 堕落, 缺陷, 恶癖, 老虎钳;vt. 钳住;prep. 代替
homosexual|同性恋的;n. 同性恋者
Islam|伊斯兰教
frustrate|挫败, 击败, 破坏;a. 无益的, 挫败的, 挫折的
Saint|圣徒, 圣人;a. 神圣的; 自动积分程序符号
militant|好战的
regulator|调整者, 校准者, 校准器, 调整器, 标准钟; 调节剂; 调节器
liberate|解放, 释放, 使自由; 释出, 放出
specialize|使特殊化, 列举, 特别指明, 限定...的范围;vi. 成为专家, 专攻
rouge|口红, 胭脂;v. 擦口红
yen|日元(日本货币单位), 渴望, 嗜好;vi. 渴望
congressional|会议的, 议会的, 国会的; 代表大会的, 大会的, 议会的
harass|使困扰, 使烦恼, 折磨
assured|确定的, 自信的; 被保险人, 被保证者, 投保人
beaten|被打败了的, 筋疲力竭的, 敲平的, 踏平的;beat的过去分词
reel|卷轴, 一卷, 纺车, 旋转, 蹒跚;vt. 卷...于轴上, 绕, 使旋转;vi. 蹒跚地走, 旋转, 眩晕, 摇晃, 退缩; 卷; 盘
baseball|棒球; 棒球系统
calculated|有计划的, 适当的, 适合的, 计算出的; 算清了的
unidentified|未被认出的, 未经确认的
auto|汽车;pref. 表示"自己"、"本身", 表示"自己的", 表示"自动的"
roach|斜齿鳊;vt. 使成凹状
statistic|统计量;a. 统计的, 统计学的
privatize|vi. 私有化
noted|著名的, 显著的, 扬名的
excerpt|摘录;v. 引用, 摘录
appal|使惊骇, 使吓坏
activism|激进主义, 行动主义, 能动论; 激进主义, 行动主义
victimize|使牺牲, 使受害; 使受害, 使作牺牲, 欺骗
done|完成了的, 好了的;do的过去分词
o'clock|...点钟, 钟头
ahead of|在…之前
air force|空军, 美国航空队
...
Third World|第三世界
we'd|we had 我们已; we should 我们应
world war|世界大战
undertake|试图, 从事, 保证, 承担, 同意, 接受; 承包; 承担
jack|插座, 千斤顶, 男人;vt. 抬起, 提醒, 扛举, 增加, 提高, 放弃;a. 雄的; 插座
expenditure|开支, 费用, 用光, 消费额; 支出, 费用, 消费
sequence|序列, 续发事件, 顺序, 连续;vt. 按顺序排好; 顺序
curriculum|课程; 课程, 学程
representation|表示法, 表现, 陈述, 代表; 表示法指定
creation|创造, 创作物, 发明; 产生
distinction|区别
external|外部, 外面;a. 外部的, 客观的, 表面的
clause|子句, 条款; 子句
defendant|被告; 被告方
bind|绑, 约束, 装订, 包扎, 使结合;vi. 凝固, 有约束力; 赋值, 绑定
liability|责任, 债务, 倾向; 责任, 义务, 负债
significance|重要性, 意义, 意味; 有效; 有效性
Christ|基督, 救世主
parish|教区, 堂区; 救贫区, 教区
China|中国, 瓷器;a. 中国的
ooh|（表示惊异、热心、高兴或不悦的叫声）哦！
amongst|在...当中, 在...之间, 在...之中
finding|发现, 发现物, 决定, 裁决; 调查结果, 对事实的认定, 判定的要素
councillor|地方议会成员, 议会委员, 顾问, 评议员, 参赞; 议员, 评议员, 顾问
tenant|承租人, 房客, 居住者;vt. 租借; 占据者
Jan|一月
boundary|边界, 分界线; 边界
formation|形成, 构造, 编队; 形成, 结构
kingdom|王国, 领域; 界(动物,植物,矿物)
incorporate|合并的, 组成公司的, 一体化的;vt. 吸收, 合并, 使组成公司, 体现;vi. 合并, 混合, 组成公司
proceeding|进行, 程序, 行动, 诉讼程序, 事项; 会议论文集
premise|前提, 房屋连地基, 上述各项;vt. 预先提出, 引出, 作为...的前提;vi. 作出前提
framework|结构, 骨架, 参照标准, 准则, 观点; 构架组织
obligation|义务, 责任, 约束, 契约, 恩惠, 债务; 待付款, 债务, 义务
setting|环境, 背景, 布景, 镶嵌, 调整, 沉落, 一副餐具; 设置
maintenance|维护, 保持, 维修, 生活费用, 坚持, 扶养; 维护; 维修
bob|剪短, 敲击;vi. 振动, 上下跳动;n. 短发, 悬挂的饰品, 浮子, 摆动, 轻敲, 5便士
mode|模态, 调式, 样式, 文体, 状态, 方式, 风尚; 方式; DOS外部命令:设定各种设备命令
specify|详列, 指定, 说明; 指定
submit|使服从, 使受到, 委托, 提交, 认为;vi. 屈服, 服从
constitute|构成, 组成, 任命; 构造, 组成
input|输入, 输入电路;vt. 输入; 输入
efficiency|效率, 效能, 功效; 效率, 效力
frank|坦白的, 率直的, 老实的;vt. 免费邮寄;n. 免费邮寄特权
statutory|法令的, 法定的, 可依法惩处的; 法定的
ratio|比, 比率; 比, 比率, 比例
PC|个人计算机; 外部控制, 个人计算机, 光电导体, 伪码
variable|易变的事物, 变数, 可变物, 变量;a. 可变的, 不定的, 易变的, 变量的; 变量
phenomenon|现象, 迹象, 表现, 奇迹, 奇才; 现象
frequency|频率, 频数; 频率
landlord|房东, 地主; 业主, 地主, 房东
administrative|管理的, 行政的; 行政的, 管理的, 遗产管理的
breach|裂口, 违背, 破坏, 违反, 突破, 破裂;vt. 攻破, 突破;vi. 跳出水面
equation|相等, 等式, 平衡; 方程式; 等式; 反应式; 公式
eh|啊!嗯!是吗?好吗?; 氧化还原电位
allowance|津贴, 零用钱, 限额, 折扣, 允许;vt. 定量供应
scope|范围, 机会, 广度, 眼界, 观察仪器, 导弹射程; 作用域
paragraph|段落, 短评;vt. 将...分段, 分段落;vi. 写短讯; 段落
detect|发现, 察觉, 探测; 发现, 查明, 探测
consent|同意, 许可;vi. 同意, 赞同
comprise|包含, 构成
visual|视觉的; 视觉的, 视力的, 视觉性记忆优势者
DNA|脱氧核糖核酸; 无效数据, 数字网络体系结构, 分布式网络体系结构
perception|知觉, 感觉, 领悟力, 获取; 知觉
differ|不一致, 不同; 差异, 不同
consumption|消费, 消费量, 痨病; 消耗量; 耗量
peasant|农夫, 乡下人
workshop|工场, 车间, 研讨会; 讨论会; 专题研究组
guidance|指导, 领导; 导
distinct|清楚的, 显著的, 不同的
supplier|供应者, 供给国, 供应商; 承制厂; 供应厂商
respectively|各自地, 独自地, 个别地, 分别地
developing|发展中的; 显影
practitioner|从业者, 开业者; 行医者, 医师
dimension|尺寸, 次元, 面积, 维数;vt. 标出尺寸
storage|存储器, 储藏, 保管, 库存, 仓库; 存放处; 存储
catalogue|目录, 大学情况一览;vt. 编入目录
architecture|建筑学, 建筑式样; 体系结构
exceed|超过, 超越, 胜过;vi. 超过其他
historian|历史学家, 记事者
clinical|临床的, 门诊部的; 临床的, 临证的
theoretical|理论的, 理论上的, 假设的, 推理的; 理论的
distant|远的, 疏远的; 远期的
leisure|空闲, 闲暇, 悠闲;a. 空闲的, 有闲的
admission|准许进入, 入场费, 录用, 承认; 加入, 入股
perceive|感觉, 认知, 理解, 意识到
secondly|第二, 其次
residential|住宅的, 与居住有关的; 有关居住的, 房产的:居所的, 适于居住的
turnover|翻倒, 翻转, 半圆酥饼, 营业额, 流通, 周转;a. 可翻转的
nick|刻痕, 缺口, 划痕;vt. 刻痕于, 弄缺, 擦伤;vi. 狙击
furthermore|此外, 而且
Aug|八月（August）
corridor|走廊, 回廊, 人口密集地带
reinforce|加强, 增援, 补充;vi. 求援, 得到增援;n. 加固材料
magistrate|长官, 法官, 推事; 司法行政官, 治安法官, 地方法官
readily|迅速地, 轻易地, 乐意地
sergeant|警察小队长, 军士
participant|参加者, 参与者;a. 有份的, 参加的, 参与的
shrug|耸肩;v. 耸肩
architect|建筑师, 设计者, 缔造者
cathedral|大教堂
acceptance|接受, 接纳, 承认, 同意, 赞同, 容忍, 相信; 承兑, 认付, (工程)验收
limitation|限制, 缺陷, 限额; 限界, 限制, 限度
thereby|因此
constituency|选民, 顾客, 读者; 选区, 全体选民, 选区内的选民
structural|结构的, 建筑的; 结构的
objection|异议, 反对, 不喜欢, 缺点, 缺陷, 妨碍, 拒绝之理由; 异议, 反对, 抗议
bench|长椅子; 台
infant|婴儿, 儿童, 初学者;a. 婴儿的, 幼稚的
ward|病房, 守卫, 保卫, 保护, 监护, 牢房, 行政区, 锁孔内的榫舌;vt. 使入病房, 守护, 保卫
guardian|看守者, 监护人, 保护人;a. 保护的
virtue|德行, 美德, 优点, 功效, 效力; 美德, 贞操, 优点
canal|运河, 水道, 管, 沟渠;vt. 开运河
universal|全世界的, 普遍的, 宇宙的, 通用的;n. 一般概念
timber|木材, 木料;vt. 用木材建造
cattle|牛, 家畜; 家畜
evident|显然的, 明显的
uncertainty|不确定, 不可靠, 不确定的事物; 不确定度
expertise|专家意见, 专门技术; 专门知识, 专家意见
constraint|强制, 约束; 约束
guideline|指导路线, 方针, 指标; 指导路线, 方针, 准则
privilege|特权, 特别恩典, 基本权利, 特免;vt. 给与...特权, 特免
reflection|反映, 沉思, 映像, 想法, 责难; 反射
Victorian|英国维多利亚女王时代的, 笃信宗教的, 讲究体面的;n. 维多利亚女王时代的英国人
consequently|所以
companion|朋友, 陪伴, 指南, 升降口围罩;vt. 陪伴
allocate|分派, 分配; 分配
rabbit|兔子;vi. 猎兔;vt. 让...见鬼去
patch|片, 补缀, 碎片, 斑, 傻瓜;vt. 补缀, 掩饰, 拼凑, 平息; 修补; 拼凑
medieval|中古的, 中世纪的
pray|祈祷, 恳求, 请
VAT|大桶;vt. 装入大桶, 在大桶里处理
undergo|遭受, 经历, 忍受; 经受, 经历, 忍受
disorder|杂乱, 混乱;vt. 扰乱, 使失调
evolution|进化, 发展, 进展, (气体)放出, 开方; 进化, 演化, 旋出
accounting|会计学, 帐单, 清帐; 帐户处理, 记帐
specimen|样品, 标本, 试料; 试样
closure|关闭;vt. 使终止
taxation|课税, 征税, 抽税, 税款, 估定的税额; 征税, 纳税, 税制
conservation|保护, 保存; 保存
ideology|思想体系, 意识形态, 观念学, 空论; 观念学, 观念形态
format|开本, 版式, 形式, 格式;vt. 格式化; 格式; DOS外部命令:对磁盘进行格式化
judicial|法庭的, 公正的, 审判上的, 司法的; 司法的, 审判上的, 法官的
NHS|国家医疗保健机构
carriage|马车, 客车, 举止, 运输; 搬运费, 运费
junction|连接, 会合处, 交叉点; 接;处, 接点.;界
conversion|转变, 转换, 改变宗教信仰, 换位法; 转换
imperial|帝王的, 宗主国的, 至尊的, 壮丽的;n. 特等品
assurance|保证, 把握, 信心, 保险; 保证, 担保, 保险
registration|登记, 挂号, 注册; 登记; 定位; 对齐; 记录
terrace|阶地, 梯田, 房屋之平顶, 阳台, 沿岸防地, 露台;a. 叠层式的;vt. 使成梯田, 使成有平台屋顶
rat|鼠, 卑鄙的人, 破坏者, 变节者;vi. 捕鼠, 变节;vt. 弄蓬松
experimental|实验的, 根据实验的; 实验的
borough|自治的市镇, 区
innovation|改革, 创新; 创新, 改革, 刷新
particle|颗粒, 粒子, 质点, 极小量; 粒子; 质点
notably|显著地, 著名地, 尤其, 特别
remedy|药物, 治疗法, 治疗, 补救, 赔偿;vt. 治疗, 补救, 矫正, 改善, 修补, 修缮
seller|销售者; 卖方
applicant|申请者; 申请人, 请求人, 谋事人
emperor|皇帝, 君主
evaluate|评估, 评价, 赋值
grin|露齿笑;v. 露齿而笑
audit|审计, 查帐;vt. 查(帐), 旁听;vi. 查账; 查帐; 审查; 检查
accordingly|相应地, 因此, 于是
disposal|丢掉, 处理, 排列, 销毁, 布置; 处理, 处置
fibre|纤维, 构造, 纤维制品; 纤维
inadequate|不充分的, 不适当的; 不充分的, 不适当的
devise|设计, 发明, 图谋, 遗赠给;n. 遗赠
correspond|符合, 通信, 相当; 符合, 一致, 相当
modify|修正, 变更, 修饰, 缓和, 减轻;vi. 被修改; 修改
chapel|小教堂, 礼拜式
rational|理性的, 合理的;n. 有理数
conception|观念, 概念; 妊娠, 受孕; 概念
attribute|属性, 标志, 定语;vt. 把...归于, 认为...属于; 属性
acute|尖锐的, 敏锐的, 激烈的, 严重的, 急性的; 急性的; 尖锐的
dose|剂量, 服用量;vt. 给药, (用药)医治;vi. 服药
incentive|动机;a. 激励的
stimulus|刺激, 激励, 刺激品; 刺激特, 刺激
directive|指导的, 指挥的, 方向的;n. 指令; 指令; 命令
gaze|注视, 凝视;vi. 注视, 凝视
darling|亲爱的, 可爱的人, 可爱的物;a. 可爱的, 亲爱的
identical|同一的, 恒等的, 完全相同的; 同一的, 同等的
isle|小岛, 群岛;vt. 使成为岛状;vi. 住在岛屿上
sole|脚掌, 鞋底, 底部;a. 唯一的, 仅有的, 单独的, 独身的;vt. 上鞋底, 触底
kit|装备, 工具箱, 成套工具; 成套部件; 成套零件
accountant|会计人员, 会计师; 会计师, 会计人员
satisfactory|满意的, 赎罪的; 令人满意的, 令当事人满意的, 充分的
distinctive|有特色的, 出众的
multiple|倍数, 并联;a. 多样的, 许多的, 多功能的
angel|天使, 守护神, 善人
liable|有义务的, 应负责的, 有...倾向的; 有责任的, 可受处理的, 应受罚的
insight|察看, 洞察力, 见识; 自知力, 洞察, 顿悟
greet|问候, 致敬, 欢迎, 映入眼帘
wholly|完全地, 整个, 统统, 全部; 完全地, 统统地
render|回报, 给于, 付给, 汇报, 提出, 舍弃, 反映, 表示, 表演, 致使, 执行, 实施;vi. 给予补偿;n. 交纳, 打底
disability|无力, 无能, 残疾; 劳动能力丧失, 病废
induce|引诱, 招致, 归纳出, 感应; 诱导, 感应
underlying|在下面的; 优先的, 基础的, 放在下面的
complexity|复杂, 复杂性, 复杂的事物
constable|治安官, 警官, 总管; 警察, 警官, 巡警
pond|池塘;v. 筑成池塘
namely|即, 就是, 换句话说
processor|信息处理机, 加工者, 处理者; 处理器
fragment|碎片, 破片, 片段; 段落; 片段; 分段
daddy|爸爸
marginal|边缘的, 最低限度的, 有旁注的; 缘的
murmur|低语, 低声的怨言;vi. 低语, 低声而言;vt. 低声说
sheer|绝对的, 全然的, 纯粹的, 透明的, 峻峭的;vi. 偏转, 偏航;vt. 使急转向, 使偏航;adv. 完全, 全然, 峻峭;n. 偏航
bulk|大小, 体积, 大块, 大多数;vt. 显得大, 显得重要
necessity|需要, 必需品, 必然; 必要性, 必然性, 必要
exclusive|排外的, 独占的, 唯一的; 独占的
everyday|每天的, 日常的, 平常的
nursery|托儿所, 苗圃, 温床; 婴儿室, 托儿所
encouraging|鼓励的, 促进的
overlook|俯瞰, 远眺, 没注意到;n. 眺望, 俯瞰到的景色
episode|插曲, 插话, 有趣的事件, 一段情节; 插话, 插曲, 发作
lion|狮子, 狮子(星)座, 国际狮子会会员
accommodate|使适应, 调和, 通融, 容纳, 向...提供;vi. 适应
motive|动机, 目的, 主题, 基调;a. 运动的, 成为动机的
desirable|令人想望的, 可取的
initiate|入会, 开始;a. 新加入的;vt. 开始, 传授基本知识给
bible|圣经
fiction|小说, 虚构故事; 虚构的事实, 捏造, 拟制
hardware|硬件, 五金器具, 零件; 硬件
assert|主张, 坚称, 断言; 宣称, 断言, 维护
comply|顺从, 依从; 遵守, 承诺, 照做
colony|殖民地, 移民队; 菌(集)落, 菌丛; 移民区
evolve|进展, 进化, 展开;vt. 使发展, 使推断出, 使进化
monopoly|垄断, 专卖权, 独占事业; 垄断, 专利品, 垄断(权)独占
organic|器官的, 有机的, 组织的, 根本的; 器官的, 有生命的, 有机的, 器质的
villa|别墅
tribunal|法庭, 法官席, 裁决; 法庭, 裁判所, 裁判
oral|口试;a. 口头的, 口述的, 口部的
capitalist|资本家, 资本主义者;a. 资本主义的
trustee|受托人, 理事; 委托者
statistical|统计的, 统计上的, 统计学的; 统计的, 统计学的
mutter|喃喃低语;vi. 喃喃自语, 作低沉声;vt. 出怨言, 抱怨地说
emission|发射, 射出, 发行; 发射, 遗精
clue|线索, 暗示;vt. 暗示, 提供线索
straightforward|笔直的, 率直的, 明确的, 简单的, 直接的
widow|寡妇, 孀妇;vt. 使成寡妇
attendance|出席, 出席的人数, 照料; 管理, 照料, 资助
fraction|小部分, 破片, 分数; 部分, 成分, 分散
literally|逐字地, 按照字面上地, 不夸张地
mechanical|机械的, 机械性的, 力学的; 机械的, 力学的
dock|码头, 船坞, 被告席, 尾巴的骨肉部分;vt. 使靠码头, 使(船)进港, 剪短;vi. 进港
magnificent|华丽的, 高尚的, 宏伟的
essence|实质, 本质, 香精; 香精
beg|乞求, 乞讨, 请求
landing|登陆, 码头, 降落; 上岸, 登陆, 降落
verse|诗, 韵文, 诗句;vt. 用诗表达;vi. 作诗
ghost|鬼, 灵魂, 幻影, 一丝, 一点;v. 鬼似地游荡
devil|魔鬼;vt. 折磨, 戏弄
receiver|接收器;接受者;收信机;收款员, 接待者
proposition|建议, 命题, 主张;vt. 向...提议, 向...提出猥亵的要求
theft|盗窃, 失窃, 盗窃罪, 赃物; 盗窃行为, 偷窃, 失窃
cliff|悬崖, 绝壁
champagne|香槟酒, 香槟酒色; 香槟酒
loyalty|忠贞, 忠诚, 忠实; 忠诚, 忠心
chap|小伙子, 颌, 龟裂;v. 皲裂
whereby|靠什么, 如何, 为何, 靠那个, 因此, 由此; 因此, 由是
successor|继承者, 接任者; 后继
established|(被)建立的, 固定的, 既定的, 确定的, 确认的, 确立的, (被)制定的; 确定的, 既定的
leaflet|小叶, 传单; 小叶
abbey|大修道院
heritage|遗产, 祖先遗留物, 继承物; 遗传性
indicator|指示器, 指示剂, 指标; 指示器
filter|滤波器, 过滤器, 滤光器, 过滤嘴, 去尘器;vt. 过滤, 渗透, 走漏;vi. 滤过, 渗入; 过滤器, 筛选
enforce|强迫, 执行, 坚持; 予以强制执行
restoration|恢复, 归还, 复位; 恢复, 康复, 复位, 回复, 修复
spectrum|光谱, 范围, 系列; 光谱
biological|生物学的; 生物学的
pensioner|领取抚恤金者, (英国剑桥大学的)自费生, 为金钱所收买的人, 帮佣; 领取退休金者, 领取抚恤金者
hierarchy|等级制度, 僧侣统治, 等级体系; 分级结构; 分层结构; 新闻组, 新闻组分层
discrimination|差别, 岐视, 辨别力; 鉴别
pope|罗马教皇, 主教
compound|混合物, 复合词, 化合物, 院子;a. 复合的, 混合的, 化合的;vi. 化合, 和解, 妥协;vt. 使复合, 使化合
wildlife|野生动植物
digital|数字显示的, 数字的;n. 数字仪表, 数字式电子表(或时钟); 数字, 数字式
raf|英国皇家空军（Royal Air Force）
institutional|制度的, 公共机构的, 学会的; 组织机构的, 制度的, 公共机构的
productivity|生产力; 生产率, 生产能力
doctrine|教条, 学说; 学说
gender|性;vt. 产生
creditor|债权人; 债权人, 债主, 贷方
sociology|社会学; 社会学
lifetime|一生, 终生;a. 一生的, 终生的
consume|消耗, 消费, 消灭;vi. 耗尽, 毁灭
avenue|大街, 途径, 林荫路
merit|优点, 功绩, 价值, 功过, 真相;vt. 值得;vi. 应受
equip|装备, 配备; 设备, 装置
oak|橡树, 橡木;a. 橡木制的
nasty|污秽的, 下流的, 险恶的
...
copper|铜, 警察; 铜Cu
builder|建立者; 组份
residence|住宅, 居留, 驻扎, 居住期间; 住房
recipe|食谱, 处方, 秘诀; 取(处方头语), 处方
bureau|局, 办公处; 局, 司, 处
isolation|隔绝, 孤立, 隔离; 分离; 生物分离
sandwich|三明治, 夹心面包, 夹层板;vt. 插入, 夹入, 把...制成三明治
rod|竿, 笞鞭, 小枝; 棒
sword|刀, 剑, 战争, 武力, 剑状物
fluid|液体, 分泌液, 流体;a. 流动的, 可改变的
discretion|慎重, 辨别力, 考虑, 处理权; 有决定权的
directory|目录, 工商名录, 指南; 目录
decent|有分寸的, 得体的, 大方的
convey|传达, 运输, 转让; 转让(财产等), 搬运
duration|持续时间, 持续; 持续时间
administer|管理, 料理, 执行;vi. 执行遗产管理人的职责, 给予帮助
succession|连续, 继承权, 继位, 演替, 地层次序; 继承, 继承权, 继位
palm|手掌, 棕榈, 胜利;vt. 与...握手, 藏...于掌中
justification|辩护, 证明正当, 释罪; 调整
duck|鸭子;vi. 没入水中, 闪避;vt. 猛按...入水, 躲避
stance|准备击球姿势, 站立的姿势, 位置, 姿态; 地位, 形势
whisky|威士忌酒, 轻便马车; 威士忌酒
norm|基准, 模范, 标准, 准则, 平均数; 定额
oxygen|氧; 氧O-2
explicit|详述的, 清楚的, 直言的
seminar|研究班, 专题讨论会; 讨论会, 专家讨论会
doorway|门口, 途径
abstract|抽象的, 深奥的;n. 摘要, 抽象概念;vt. 摘要, 提炼, 使抽象化; 摘录; 摘要; 抽象
defender|防卫者, 防护者, 辩护者; 辩护人, 保护人
portfolio|皮包, 公文包, 部长职务, 有价证券财产目录, 艺术代表作选辑; 公文包, 文件夹, 阁员职务
sculpture|雕刻, 雕塑;vt. 雕刻, 雕塑;vi. 当雕刻师
successive|继承的, 连续的; 接续承运人; 连续的
abolish|废止, 革除, 消灭; 废除, 取消, 裁撤
sensation|感觉, 轰动; 感觉
diagnosis|诊断; 诊断
developer|开发者; 显影器
comparable|可比较的, 比得上的
installation|安装, 装置, 就职; 结构, 装置, 设立
bastard|私生子, 劣货;a. 私生的, 杂种的, 不合标准的
offender|罪犯, 无礼的人, 得罪人的人
forum|论坛, 公开讨论的广场, 法庭, 讨论会; 讨论会, 专题讨论, 公共论坛
capitalism|资本主义; 资本主义
frown|皱眉;vi. 皱眉头;vt. 皱眉表示
polytechnic|各种工艺的, 工艺教育的;n. 工艺专科学校, 理工专科学校
computing|计算
legislative|立法机构;a. 立法的, 有立法权的
timing|时间选择, 时间测定, 定时, 调速; 定时器时钟
interfere|妨碍, 冲突, 干涉, 抵触; 干扰, 干涉, 阻碍, 碰腿(马)
sooner|(美)(非正式)抢先占有土地者, 抢先而获得不正当利益的人
plead|辩护, 恳求;vt. 为...辩护, 提出...借口, 托称, 恳求
bonus|奖金, 红利; 奖金, 红利, 额外补贴
casual|偶然的, 不经意的, 便装的;n. 临时工, 待命士兵
persist|坚持, 固执, 持续, 坚称; 持续
inherit|继承, 遗传;vi. 接受遗产
extract|榨出物, 精汁, 摘录, 选段;vt. (费力地)取出, 采掘, 榨取, 摘录, 吸取; 提取
lesser|较少的, 较小的, 次要的
subtle|敏锐的, 精细的, 狡猾的, 稀薄的, 灵巧的, 微妙的; 锐敏的; 精细的
glory|光荣, 荣耀, 荣誉, 壮丽, 繁荣;vi. 自豪
partial|部分的, 偏袒的, 偏爱的;n. 分音
conceive|构思, 认为;vi. 怀孕
cater|提供饮食及服务, 投合, 迎合
random|随意, 随机;a. 任意的, 随便的, 胡乱的, 随机的;adv. 胡乱地
assignment|分配, 功课, 任务, 转让, 归因, 陈述; 赋值
marvellous|奇异的, 神奇的, 奇迹般的, 惊人的, 不可思议的, 绝妙的, 妙极的
resemble|相似, 类似
intensive|加强的, 内涵的, 集中的;n. 加强器
guilt|罪行, 内疚; 罪, 犯罪, 罪行
basket|篮, 篮子;vt. 装入篮
horizon|地平线, 眼界, (天)视地平
envisage|面对, 正视, 想象
capability|能力, 性能, 约束力; 能力
tutor|家庭教师, 导师, 助教, 监护人;vt. 当...的教师, 教, 指导, 约束, 克制;vi. 当家庭教师, 受家庭教师的指导
instinct|本能, 直觉;a. 充满着的
eagle|鹰, 鹰状标饰
preliminary|初步做法, 初步措施, 预试, 预选赛;a. 初步的, 开始的, 预备的
inn|旅馆, 客栈;vi. 住旅馆
scholar|学者, 奖学金获得者, 有文化者, 学习者
pavement|路面, 人行道, 铺面路, 铺路材料
sphere|球, 球面, 球体, 天体, 地球仪, 范围;vt. 包围, 使成球体, 放入球内
holding|把持, 支持, 保持; 租借地, 占有物, 拥有的财产
reign|为王，为君;当政;统治;n. 为王，为君;当政;统治
motivation|动机, 刺激, 推动; 促动, 推动, 诱导
influential|有影响的, 有势力的
entity|实体, 实存物, 存在; 实体
assign|分配, 指派, 赋值; 赋值
redundancy|过多, 冗长, 累赘, 多余, 冗余位, 冗余度, 冗余码, 多余信息; 冗余
pat|轻拍;v. 轻拍;adv. 适时, 正好, 恰好, 毫不迟疑, 熟记地;a. 恰好的, 合适的, 熟练的, 坚定的, 人为的
update|更新, 使现代化;n. 更新; 更新
tray|托盘, 公文盘, 满盘, 发射箱; 淋盘
Christianity|基督教, 基督教精神
thesis|论题, 论文
regulate|管理, 控制, 调节, 调整, 校准; 控制, 管理
commonwealth|共和国;联邦;国民整体
radiation|辐射; 放射
consensus|合意, 一致, 同感; 合意
hey|嗨
subsidiary|子公司, 附件, 辅助者;a. 辅助的, 次要的, 津贴的
organism|生物, 有机体, 社会组织; 生物;,;机体
plc|可编程逻辑控制器
lighting|照明, 照明设备, 舞台灯光
assemble|集合, 收集, 装配;vi. 集合; 汇编
poster|海报, 招贴, 驿马
harsh|粗糙的, 刺耳的, 严厉的; 粗糙的, 严厉的, 苛刻的
blanket|毛毯, 毯子;vt. 掩盖, 覆盖;a. 总共的
tribute|贡物, 礼物, 颂辞
surgeon|外科医生, 军医, 船医; 外科医师
beam|横梁, 杆, 光线, 容光焕发;vi. 用梁支承, 微笑, 射出光线;vt. 照耀, 感到欣喜; 束
slave|奴隶, 从动装置, 卑鄙的人;vi. 拼命工作; 从设备
engagement|诺言, 约会, 婚约, 交战; 衔接
contemplate|注视, 沉思, 盘算;vi. 冥思苦想
excessive|过度的, 过多的, 极端的; 过度的, 过分的, 额外的
splendid|光亮的, 了不起的, 灿烂的, 壮丽的, 显著的, 杰出的
remainder|剩余物, 其他人, 残余, 余数;v. 削价出售(图书);a. 剩余的, 出售削价剩书的; 余数
intervene|插入, 调停, 干涉; 进场干预
clay|泥土, 肉体, 黏土; 粘土
metropolitan|大都市居民, 都主教, 宗主国的公民;a. 大都市的, 都主教区的, 宗主国的
embrace|拥抱;vt. 拥抱, 互相拥抱, 包含, 收买;vi. 拥抱
exceptional|例外的, 异常的, 特别的
descend|下降, 世代相传, 屈尊, 袭击;vt. 下降
combined|结合的;组合的
grasp|把握, 抓紧, 理解, 抓, 柄, 控制;vt. 抓住, 紧握, 领会;vi. 抓
supervision|监督, 管理; 监督, 管理
limb|四肢, 枝干, 翼, 边缘;vt. 切断...之手足
cling|粘紧, 附着, 紧贴, 坚持
monster|怪物, 恶人, 巨物; 畸胎
memorial|纪念物, 请愿书;a. 记念的, 记忆的
exclusively|排他地, 仅仅, 专门, 只, 仅, 唯一地, 专有地
conceal|隐藏, 掩盖, 隐瞒; 隐瞒, 隐匿, 保守秘密
compulsory|被强制的, 强迫的, 义务的; 强迫的, 强制的
similarity|类似, 类似处; 类似, 相似, 类似事例
jaw|颚, 颌;v. 闲谈, 教训, 唠叨
ridge|脊, 山脊, 山脉; 嵴, 脊, 棱线
liver|肝脏, 生活者, 居民; 肝
progressive|改革论者, 进步论者;a. 前进的, 累进的, 进步的
terminal|终端机, 终点, 末端, 极限, 终点站;a. 终点的, 定期的, 致死的, 结尾的, 末端的, 晚期的; 终端; 终端设备
incur|招致, 蒙受, 遭遇; 招致, 蒙受, 担负
continental|大陆的, 洲的;n. 欧洲大陆人
cab|出租车, 出租汽车, 出租马车;vi. 乘出租马车(或汽车)
chronic|慢性的, 习惯性的;n. 慢性病患者
primitive|原始人, 早期艺术家;a. 原始的, 上古的; 图元; 原语; 基元
legend|传说, 传奇文学, 图例; 图例
bronze|青铜, 铜像;a. 青铜色的
orchestra|管弦乐队, 乐队演奏处
scarcely|简直不, 一定不, 仅仅
operational|操作的, 运作的; 操作上的, 业务上的, 可起作用的
handsome|英俊的, 大方的, 慷慨的, 相当可观的, 美观的, 灵敏的
horrible|可怕的, 遭透的, 极讨厌的
faculty|才能, 能力, 全体教员, (大学的)系; 能力, ;院系
socialism|社会主义, 社会主义运动
exclusion|排除, 除外, 逐出; 排除, 除外, 分离术
systematic|有系统的, 分类上的, 体系的; 系统的, 系的, 分类的
constituent|成分, 选民, 构成物;a. 构成的, 组织的, 选举的
pardon|原谅, 赦免;vt. 宽恕, 原谅
ideological|意识形态的, 空想的; 思想的, 思想上的, 意识形态的
GP|普通医师, 普通医生开业医生; 通用程序设计, 图形处理器
striker|打击者, 罢工者; 罢工者
fortunately|幸运地, 幸亏
pursuit|追踪, 追求, 追赶, 娱乐, 职业; 追捕, 追求
sue|控告, 起诉, 请求;vi. 提出诉讼, 提出请求
nowadays|现在, 现时, 当今;adv. 时下, 现今
endless|不停的, 无穷尽的, 无尽的; 无端的, 环状的
invariably|不变化地, 恒定地, 始终如一地
dispose|处理, 排列, 布置;vi. 处置
confess|承认, 坦白, 忏悔, 供认
grace|优雅, 风度, 慈悲, 恩惠, 体面, 赦免, 恩典, 谢恩祷告;vt. 使优美
isolated|孤立的, 孤零零的; 隔离的, 绝缘的
precious|宝贵的, 珍贵的, 过于精致的, 珍爱的
miracle|奇迹, 奇事
prejudice|偏见, 成见, 侵害;vt. 使存偏见, 使有成见, 侵害
shield|盾, 防卫物, 保护者, 屏蔽;vt. 保护, 遮蔽, 屏蔽, 庇护, 挡开, 避开;vi. 起保护作用
wealthy|富有的, 丰裕的, 充分的
scatter|消散, 分散, 散播, 散射, 散布, 酒馆;vi. 散布, 散播, 消散;vt. 使消散, 使分散, 撒, 散布, 散播, 散射; 散点图
forthcoming|即将来临的;n. 来临
hedge|树篱, 障碍, 套头交易;vt. 用树篱围, 套期保值, 妨碍, 两面下注以防...的损失;vi. 筑树篱, 躲闪, 两面下注以防损失;a. 树篱的, 偷偷摸摸的
brass|黄铜, 黄铜制品;a. 黄铜的, 铜管乐器的;v. 镀以黄铜, 支付
terror|恐怖, 可怕的人; 惊吓, 惊悸
neutral|中立者, 中立国, 非彩色, 空档;a. 中立的, 中性的, 无色的
mature|成熟的, 到期的, 充分考虑的;vt. 使成熟;vi. 成熟, 到期
vanish|消失, 不见, 成为零
virgin|处女;a. 处女的, 贞洁的, 纯洁的, 初始的, 纯的
coincide|一致, 符合; 重合
ladder|梯, 梯状物, 发迹的途径;vi. 袜子抽丝, 成名
keeper|监护人, 管理人, 看守人; 保管人, 看守人, 保持片
hostile|敌人的, 怀敌意的, 敌对的;n. 敌对分子
formulate|用公式表示, 明确叙述, 制订; 公式化, 公式表示
correspondence|相符, 通信, 信件; 对应, 相对
supper|晚餐
creep|爬, 徐行, 蠕动;vi. 爬, 蔓延, 潜行
contractor|立契约的人, 承包商; 承包者; 承包工厂
accessible|易接近的, 可进入的, 可使用的, 易受影响的, 可理解的
deem|认为, 相信
inhabitant|居民, 居住者; 居民
prediction|预言, 预报; 预测
classify|分类, 归类, 分等; 分类, 分级, 分粒
lamb|小羊, 羔羊;v. 产羊羔
candle|蜡烛;vt. 对着光检查
fist|拳头, 手;vt. 拳打, 握成拳, 紧握
prey|被掠食者, 牺牲者;vi. 捕食
predecessor|前任, 先辈, 前身; 初牙, 前辈, 祖先
provincial|外地人, 粗野的人;a. 省的, 外地的, 偏狭的
coffin|棺材, 灵柩;vt. 把...装进棺材
notable|著名人士, 值得注意之事物;a. 值得注意的, 显著的
transmission|传输, 传送, 变速器; 传输
marble|大理石, 石弹, 雕刻品;a. 大理石的, 冷酷无情的, 有大理石花纹的
endorse|支持, 赞同, 背书于, 签署; 赞成, 背书
barn|谷仓; 靶(恩)(核反应截面单位)
collar|衣领, 颈圈;vt. 控制, 扭住衣领, 给...装上领子
hut|小屋, 茅舍, 临时军营;v. (使)住在茅舍
utility|功用, 有用之物, 实用, 公用事业, 实用程序;a. 实用的, 有多种用途的; 实用程序, 工具
trophy|战利品, 奖品;vt. 用战利品装饰
elite|精华, 精锐, 中坚分子
workforce|劳动力;工人总数, 职工总数
dynamic|动态的, 有活力的, 有力的, 动力的, 不断变化的;n. 动力, 动态; 动态的
technological|技术的; 工艺的, 技术的
dolphin|海豚
advisory|顾问的, 咨询的, 劝告的; 劝告的, 忠告的, 咨询的
geographical|地理学的, 地理的
stitch|一针, 疼痛, 针法, 碎布条, 针脚;v. 缝, 缝合, 装订
bloke|小子, 家伙
owl|猫头鹰; 走私
tumour|瘤, 肿块
electron|电子; 电子
antibody|抗体; 抗体
relieve|减轻, 救济, 解除, 使免除, 换...的班, 使得到调剂, 使不单调, 衬托, 使显著;vi. 救济, 当替补投手, 呈鲜明突出
handful|少数, 一把, 棘手事
worthwhile|值得花时间的, 值得做的, 有真实价值的
vague|含糊的, 不清楚的, 茫然的
odds|可能性, 几率, 机会, 胜算, 不平等
portion|部分, 一份, 命运, 嫁妆;vt. 分配, 给...嫁妆
conscience|良心; 良心, 道德感, 正义感
tobacco|烟草, 香烟; 烟草
wisdom|智慧, 明智行为, 学识, 名言, 贤人
regardless|不管, 不注意, 不顾
certainty|确定, 确实的事情; 确定, 肯定, 必然的事
distress|苦恼, 贫困, 痛苦;vt. 使苦恼;a. 亏本出售的
fortnight|两星期
circulation|流通, 循环, 发行量; 环流
suite|随员, 套房, (一)组, (一)套, 组曲, 继之而来的事; 程序组
disturbance|扰乱, 不安, 忧虑; 扰动; 干扰; 失调
tighten|勒紧, 使变紧;vi. 变紧, 绷紧
ambitious|有野心的, 抱负不凡的, 雄心勃勃的
straw|稻草, 麦管, 吸管, 一文不值的东西, 草帽;a. 稻草的, 稻草色的, 琐碎的, 无价值的
erect|直立的, 竖立的, 笔直的;vt. 使竖立, 使直立, 树立, 建立;vi. 勃起
evidently|明显地, 根据现有证据来看
destination|目的地, 目标, 目的; 目的文件, 目的单元
verbal|用言辞的, 言语的, 口头的, 逐字的, 动词的; 言语的, 口述的
enclose|围绕, 圈起, 放入封套, 附上
discharge|卸下, 放出, 解雇, 拔染, 履行, 放电;vi. 卸货, 流出;n. 卸货, 流出, 放电
hazard|冒险, 危险, 机会;vt. 冒...的危险, 赌运气, 使冒危险; 相关危险; 冒险
log|记录, 圆木, 日志, 计程仪;vt. 伐木, 切, 航行;vi. 伐木; 日志
elephant|象
seldom|不常的, 稀少的;adv. 很少, 不常
precede|在...之前, 优于, 较...优先;vi. 在前面
legitimate|合法的, 正当的, 婚生的;vt. 认为正当, 立为嫡嗣, 使合法
grief|伤心, 忧愁, 悲痛, 不幸, 灾难
tuck|缝褶, 活力, 鼓声, 船尾突出部, 食品;vt. 打褶, 卷起, 挤进, 塞, 收藏;vi. 缝褶裥, 缩拢
restraint|抑制, 克制, 束缚; 约束, 拘束
charm|吸引力, 魔力, 符咒;vt. 迷住, 使陶醉, 行魔法;vi. 用符咒, 有魅力
omit|省略, 删除, 疏忽, 遗漏; 省略
contradiction|反驳, 矛盾; 矛盾, 否认, 反驳
suspension|悬挂, 暂停, 中止; 悬浮; 悬浮体; 悬浮液
vein|血管, 静脉, 纹理, 气质, 情绪;vt. 使有脉络, 像脉络般分布于
petition|请愿, 诉状, 陈情书, 申请, 祈求, 祷文;v. 正式请求, 恳求, 请愿
basin|盆, 盆地; 第三脑室, 骨盆
favourable|有用的, 良好的, 赞成的, 顺利的; 良好的, 顺利的
expedition|远征, 探险队, 迅速
administrator|管理人, 行政官; 遗产管理人员
plea|恳求, 辩解, 抗辩, 诉讼, 请愿, 托词; 抗辩, 申诉案件, 答辩
integrity|正直, 廉正, 完整; 完整性
commodity|农产品, 商品, 有用的物品; 商品, 货物, 日用品
academy|学院, 院校, 学会
goodness|仁慈, 善良
cluster|串, 丛, 群, 簇;vi. 成串, 丛生;vt. 使聚集; 簇
supplement|补充物, 增刊, 补充, 补遗, 补编, 附录, 补角;vt. 补充, 增补
profound|极深的, 深厚的, 深刻的, 渊博的
depict|描述, 描写
dawn|破晓, 黎明;vi. 破晓
parking|停车;a. 停车的
tile|砖瓦, 瓷砖, 瓦片;vt. 铺以瓦, 铺以瓷砖; 平铺
pulse|脉冲, 脉搏, 情绪, 意向, 拍子, 豆类;vi. 跳动, 脉跳;vt. 使跳动, 用脉冲调制; 脉冲
manual|手册, 指南;a. 手的, 手动的, 手工的, 体力的; 人工的, 手动的
mining|采矿; 采矿, 采矿业
originate|创始, 发明, 发起;vi. 发源, 发生, 起航; 发自
moor|荒野;旷野;Moor: 摩尔人.;v.系住;停泊
regiment|（军队）团, 大量（人或物）;v. 组编成团，组织，严格管制
custody|监护, 拘留, 监禁; 保管, 照顾, 保护
electronics|电子学; 电子学
handicap|障碍, 困难, 不利条件;vt. 加障碍于, 妨碍
manor|庄园; 采邑, 庄园, 采地
defect|缺点; 缺损, 缺陷
breeze|微风, 煤屑, 轻而易举的事;vi. 吹微风, 逃走
spine|背骨, 脊柱, 尖刺; 脊柱; 棘, 刺; 马蹄嵴
lounge|闲逛, 休闲室, 长沙发;vi. 闲混, (懒洋洋地)躺;vt. 闲混
colonial|殖民的, 殖民地的; 殖民地居民
magnetic|有磁性的, 有吸引力的, 催眠术的; 磁;的
bureaucracy|官僚, 官吏; 官僚主义, 官僚政治, 官僚机构
ballet|芭蕾舞
tourism|观光业, 游览; 旅游业
bowel|肠, 内脏, 内部;vt. 挖...的内脏
tremble|战栗, 颤抖;vi. 战栗, 忧虑, 摇晃
thigh|大腿, 股; 股, 大腿
composer|作曲家, 作家, 调停者
reportedly|根据传说, 根据传闻, 据报道
meantime|间隔时间, 其时;adv. 其间
fatal|致命的, 重大的, 命运注定的, 粗心的, 不幸的; 致命的, 致死的
compensate|偿还, 补偿, 付报酬
bold|大胆的;n. 粗体; 粗体
rigid|坚硬的, 刚性的, 严格的, 精密的, 刻板的
peculiar|奇特的, 罕见的, 特殊的, 特别的;n. 特有财产, 特权
neglect|疏忽, 忽略, 漏做;vt. 疏忽, 忽视, 不顾
making|制造, (手工)制造业, 制作, 形成, 发展, 要素, 内在因素, 赚头, 制造物
circulate|(使)流通, (使)循环, (使)传播
spill|溢出, 溅出, 摔下, 溢出量, 木片, 小塞子;vt. 使溢出, 使散落, 洒, 使流出, 倒出, 使摔下;vi. 溢出, 涌流, 摔下
profitable|有利润的, 有利益的, 赚钱的; 有利(可图)的, 合算的
deprive|剥夺, 使丧失; 剥夺, 剥夺, 夺去
warehouse|仓库, 货栈, 大商店;vt. 储入仓库
drown|淹死;vt. 把...淹死, 淹没
lecturer|演讲者, 讲师; 讲演人, 讲课人, 讲师
bucket|桶; 存储桶; 桶
compact|紧凑的, 紧密的, 简洁的;vt. 使紧密结合, 压缩;vi. 变坚实
embark|乘船, 着手, 从事, 上飞机;vt. 使上船, 使上飞机, 使从事
depart|离开, 出发, 背离, 违反, 去世
irrelevant|不恰当的, 无关系的, 不相干的; 无关的, 不相干的, 离题的
crude|天然的, 未成熟的, 粗糙的, 粗鲁的;n. 天然的物质
summon|召唤, 召集, 号召, 振奋, 唤起, 鼓起; 传唤, 传讯
lifestyle|生活方式
outlet|出口, 发泄方法, 市场; 出口
passive|消极的, 被动的, 冷漠的, 顺从的, 无源的; 被动的
interference|冲突, 干涉; 干扰
beast|畜生, 动物, 野兽, 兽性
symbolic|象征的, 符号的; 符号化
ritual|仪式, 典礼, 宗教仪式;a. 仪式的, 依仪式进行的
skull|头盖骨, 头脑, 好学生; 头颅
widen|弄宽, 加宽, 扩大;vi. 变宽, 扩大
obstacle|障碍, 妨害物, 阻碍
diminish|(使)减少, (使)变小
revive|使苏醒, 使复兴, 使振奋, 回想起, 重播;vi. 苏醒, 复活, 复兴, 恢复精神
reassure|使...安心, 向...再保证; 重新保证, 再保险, 使清除疑虑
transmit|传输, 传染, 传达, 遗传, 发射, 传播;vi. 发射信号, 留传下来; 传送
stall|厩, 停车处, 牧师职位, 货摊, 托辞, 拖延;vt. 关入厩, 停顿, 推托, 支吾, 使陷于泥中;vi. 被关在厩内, 陷于泥中, 停止, 支吾
treasure|宝物, 财富;vt. 珍爱, 重视, 秘藏
canvas|帆布, 画布, 油画; 帆布
suppress|镇压, 使止住, 禁止, 抑制, 查禁; 镇压, 平定, 禁止出版
immense|极广大的, 无边的, 非常好的
arouse|唤醒, 鼓励, 引起;vi. 醒来
minimal|最小的, 极微的, 最小限度的; 最小的, 最低的
revelation|揭露, 泄露, 发觉, 默示, 启示
neighbouring|邻近的, 接壤的, 附近的; 邻近的, 附近的, 接壤的
dilemma|困境, (进退两难的)窘境
clarify|澄清, 阐明;vt. 使明晰
frontier|边界, 边境; 国境, 边境, 边界
charming|迷人的, 有吸引力的
productive|能生产的, 有生产价值的, 多产的; 产出性的, 产生性的
motorway|高速公路
strand|(绳索的)股, 绳, 串, 海滨, 河岸;vi. 搁浅;vt. 使搁浅, 使落后, 使陷于困境, 弄断, 搓
injection|注射, 注射剂; 注入; 注射
compile|编译, 编辑, 编纂, 收集; 编译
thereafter|其后, 从那时以后
dreadful|可怕的
bang|重击, 突然巨响, 刘海;v. 发巨响, 重击;adv. 砰然地, 突然巨响地, 直接地; 撞击符
fling|投掷, 急冲, 嘲弄;vt. 投, 丢下, 抛弃, 使陷入, 挥动, 嘲笑, 扫视;vi. 猛冲
beneficial|有益的, 受益的; 有使用权的, 可享利益的
thrust|插, 戳, 刺, 猛推, 口头攻击, 推力;vt. 插入, 猛推, 刺, 戳, 强加, 延伸;vi. 插, 刺, 戳, 延伸, (用力)推
amend|修改, 改善, 改良;vi. 改过自新
comparative|比较的, 相对的;n. 对手
albeit|尽管, 虽然
lawn|草地, 草坪, 上等细麻布; 细筛
ferry|渡船, 渡口; 摆渡营业权, 轮渡
booking|预约演出合同; 书型模法
manuscript|手稿, 原稿, 底稿;a. 手写的
tribe|宗族, 部落, 一群人; 族(生物分类)
quota|配额, 限额; 定额
heir|继承人, 嗣子, 后嗣; 继承人, 后嗣
slam|砰然声, 猛然, 猛烈的抨击;vt. 猛然关上, 砰地关上, 猛烈抨击;vi. 砰地关上, 猛攻
habitat|栖息地, 居留地, 自生地, 聚集处; 习生地, 产地, 生境, 栖所
bias|偏见, 斜纹;a. 偏斜的;adv. 偏斜;vt. 使有偏见; 偏流; 偏压; 偏磁; 偏离
diameter|直径; 直经, 径
fox|狐狸, 狡猾的人;vi. 奸狡地行动, (书页)生斑, 变酸;vt. 欺骗, 使变酸, 为(鞋等)换面, 使生黄斑
collaboration|合作, 勾结; 通敌卖国者, 奸细
sexuality|性征, 性行为, 性欲; 性别, 性欲
eyebrow|眉毛; 眉
diesel|内燃机, 柴油机, 柴油
forehead|额, 前额, 前部; 额
referee|仲裁人, 调解人, 裁判员;v. 仲裁, 裁判
taxpayer|纳税人; 纳税人, 纳税义务人
fossil|化石, 古物;a. 化石的, 陈腐的, 守旧的
diversity|差异, 多样性; 多样性
retailer|零售商人, 传播的人; 零售商
rug|小块地毯, 揭露某人
worthy|杰出人物;a. 有价值的, 可敬的, 值得的
doubtful|可疑的, 疑心的, 不明确的; 怀疑的, 有疑问的, 未确的
dictate|听写, 口述, 口授;vt. 口述, 使听写, 命令;n. 命令, 指挥, 指令
protective|给予保护的, 保护的; 保护的, 防护的, 保护剂, 保护物, 油绸
promising|有希望的, 前途有望的; 有希望的
forbid|禁止, 不准, 妨碍; 不许, 禁止, 阻止
dedicate|献出, 贡献
tender|嫩的, 柔软的, 脆弱的, 温柔的, 亲切的, 未成熟的, 微妙的, 棘手的, 审慎的;vt. 使变嫩, 提供, 偿还;vi. 变柔软, 投标;n. 照料, 看管人, 供应船, 小船, 提出, 偿付, 投标
supervise|监督, 管理, 指导
misery|痛苦, 悲惨, 不幸, 穷困
illusion|幻影, 错觉, 幻想; 错觉
fringe|边缘, 端, 流苏, 穗, 初步;vt. 加穗于, 加饰边于;a. 边缘的, 附加的
reminder|提醒的人, 暗示; 催单
fortunate|幸运的, 幸福的
temptation|诱惑, 诱惑物; 诱惑, 诱惑物
underline|在...下面划线, 作...的衬里, 强调;n. 下划线, 图下说明文字; 加下划线; 下划线
merge|使合并, 使消失, 吞没;vi. 合并, 渐渐消失; 合并
manipulate|操纵, 利用, 操作, 巧妙地处理, 假造
burning|燃烧的, 象燃烧一样的;n. 烧, 燃烧
throne|王座, 君主
sacred|神圣的, 献给上帝的, 庄严的, 祭祀的; 神圣的, 不可侵犯的
calendar|日历, 日程表;vt. 列入表中; 日历
harmony|协调, 和睦, 调和; 和声学
intent|意图, 含义, 故意;a. 专心的, 决心的, 热心的
persistent|固执的, 坚持的, 持续的, 作用持久的; 坚持的, 固执的, 持续的
outsider|外人, 局外人, 非会员, 外行, 门外汉, 比赛中获胜可能性不大的选手; 外船公司
elaborate|精细的, 详尽的, 精心计划(或制作)的;vt. 详细地说明, 用心地制作, 发挥;vi. 变复杂, 作详细说明
utterly|完全地, 全然, 绝对
rebuild|改建, 重建, 改造;vi. 重建
circular|圆形的, 循环的, 间接的; 环状的, 循环的
ash|灰, 灰烬; 灰分
fitting|适宜的;n. 试穿, 试衣, 装配, 装置
hidden|隐藏的;hide的过去分词; 隐藏的
defensive|防卫的, 防备用的, 自卫的;n. 守势, 防卫姿势, 防卫物
caution|小心, 慎重, 警示;vt. 警告; 警告
partially|部分地, 一部分地, 不公平地
distinguished|卓著的, 著名的
sunshine|阳光, 光明, 晴天
stuck|stick的过去式和过去分词
proclaim|宣布, 公告, 宣言, 表明, 赞扬; 宣布, 宣告, 公布
shaft|轴, 箭杆, 矛, 矿井;vt. 装杆于, 利用
furious|狂怒的, 激烈的, 吵闹的
monument|纪念碑, 纪念物, 石碑
prescribe|规定, 指定, 嘱咐, 开处方
divine|神的, 神圣的, 非凡的;n. 神学家
morality|道德, 教训, 品行; 道德, 道义
syndrome|并发症状, 综合征, 同时存在的事物; 校验子; 并发位
invisible|看不见的, 无形的; 无形的, 表面上看不见的, 未列在公开帐目的
dignity|尊严, 高贵; 尊严, 高位, 高贵
despair|绝望, 失望;vi. 绝望
steward|管理人, 招待员, 管家, 乘务员; 轮船, 飞机的服务员, (财务)管理员
salmon|鲑鱼, 大麻哈鱼; 鲑
contempt|轻视, 轻蔑; 藐视, 侮辱, 轻视
loop|环, 圈, 弯曲部分, 循环;vt. 使成环, 以圈结, 以环连结;vi. 打环, 翻筋斗; 循环
gardener|园丁, 花匠, 园艺家
brochure|小册子, 小册
contrary|相反的, 矛盾的, 对立的;n. 相反, 对立面;adv. 相反地
prospective|预期的, 将来的; 预期的, 未来的
array|排列, 衣服, 大批, 军队;vt. 布署, 打扮, 排列; 数组; 阵列
temper|(钢等的)硬度, 脾气, 心情, 中和剂, 倾向, 回火;vt. 使回火, 锻炼, 调和, 使缓和;vi. 回火
bee|蜜蜂, 聚会
arch|拱门, 拱形, 足弓;vt. 使成弓形;vi. 拱起, 成弓形;a. 主要的, 调皮的, 傲慢无礼的, 狡猾的
aggression|侵犯, 侵略; 攻击
solar|太阳的, 日光的, 源自太阳的; 太阳的; 腹腔丛的
cage|笼, 牢房, 战俘营;vt. 关进笼内
regain|取回, 恢复, 重回, 复得; 回潮
misleading|引入歧途的, 使人误解的, 骗人的; 误写姓名的, 误称的, 令人误解的
bounce|跳, 跳跃, 弹力, 撞击;vi. 反跳, 弹跳;vt. 使跳回, 撞击; 打回
philosophical|哲学的, 冷静的, 达观的, 哲学上的, 哲学家似的
realm|王国, 领土, 领域; 领域
mist|雾, 迷蒙, 朦胧不清;vt. 使模糊, 使蒙上雾;vi. 变模糊, 下雾
brigade|旅, 队; 团体, 队, 组
minus|负号, 不足;a. 减的, 负的, 阴性的;prep. 减, 缺; 负差
inappropriate|不适当的, 不相称的
insufficient|不够的, 不能胜任的, 不充足的; 不足的, 不充分的, 不能胜任的
conform|使一致, 使遵守, 使符合;vi. 一致, 符合, 适应
ancestor|祖先, 祖宗
eligible|有资格当选的, 合格的;n. 有资格者, 合格者, 适任者
sunlight|日光; 日光, 太阳光
philosopher|哲学家, 哲人, 思想开创人, 达观的人; 哲学家, 哲学研究者
toss|投掷, 抛, 摇摆, 震荡, 掷钱币决定;vt. 投掷, 猛抬, 摇荡, 使不安, 掷钱币决定;vi. 被到处扔, 摇摆, 颠簸, 辗转, 掷钱币决定某事
mistress|主妇, 女主人, 情妇
noble|贵族;a. 高贵的, 高尚的, 贵族的, 辉煌的
mathematical|数学的, 精确的; 数学上的
whale|鲸;vi. 捕鲸;vt. 使惨败, 猛揍
gospel|福音, 信仰, 真理
diverse|不同的, 变化多的
monk|修道士, 僧侣, 和尚
cylinder|圆筒, 圆筒状物, 汽缸, 柱面; 柱面
archive|把...存档;n. 档案馆, 档案文件; 挡案库, 存档
garment|衣服, 衣装, 外表
nonetheless|然而, 尽管, 不过;adv. 不过, 仍然, 尽管如此, 然而
textile|纺织品, 纺织业;a. 织的, 纺织的
woodland|林区, 林地
feedback|反馈, 反应; 反馈
cabin|小屋, 客舱;vt. 关在小屋
patent|专利权, 许可证, 执照, 专利品, 素质;a. 专利的, 特许的, 显著的, 新奇的;vt. 取得...的专利权, 请准专利
laser|激光; 激光器
dragon|龙, 凶暴的人; 凶恶的人, 凶恶严厉的监护人
lace|饰带, 花边, 缎带, 鞋带;vt. 结带子, 饰以花边;vi. 系带子; 全穿孔
lab|实验室, 研究室; 凝乳酶
inherent|固有的, 与生俱来的; 固有的, 生来的
viewer|观察者, 看电视者, 视察员, 观察器; 指示器
selective|选择的, 选择性的; 选择的, 选择性的
clutch|抓紧, 掌握, 离合器, 一窝小鸡;vt. 抓住, 踩汽车离合器踏板;vi. 抓; 联轴器; 离合器
intermediate|中间物, 调停者, 中级;a. 中间的, 中级的;vi. 起媒介作用; 中级
greater|大的
ace|幺点, 好手, 少许, 发球得分;a. 一流的, 杰出的; 应答允许, 自适应计算机试验, 自动呼叫设备, 自动执行控制
promoter|促进者, 助长者; 助催化剂
characterize|描绘...的特性, 刻划...的性格
probe|探索, 调查, 探针, 探测器;v. 用探针探测, 调查, 探索
ozone|新鲜的空气, 臭氧, 使人愉快的影响; 臭氧
ft|英尺
calcium|钙; 钙Ca
reactor|反应者, 反应器, 反应堆, 电抗器; 反应釜; 反应锅
presume|假定, 推测, 擅自, 意味着;vi. 擅自行动, 相信
divert|转移, 使欢娱;vi. 转移
convincing|使人信服的, 有力的, 令人心悦诚服的
carve|雕刻, 切开
parcel|包裹, 部分, 片;vt. 分配, 打包;a. 部分的;adv. 局部地
crossing|横越, 横渡, 交叉点, 渡口; 划线
gathering|聚集, 集中, 采集; 富集
fantastic|奇妙的, 稀奇的, 空想的
costly|昂贵的, 奢华的, 费用大的
sketch|素描, 草图, 小品;v. 描绘略图, 画素描或速写
respectable|值得尊重的, 人格高尚的, 相当数量的;n. 品格高尚的人
relieved|宽慰的, 解除的, 减轻的
apology|道歉, 辩护; 道歉, 谢罪, 辩解者
sickness|疾病, 不健康, 呕吐; 病
intact|尚未被人碰过的, 原封不动的, 完整的; 完整的, 无伤的
fond|喜欢的, 宠爱的, 温柔的
gravity|地心引力, 重力; 重力
corn|玉蜀黍, 谷类, 谷粒, 鸡眼;vt. 使成颗粒, 腌
anonymous|姓氏不详的, 无名的, 无特色的; 无记录
tolerate|宽容, 容许, 有耐力
queue|辫子, 一队人, 队列;vt. 使排队, 将...梳成辫子;vi. 排队; 队列
compel|强迫, 迫使
tragic|悲惨的, 悲剧的
redundant|多余的, 过多的, 冗长的; 过多的, 多余的
decisive|决定性的, 坚定的, 果断的
parade|游行, 炫耀, 阅兵;v. 游行, 炫耀, (使)列队行进
recorder|记录员, 录音机;n. 记录器; 宏录制器, 记录器
foolish|愚蠢的, 傻的
mechanic|机械工, 技工;a. 手工的
intake|入口, 吸入, 吸入量; 摄取量
complication|复杂化, 复杂情况; 并发症, 并发病
unaware|未认识到的, 不知道的; 不知道的, 不察觉的, 无意的
lengthy|冗长的, 漫长的
dip|浸, 降下, 把(手、勺等)伸入, 舀取;n. 浸, 涉猎; 双列直插式组件, 分布式输入输出系统, 双排直插封装
alike|相似的, 同样的;adv. 一样, 以同样的方式
threshold|门槛, 入口, 开端, 阈; 阈; 阈值
mercy|仁慈, 宽恕, 慈悲, 怜悯, 幸运; 权宜处置权, 决定权, 宽恕
trunk|树干, 干线, 躯干, 主干, 象鼻, 箱子;vt. 把...放入旅行箱内;a. 树干的, 躯干的, 干线的, 箱形的; 中继线; 母线
likelihood|可能, 可能性
competent|能干的, 胜任的, 有效的, 足够的; 有权的, 授权的, 胜任的
boast|吹牛;vi. 吹牛, 自夸;vt. 夸口说, 自恃有
accumulate|积聚, 堆积
rip|裂痕, 破绽, 拉裂, 浪子, 巨浪;vi. 被拉开, 裂开, 猛冲;vt. 撕, 扯, 劈
humanity|人性, 人类, 博爱
genius|天才, 天赋, 精神, 神魔; 特征
scan|审视, 浏览, 扫描, 细查;vt. 细看, 浏览, 扫描, 详细调查, 标出格律;vi. 押韵, 扫描; 网络软件目录, 编码与分析系统
crawl|爬行, 匍匐而行, 养鱼池;v. 爬行
bull|公牛; 买方, 买空者
prevail|获胜, 流行, 盛行; 流行, 盛行
likewise|同样地, 也
follower|从者, 属下, 追补者; 随动机
wit|机智, 智力, 头脑, 理智, 妙语, 机智的人
spectacle|引人羡慕的东西, 景象, 眼镜, 场面, 公开展示
miserable|悲惨的;痛苦的;卑鄙的
dual|双重的, 双的;n. 双数
accusation|控告, 指控, 指责; 控告, 起诉, 告发
cleaner|清洁工人, 清洁剂, 干洗商; 滤清器; 除垢器; 洗净剂; 清洁剂
penetrate|穿透, 刺穿, 渗透, 看穿, 洞察, 了解, 使充溢;vi. 刺入, 看穿, 渗透, 打进
spectator|观众, 目击者, 旁观者
scrutiny|细看, 仔细检查, 监视, 选票检查; 复查, 评核, 仔细检查
outlook|观点, 景色, 前途, 了望; 展望
texture|(织物的)密度, (材料等的)结构, 纹理; 纹理
orthodox|正统的, 传统的, 惯常的
snatch|抢夺, 攫取, 片断;vt. 夺取, 攫取;vi. 想抢走, 攫取
precision|精密, 精确, 精确度, 精度;a. 精密的, 精确的; 精度
bolt|门闩, 螺钉, 筛子, 闪电, 意外事件;vt. 闩住, 发射, 脱口而出, 筛, 囫囵吞下;vi. 囫囵吞枣, 射箭, 脱缰, 退出党派;adv. 突然
exert|发挥, 运用, 施以影响; 施加, 产生, 行使
patron|赞助人, 顾客, 保护人; 保护人, 庇护人, 赞助人
curiosity|好奇心, 新奇的事物, 珍品
outbreak|爆发, 暴动; 暴发
legacy|祖先传下来之物, 遗赠物; 遗产, 遗赠物
worm|虫, 蠕虫, 小人物, 螺纹, 蜗杆;vi. 蠕行, 慢慢前进;vt. 使蠕行, 慢慢地走, 除虫; 蠕虫病毒
propaganda|宣传, 宣传活动; 宣传
conspiracy|同谋, 阴谋, 阴谋集团; 阴谋, 通谋, 共谋
rib|肋骨, 肋状物, 笑话;vt. 装肋状物于, 戏弄
cart|二轮运货马车;vi. 驾运货马车;vt. 用车装载
territorial|领土的, 土地的, 地方的, 区域性的;n. 本土自卫队队员
costume|装束, 服装
pine|松树, 松木;vi. 消瘦, 憔悴, 痛苦, 怀念, 渴望; 邮件程序
inland|内陆的, 国内的;n. 内地
weep|哭, 哭泣;vi. 哭泣, 流泪, 哀悼, 滴落;vt. 哭着使..., 悲叹, 滴下
implicit|暗示的, 含蓄的, 固有的, 绝对的; 不讲明的, 含蓄的
choir|唱诗班, 唱诗班的席位;v. 合唱
precedent|先例, 前例;a. 在先的, 在前的
viewpoint|观点
doll|洋娃娃, 无头脑的美丽女人
bride|新娘
boxing|拳击; 围模(牙科)
herb|药草, 香草; 草, 草本, 草药
goat|山羊, 替罪羊, 色鬼
adverse|不利的, 敌对的, 相反的, 逆的; 相反的, 敌对的, 逆的
planner|计划者, 设计者, 安排者; 刨床机
valve|活瓣, 阀, 活门;v. 装阀, 用阀调节
metaphor|隐喻
revival|复兴, 复活, 恢复精神, 苏醒; 复苏, 回生, 精神重振
sponsorship|发起, 倡议, 主办, 保证人的地位, 教父的地位, 教母的地位
fury|愤怒, 狂暴, 狂怒的人; 狂乱, 狂暴, 狂怒
differentiate|区别, 区分
sofa|沙发
compatible|能共处的, 可并立的, 适合的; 相容的; 兼容的
corpse|尸体; 尸体
toxic|有毒的, 中毒的; 中毒的, 毒物的
torch|火把, 启发之物; 火炬
knight|骑士, 爵士;vt. 授以爵位
booklet|小册子
aesthetic|美学的, 审美的, 有美感的
binding|装订; 联编; 汇集; 绑定, 捆绑
maid|少女, 未婚女子, 女仆
narrative|叙述, 故事;a. 叙述的, 叙事的, 故事体的
corps|军, 队, 部队, 兵种; 对, 团; 体, 物体
solo|独奏, 独唱, 单独表演;a. 单独的, 独奏的, 独唱的;vi. 放单飞
wee|很小的, 微小的;n. 一点点
yell|叫喊, 大叫, (齐声)呐喊欢呼;vt. 喊叫着说;n. 叫声, 喊声, 呐喊
tariff|关税, 关税表, 价格表, 收费表;vt. 课以关税; 价目表
census|户口普查;vt. 实施统计调查
stride|大步, 步幅, 步态, 进步;v. 迈大步走, 跨过, 跨
sovereignty|主权, 独立国; 主权, 主权国家, 统治权
gasp|喘气;vi. 喘气, 喘息, 渴望;vt. 气喘吁吁地说`,

cn2en: `一些|some; a few; a little; (following an adjective) slightly ...er
...
一一|one by one; one after another
